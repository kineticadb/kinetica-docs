...
| `options.renderingOptions` | `Object` | No | Rendering options that dictate the styling of the WMS layer; see the WMS documentation for the corresponding layer type for examples and default values: <br/> <br/> * [raster](/content/api/rest/wms_rest#wms-raster) <br/> * [cb_raster](/content/api/rest/wms_rest#wms-cbraster) <br/> * [heatmap](/content/api/rest/wms_rest#wms-heatmap) <br/> * [contour](/content/api/rest/wms_rest#wms-contour) <br/> * [labels](/content/api/rest/wms_rest#wms-labels) |
...
<a id="enableidentifybyradiusmode-1"></a>
...
<a id="enableidentifybypointmode-1"></a>

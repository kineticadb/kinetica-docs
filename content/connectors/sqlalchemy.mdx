...
use of the [DBAPI](/content/api/python/source/dbapi) interface of
...
The following demonstrates [creating a table](/content/sql/ddl/create-table#sql-create-table)
with various [column types](/content/sql/ddl/column-types#sql-column-types) using a SQL literal
...
The following demonstrates [creating](/content/sql/ddl/create-table#sql-create-table) a
...
<a id="create-table-as"></a>
### CREATE TABLE...AS


[CREATE TABLE ... AS](/content/sql/ddl/create-table-as#sql-create-table-as) is supported in both native SQL and in the
...
[CREATE EXTERNAL TABLE](/content/sql/ddl/create-external-table#sql-create-ext-table) is supported in both native SQL and in the
Kinetica Dialect for SQLAlchemy as the following examples show:
...
The following demonstrates [inserting](/content/sql/dml/insert#sql-insert-values) data as
...
The following demonstrates [inserting](/content/sql/dml/insert#sql-insert-select) data
...
The following demonstrates [inserting](/content/sql/dml/insert#sql-insert) data with a
[CTE](/content/sql/query/with-common-table-expressions#sql-cte) using a SQL literal as compared to using SQLAlchemy
objects:
...
The following demonstrates [updating](/content/sql/dml/update#sql-update) data with raw
...
The following demonstrates [updating](/content/sql/dml/update#sql-update) data with a
...
The following demonstrates [updating](/content/sql/dml/update#sql-update) data with a
[join](/content/sql/query/join#sql-join) using a SQL literal as compared to using
SQLAlchemy objects:
...
The following demonstrates [deleting](/content/sql/dml/delete#sql-delete) data with raw
values using a SQL literal as compared to using SQLAlchemy objects:
...
The following demonstrates [deleting](/content/sql/dml/delete#sql-delete) data with a
subquery filter (subquery in the `WHERE` clause) using a SQL literal as
compared to using SQLAlchemy objects:
...
The following demonstrates a [CTE](/content/sql/query/with-common-table-expressions#sql-cte) query using a SQL
...
The following demonstrates a [join](/content/sql/query/join#sql-join) query using a SQL
literal as compared to using SQLAlchemy objects:
...
The following demonstrates an [ASOF join](/content/sql/query/join#sql-join-asof) query
using a SQL literal as compared to using SQLAlchemy objects:
...
<a id="aggregation-group-by"></a>
### Aggregation (GROUP BY)


The following demonstrates an [aggregation](/content/sql/query/aggregation#sql-aggregation) query
using a SQL literal as compared to using SQLAlchemy objects:
...
<a id="aggregation-rollup"></a>
### Aggregation (ROLLUP)


The following demonstrates an [aggregated roll-up](/content/sql/query/grouping#sql-rollup)
...
<a id="aggregation-grouping-sets"></a>
### Aggregation (GROUPING SETS)


The following demonstrates an
[aggregated grouping sets](/content/sql/query/grouping#sql-grouping-sets) query using a SQL
literal as compared to using SQLAlchemy objects:
...
<a id="window-functions-rolling-sum"></a>
### Window Functions (Rolling Sum)


The following demonstrates a
[rolling sum window function](/content/sql/query/window#sql-window) query using a SQL
literal as compared to using SQLAlchemy objects:
...
<a id="window-functions-moving-average"></a>
### Window Functions (Moving Average)


The following demonstrates a
[moving average window function](/content/sql/query/window#sql-window) query using a SQL
literal as compared to using SQLAlchemy objects:
...
<a id="window-functions-ranking"></a>
### Window Functions (Ranking)


The following demonstrates a
[ranking window function](/content/sql/query/window#sql-window) query using a SQL literal as
compared to using SQLAlchemy objects:
...
The following demonstrates a [pivot](/content/sql/query/pivot#sql-pivot) query using a SQL
literal as compared to using SQLAlchemy objects:
...
The following demonstrates an [unpivot](/content/sql/query/unpivot#sql-unpivot) query using a
...
<a id="set-union-deduplicate"></a>
### Set Union (Deduplicate)


The following demonstrates a [set union](/content/sql/query/set-operations#sql-union) query that
...
<a id="set-union-keep-duplicates"></a>
...
The following demonstrates a [set intersection](/content/sql/query/set-operations#sql-intersect)
...
The following demonstrates a [set exception](/content/sql/query/set-operations#sql-except) query
...
[full text search](/content/sql/query/string-functions#sql-string-functions-fts) feature using a SQL
literal as compared to using SQLAlchemy objects:

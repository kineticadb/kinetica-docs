...
- [Conversion Functions](/content/sql/query/conversion-functions#sql-conversion-functions)
- [Date/Time Base Functions](/content/sql/query/date-time-functions#sql-datetime-functions-base)
- [Date/Time Complex Conversion Functions](/content/sql/query/date-time-functions#sql-datetime-functions-complex)
</Card>
...
<Card title="Temporal Windows" href="/content/sql/query/window#sql-window">
- [Window Functions](/content/sql/query/window#sql-window)
- [Aggregate Functions](/content/sql/query/window#sql-window-types-agg)
- [Ranking Functions](/content/sql/query/window#sql-window-types-rank)
</Card>


<Card title="Trend Analysis & Forecasting" href="/content/sql/query/ml-functions#sql-ml-functions">
...
<Card title="Temporal Joins" href="/content/sql/query/join#sql-join-asof">

...
<a id="table-management-permissions"></a>
...
<a id="object-creation-permissions"></a>
...
[native](/content/concepts/views) & [SQL](/content/sql/ddl/create-view#sql-create-view)
*views*.
...
<a id="table-monitor-sql-stream-permissions"></a>
...
(SQL [Streams](/content/sql/ddl/create-stream#sql-create-stream)).

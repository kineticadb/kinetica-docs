...
- [Joins](/content/sql/query/join#sql-join)
- [Aggregation](/content/sql/query/aggregation#sql-aggregation)
- [Grouping](/content/sql/query/grouping#sql-grouping)
- [Sets](/content/sql/query/set-operations#sql-set-ops)
- [Constants](/content/sql/query/constants#sql-constants)
- [Functions](/content/sql/query/array-functions#sql-functions)
- [Hints](/content/sql/query/hints#sql-hints)
- [Explain Plan](/content/sql/query/explain#sql-explain)
</Card>


<Card title="Data Manipulation (DML)" href="/content/sql/dml">
- [Insert](/content/sql/dml/insert#sql-dml-insert)
- [Update](/content/sql/dml/update#sql-dml-update)
- [Merge Into](/content/sql/dml/merge-into#sql-dml-merge-into)
- [Delete](/content/sql/dml/delete#sql-dml-delete)
</Card>


<Card title="Data Definition (DDL)" href="/content/sql/ddl">
- [Column Types](/content/sql/ddl/column-types#sql-column-types)
- [Column Properties](/content/sql/ddl/column-properties#sql-column-properties)
- [Schemas](/content/sql/ddl/create-schema#sql-create-schema)
...
- [ML Functions](/content/sql/query/ml-functions#sql-ml-functions)
</Card>

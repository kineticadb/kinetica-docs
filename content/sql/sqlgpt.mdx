...
Name of the [schema](/content/sql/ddl/create-schema#sql-create-schema) containing the *context*
...
Name of the [schema](/content/sql/ddl/create-schema#sql-create-schema) containing the table to include in the
*context*
...
Name of the [table](/content/sql/ddl/create-table#sql-create-table) to include in the *context*
...
Name of the [schema](/content/sql/ddl/create-schema#sql-create-schema) containing the *context* to use in generating
the query
...
<a id="sql-generation-options-1"></a>
### SQL Generation Options

...
through the given [data sink](/content/sql/ddl/create-data-sink#sql-create-data-sink).
...
Name of the [data sink](/content/sql/ddl/create-data-sink#sql-create-data-sink) to use to send the database *backup*
...
<table class="table w-full [&_td]:min-w-[150px] [&_th]:text-left [&_td[data-numeric]]:tabular-nums">
  ...
  <tr>
    <td><code>ALL</code></td>
    <td>[Schema](/content/sql/ddl/create-schema#sql-create-schema), and all the objects &amp; data it contains</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>[Credential](/content/sql/ddl/create-credential#sql-create-credential)</td>
  </tr>
  <tr>
    <td><code>DATA SINK</code></td>
    <td>[Data sink](/content/sql/ddl/create-data-sink#sql-create-data-sink)</td>
  </tr>
  <tr>
    <td><code>DATA SOURCE</code></td>
    <td>[Data source](/content/sql/ddl/create-data-source#sql-create-data-source)</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>[Table](/content/sql/ddl/create-table#sql-create-table) or [view](/content/sql/ddl/create-view#sql-create-view)</td>
  </tr>
  <tr>
...
be altered, via a given [data sink](/content/sql/ddl/create-data-sink#sql-create-data-sink):
...
Name of the [data sink](/content/sql/ddl/create-data-sink#sql-create-data-sink) used to alter the database *backup* files
...
Name of the [data source](/content/sql/ddl/create-data-source#sql-create-data-source) to use to retrieve the database
...
Whether to create the [schema](/content/sql/ddl/create-schema#sql-create-schema) containing objects being restored if it
...
[schema](/content/sql/ddl/create-schema#sql-create-schema) if a restored database object would otherwise collide with
...
Name of the [data sink](/content/sql/ddl/create-data-sink#sql-create-data-sink) to use to delete the database
*backup* files from the remote file store.

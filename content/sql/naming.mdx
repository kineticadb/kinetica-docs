...
Most database objects ([tables](/content/sql/ddl/create-table#sql-create-table),
[views](/content/sql/ddl/create-view#sql-create-view), etc.) can be addressed using a
...
[CREATE SCHEMA](/content/sql/ddl/create-schema#sql-create-schema).
...
the [SET CURRENT SCHEMA](/content/sql/ddl/set-current-schema#sql-current-schema) command.  Once set, the new *schema* will be used

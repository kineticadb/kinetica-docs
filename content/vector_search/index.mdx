...
[CREATE TABLE](/content/sql/ddl/create-table#sql-create-table), as well as afterwards, as below:
...
<a id="vector-functions-operators"></a>
...
[Credential](/content/sql/ddl/create-credential#sql-create-credential) object to use to authenticate to *model* service.

...
| `kind` | `VARCHAR(256)` | Function type. <br/> <br/> A: Aggregate function <br/> <br/> C: Cast function <br/> <br/> P: SQL procedure <br/> <br/> S: Scalar function <br/> <br/> U: User-defined function |

...
| `outer_object` | `VARCHAR(256)` | Special column identifying which table this tiered object belongs to; only populated when referenced in the query predicate (e.g. `SELECT * FROM ki_tobj WHERE outer_object IN ('a', 'b')`). |

...
| `OBJECT_TYPE` | `VARCHAR(256)` | Type of object grant this mapping represents (for object-level permissions). <br/> <br/> `context`: [SQL-GPT context](/content/sql/sqlgpt) <br/> <br/> `credential`: [Credential](/content/sql/ddl#sql-create-credential) <br/> <br/> `datasink`: [Data sink](/content/sql/ddl#sql-create-data-sink) <br/> <br/> `datasource`: [Data source](/content/sql/ddl#sql-create-data-source) <br/> <br/> `directory`: [KiFS directory](/content/sql/kifs#sql-kifs-create-dir) <br/> <br/> `graph`: [Graph](/content/sql/graph) <br/> <br/> `proc`: [SQL procedure](/content/sql/procedure) or [UDF/UDTF](/content/sql/udf) <br/> <br/> `schema`: [Schema](/content/sql/ddl#sql-create-schema) <br/> <br/> `table`: [Table](/content/sql/ddl#sql-create-table) or [view](/content/sql/ddl#sql-create-view) <br/> <br/> `table_monitor`: [Stream](/content/sql/ddl#sql-create-stream) |

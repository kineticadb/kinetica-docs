...
`UNION` of two or more tables.  See [CREATE TABLE ... AS](/content/sql/ddl/create-table-as#sql-create-table-as) and
[UNION](/content/sql/query/set-operations#sql-union) for details.
</Info>
...
<a id="union-compatible-data-types-1"></a>

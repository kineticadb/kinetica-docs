...
The SQL [FILTER_BY_STRING](/content/sql/query/string-functions#sql-string-functions-fts) function, as well as the
[/filter/bystring](/content/api/rest/filter_bystring_rest) endpoint, enables the use of several
...
<a id="required-optional-prohibited-matches"></a>

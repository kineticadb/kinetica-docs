...
[CREATE STREAM](/content/sql/ddl/create-stream#sql-create-stream) command in SQL), or when referenced as the
...
managing *data sinks* in SQL, see [CREATE DATA SINK](/content/sql/ddl/create-data-sink#sql-create-data-sink).

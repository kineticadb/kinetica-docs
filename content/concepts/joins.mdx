...
<Info>
For SQL views, see [CREATE VIEW](/content/sql/ddl/create-view#sql-create-view).
</Info>
...
A [SQL join](/content/sql/query/join#sql-join) is performed automatically when the database

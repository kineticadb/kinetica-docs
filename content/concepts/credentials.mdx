...
* [Data sources](/content/concepts/data_sources)
  (see also the [CREATE DATA SOURCE](/content/sql/ddl/create-data-source#sql-create-data-source) command in SQL)
* [Data sinks](/content/concepts/data_sinks)
  (see also the [CREATE DATA SINK](/content/sql/ddl/create-data-sink#sql-create-data-sink) command in SQL)
...
managing *credentials* in SQL, see [CREATE CREDENTIAL](/content/sql/ddl/create-credential#sql-create-credential).

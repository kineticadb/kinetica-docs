...
A *table monitor* (SQL [Stream](/content/sql/ddl/create-stream#sql-create-stream)) is an entity
...
managing *table monitors* in SQL, see [CREATE STREAM](/content/sql/ddl/create-stream#sql-create-stream).

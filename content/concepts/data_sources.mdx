...
* [External tables](/content/concepts/external_tables)
  (see also the [CREATE EXTERNAL TABLE](/content/sql/ddl/create-external-table#sql-create-ext-table) command in SQL)
...
managing *data sources* in SQL, see [CREATE DATA SOURCE](/content/sql/ddl/create-data-source#sql-create-data-source).

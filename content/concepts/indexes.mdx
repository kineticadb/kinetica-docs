...
<Tip>
For *primary key* SQL syntax, see [CREATE TABLE](/content/sql/ddl/create-table#sql-create-table).
</Tip>
...
[CREATE TABLE](/content/sql/ddl/create-table#sql-create-table), as well as afterwards, via
[ALTER TABLE](/content/sql/ddl/alter-table#sql-alter-table-foreign-key-add).
</Tip>

<a id="column-index"></a>


<a id="column-index-1"></a>
## Column Index
...
[CREATE TABLE index clause](/content/sql/ddl/create-table#sql-create-table-index), as well as
afterwards, via
[ALTER TABLE](/content/sql/ddl/alter-table#sql-alter-table-column-index-add).
</Tip>
...
<a id="low-cardinality-index-1"></a>
...
the [CREATE TABLE index clause](/content/sql/ddl/create-table#sql-create-table-index), as
well as afterwards, via
[ALTER TABLE](/content/sql/ddl/alter-table#sql-alter-table-chunk-skip-index-add).
</Tip>
...
* A *chunk skip index* can be applied to any *table* column except the
  following:
...
the [CREATE TABLE index clause](/content/sql/ddl/create-table#sql-create-table-index), as
well as afterwards, via
[ALTER TABLE](/content/sql/ddl/alter-table#sql-alter-table-geospatial-index-add).
</Tip>
...
[CREATE TABLE index clause](/content/sql/ddl/create-table#sql-create-table-index), as well as
afterwards, via
[ALTER TABLE](/content/sql/ddl/alter-table#sql-alter-table-cagra-index-add).
</Tip>
...
[CREATE TABLE index clause](/content/sql/ddl/create-table#sql-create-table-index), as well as
afterwards, via
[ALTER TABLE](/content/sql/ddl/alter-table#sql-alter-table-hnsw-index-add).
</Tip>

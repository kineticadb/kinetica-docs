...
<a id="expression-functions-array"></a>


### Array Functions


<a id="expression-functions-array-scalar"></a>
...
<a id="expression-functions-array-agg"></a>


<a id="aggregation-transposition-functions"></a>
...
<a id="date-time-conversion-codes"></a>
...
<a id="geospatial-geometry-functions"></a>
...
<a id="expression-functions-json"></a>


### JSON Functions


<a id="expression-functions-json-scalar"></a>


<a id="scalar-functions-2"></a>
#### Scalar Functions
...
<a id="expression-functions-json-agg"></a>


<a id="aggregation-functions-1"></a>
#### Aggregation Functions
...
<a id="expression-functions-math"></a>


### Math Functions


<a id="scalar-functions-3"></a>
#### Scalar Functions
...
<a id="expression-functions-math-agg"></a>
...
Returns *false* if `expr_a` equals `expr_b` or both are *null*; otherwise, returns
*true*.  Unlike `<>`, returns *true* (not *null*) when exactly one expression is *null*.
Both expressions should be of the same or convertible data type.

</Accordion>

<Accordion title="IS_NOT_DISTINCT_FROM(expr_a, expr_b)" id="is_not_distinct_from-expr_a-expr_b" defaultOpen>

Returns *true* if `expr_a` equals `expr_b` or both are *null*; otherwise, returns
*false*.  Unlike `=`, returns *false* (not *null*) when exactly one expression is *null*.
Both expressions should be of the same or convertible data type.
...
<a id="expression-functions-string"></a>
...
<a id="expression-functions-string-scalar"></a>


<a id="scalar-functions-4"></a>
#### Scalar Functions
...
<a id="expression-functions-string-agg"></a>


<a id="aggregate-functions-1"></a>
#### Aggregate Functions
...
<a id="user-security-functions"></a>
...
<a id="expression-functions-lookup-agg"></a>
...
It also applies to
[SQL conditional functions](/content/sql/query/conditional-functions#sql-conditional-functions).

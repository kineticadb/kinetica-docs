...
`INTERSECT` of two tables.  See [CREATE TABLE ... AS](/content/sql/ddl/create-table-as#sql-create-table-as) and
[INTERSECT](/content/sql/query/set-operations#sql-intersect) for details.
</Info>

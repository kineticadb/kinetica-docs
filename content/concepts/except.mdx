...
`EXCEPT` of two tables.  See [CREATE TABLE ... AS](/content/sql/ddl/create-table-as#sql-create-table-as) and
[EXCEPT](/content/sql/query/set-operations#sql-except) for details.
</Info>

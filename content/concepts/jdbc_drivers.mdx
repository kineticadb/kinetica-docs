...
| [Informix](https://www.ibm.com/docs/en/informix-servers/15.0.x?topic=started-informix-jdbc-driver) | `jdbc:informix-sqli://localhost:1526/mydb:INFORMIXSERVER=server` |
...
| [PrestoDB](https://prestodb.io/docs/current/clients/java.html) | `jdbc:presto://<HOST>:8080/<CATALOG>/<SCHEMA>` |

...
<a id="concat-truncate-function"></a>
...
If [AAW](https://legacydocs.kinetica.com/7.1/aaw/overview/) is being used, [ingests](https://legacydocs.kinetica.com/7.1/aaw/data/) will

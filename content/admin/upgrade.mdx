...
[Kinetica 7.1 Upgrade instructions](https://legacydocs.kinetica.com/7.1/admin/upgrade/)
...
* If [AAW](https://legacydocs.kinetica.com/7.1/aaw/overview/) is being used, terminate all [ingests](https://legacydocs.kinetica.com/7.1/aaw/data/) and [deployed models](https://legacydocs.kinetica.com/7.1/aaw/deployments/).


<a id="upgrade-actions"></a>


<a id="upgrade-actions-1"></a>
## Upgrade Actions
...
<a id="managed-cluster-upgrade-1"></a>
...
<a id="unmanaged-cluster-upgrade-1"></a>
...
* If [AAW](https://legacydocs.kinetica.com/7.1/aaw/overview/) was being used in the *ring* that was upgraded:
...
<a id="install-new-odbc-jdbc-drivers"></a>

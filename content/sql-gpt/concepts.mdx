...
*SQL-GPT* is a Kinetica generative AI capability that produces SQL based on
...
within a database [schema](/content/sql/ddl/create-schema#sql-create-schema) and has
...
Increasing the size of the *context* is a trade-off.  The *SQLGPT.io* service
...
* **Limit the number of tables included in the context.**
  ...
  [view](/content/sql/ddl/create-view#sql-create-view) that connects them along their
...
* **Limit the number of columns in the context.**
  ...
  then create a [view](/content/sql/ddl/create-view#sql-create-view) with only the columns

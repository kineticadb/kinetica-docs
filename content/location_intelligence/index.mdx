...
- [Create Table w/ Index (SQL)](/content/sql/ddl/create-table#sql-create-table-index)
- [Add Index (SQL)](/content/sql/ddl/alter-table#sql-alter-table-geospatial-index-add)
</Card>

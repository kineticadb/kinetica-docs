...
* [nyc_neighborhood](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/data/nyc_neighborhood.csv)
...
[nyc_neighborhood](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/data/nyc_neighborhood.csv) with the
...
| `MAX_LEVEL` | Maximum isoline value to be shown. <br/> <Info> If `ADJUST_LEVELS` is `true` (default) this value will be calculated automatically. </Info> | Number | `-1` |
...
| `MIN_LEVEL` | Minimum isoline value to be shown. <br/> <Info> If `ADJUST_LEVELS` is `true` (default) this value will be calculated automatically. </Info> | Number | `-1` |

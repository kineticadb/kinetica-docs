...
[SET CURRENT SCHEMA](/content/sql/ddl/set-current-schema#sql-current-schema) command at the beginning of the session.
...
Display the [schemas](/content/sql/ddl/create-schema#sql-create-schema) to which the user has access.

</Accordion>

<Accordion title="&lt; \t | \tables &gt; [&lt;schema [&lt;table&gt;]]" id="<-t-|-tables->-<schema-<table>" defaultOpen>

Display the [tables](/content/sql/ddl/create-table#sql-create-table) &
[views](/content/sql/ddl/create-view#sql-create-view) to which the user has access.
...
Display the columns of [tables](/content/sql/ddl/create-table#sql-create-table) &
[views](/content/sql/ddl/create-view#sql-create-view) to which the user has access.

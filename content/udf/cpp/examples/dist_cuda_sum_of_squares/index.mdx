...
* [udf_sos_cpp_init.py](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/udf/cpp/examples/dist_cuda_sum_of_squares/udf_sos_cpp_init.py): creates the schema, input & output tables,
  and loads test data
* [udf_sos_cpp_proc.cu](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/udf/cpp/examples/dist_cuda_sum_of_squares/udf_sos_cpp_proc.cu): implements the *UDF* itself
...
* [udf_sos_cpp_exec.py](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/udf/cpp/examples/dist_cuda_sum_of_squares/udf_sos_cpp_exec.py): creates & executes the *UDF*

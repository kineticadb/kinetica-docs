...
API, an environment name can be passed into the [create_environment()](/content/api/python/source/gpudb.html#gpudb.GPUdb.create_environment) call
([CREATE FUNCTION ENVIRONMENT](/content/sql/udf#sql-create-function-environment) in SQL) and then
[alter_environment()](/content/api/python/source/gpudb.html#gpudb.GPUdb.alter_environment) ([ALTER FUNCTION ENVIRONMENT](/content/sql/udf#sql-alter-function-environment) in SQL)
...
Calling the [create_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.create_proc) method ([CREATE FUNCTION](/content/sql/udf#sql-create-function) in SQL)
...
use when [execute_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.execute_proc) is called.
...
See [create_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.create_proc) for more details.
...
[create_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.create_proc) call as a `files` map, with the key as the name of the file
...
[create_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.create_proc) call, with the key as the *KiFS* path to the file and the value
...
Calling the [execute_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.execute_proc) method (see [Executing Functions](/content/sql/udf#sql-execute-function) in
...
Optional parameters for UDF execution; see [execute_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.execute_proc) for details
...
| --- | --- | --- |
| [delete_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.delete_proc) | [DROP FUNCTION](/content/sql/udf#sql-drop-function) | Removes the given UDF definition from the system; needs to be called before [create_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.create_proc) when recreating a UDF |
| [has_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.has_proc) |  | Returns whether the given UDF exists |
| [kill_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.kill_proc) |  | Terminates a running UDF (or UDFs) |
| [show_proc()](/content/api/python/source/gpudb.html#gpudb.GPUdb.show_proc) | [SHOW FUNCTION](/content/sql/udf#sql-show-function) | Returns the parameter values used in creating the UDF |
| [show_proc_status()](/content/api/python/source/gpudb.html#gpudb.GPUdb.show_proc_status) | [SHOW FUNCTION STATUS](/content/sql/udf#sql-show-function-status) | Returns whether the UDF (or UDFs) is still running, has completed, or has exited with an error, along with any processed results |

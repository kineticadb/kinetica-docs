...
<Card title="Data Sources" href="/content/sql/ddl/create-data-source#sql-create-data-source">
- [CREATE DATA SOURCE](/content/sql/ddl/create-data-source#sql-create-data-source)
- [CREATE CREDENTIAL](/content/sql/ddl/create-credential#sql-create-credential)

...
[credential](/content/sql/ddl/create-credential#sql-create-credential) and a
[data source](/content/sql/ddl/create-data-source#sql-create-data-source) object in Kinetica before

...
1. Upload the local file to *KiFS* using
   [upload_files](/content/api/python/source/gpudb#gpudb.GPUdb.upload_files),
...
it.  The
[create_directory](/content/api/python/source/gpudb#gpudb.GPUdb.create_directory)
...
[GPUdb.get_records](/content/api/python/source/gpudb#gpudb.GPUdb.get_records)
method:

...
<a id="python-api-installation-1"></a>
...
<a id="python-api-installation-2"></a>
### Python API Installation
...
<a id="python-virtual-environment"></a>
...
[insert_records](/content/api/python/source/gpudbtable#gpudb.GPUdbTable.insert_records)
...
1. Upload the local file to *KiFS* using
   [upload_files](/content/api/python/source/gpudb/upload-files#gpudb.GPUdb.upload_files),
...
2. Insert the data from the uploaded file in *KiFS* using
   [insert_records_from_files](/content/api/python/source/gpudb/insert-records-from-files#gpudb.GPUdb.insert_records_from_files),
...
it.  The
[create_directory](/content/api/python/source/gpudb/create-directory#gpudb.GPUdb.create_directory)
...
[GPUdbTable.get_records](/content/api/python/source/gpudbtable#gpudb.GPUdbTable.get_records)
...
[GPUdb.get_records](/content/api/python/source/gpudb/get-records#gpudb.GPUdb.get_records)
method:
...
[update_records](/content/api/python/source/gpudbtable#gpudb.GPUdbTable.update_records)
method.
...
[delete_records](/content/api/python/source/gpudbtable#gpudb.GPUdbTable.delete_records)
...
[alter_table](/content/api/python/source/gpudbtable#gpudb.GPUdbTable.alter_table),
...
performed using the
[create_join_table](/content/api/python/source/gpudbtable#gpudb.GPUdbTable.create_join_table)
...
tutorial using
[create_projection](/content/api/python/source/gpudbtable#gpudb.GPUdbTable.create_projection).
</Info>
...
[create_union](/content/api/python/source/gpudbtable#gpudb.GPUdbTable.create_union)

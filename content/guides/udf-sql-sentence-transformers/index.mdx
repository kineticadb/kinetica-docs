...
* [udf_st.kisql](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/sql/udf/st/udf_st.kisql) - UDF management script, in
...
* [udf_st.py](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/python/udf/udf_st.py) - the UDF, written using
  the Python UDF API, which contains the semantic search example
* [sentences.txt](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/data/sentences.txt) - the data file containing

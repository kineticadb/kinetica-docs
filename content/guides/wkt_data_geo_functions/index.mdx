...
* Sample CSV data files, which should be downloaded & copied to the host running
  ...
  * [NYC Neighborhood](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/data/nyc_neighborhood.csv)
  * [Taxi Trip Data](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/data/taxi_trip_data.csv)
  * [Taxi Zone](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/data/taxi_zone.csv)
...
Create a [schema](/content/sql/ddl/create-schema#sql-create-schema) to house the example tables.
...
[Scalar Functions](/content/sql/query/geospatial-geometry-functions#sql-geo-functions-scalar) and
[Enhanced Performance Scalar Functions](/content/sql/query/geospatial-geometry-functions#sql-geo-functions-scalar-ep).
...
[Aggregation Functions](/content/sql/query/geospatial-geometry-functions#sql-geo-functions-aggregation).
...
For details on these functions see [Scalar Functions](/content/sql/query/geospatial-geometry-functions#sql-geo-functions-scalar).
...
<a id="creating-a-table-and-inserting-wkt-data-1"></a>
### Creating a Table and Inserting WKT Data
...
* Python *(see* [Python Developer Guide](/content/guides/python_guide) *for configuration & execution*
  ...
  * [geospatial_examples.py](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/python/geospatial_examples.py)
  * [Python Output](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/python/geospatial_examples.out)

* SQL *(see* [ODBC/JDBC Connector](/content/connectors/sql_guide)
  *for configuration & execution details)*

  * [geospatial_examples.kisql](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/sql/geospatial_examples.kisql)
  * [SQL Output](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/sql/geospatial_examples.out)

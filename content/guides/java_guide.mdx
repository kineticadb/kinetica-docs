...
[single request object](/content/api/java/com/gpudb/GPUdb/createtable#createTable(com.gpudb.protocol.CreateTableRequest))
(`vendor` *table*) or a
[parameterized call](/content/api/java/com/gpudb/GPUdb/createtable#createTable(java.lang.String,java.lang.String,java.util.Map))
(`payment` *table*):
...
[insertRecords()](/content/api/java/com/gpudb/GPUdb/insertrecords#insertRecords(java.lang.String,java.util.List,java.util.Map))
will be used.


<a id="key-value-record"></a>
### Key/Value Record
...
[GPUdbFileHandler](/content/api/java/com/gpudb/filesystem/GPUdbFileHandler).  This can
...
system by a call to
[getRecords(tableName, offset, limit, options)](/content/api/java/com/gpudb/GPUdb/getrecords#getRecords(java.lang.String,long,long,java.util.Map))
...
One can also invoke
[getRecords(request)](/content/api/java/com/gpudb/GPUdb/getrecords#getRecords(com.gpudb.protocol.GetRecordsRequest))
using the
...
Use
[updateRecords()](/content/api/java/com/gpudb/GPUdb/updaterecords#updateRecords(java.lang.String,java.util.List,java.util.List,java.util.List,java.util.Map))
...
Use
[deleteRecords()](/content/api/java/com/gpudb/GPUdb/deleterecords#deleteRecords(java.lang.String,java.util.List,java.util.Map))
to delete records from a *table*. A list can be used to specify which records to
delete based on matching expressions.  Set
[DELETE_ALL_RECORDS](/content/api/java/com/gpudb/protocol/DeleteRecordsRequest.Options#DELETE_ALL_RECORDS) to
...
[alterTable()](/content/api/java/com/gpudb/GPUdb/altertable#alterTable(java.lang.String,java.lang.String,java.lang.String,java.util.Map)),
...
[CREATE_INDEX](/content/api/java/com/gpudb/protocol/AlterTableRequest.Action#CREATE_INDEX)
...
[CHANGE_COLUMN](/content/api/java/com/gpudb/protocol/AlterTableRequest.Action#CHANGE_COLUMN)
...
performed using the
[createJoinTable()](/content/api/java/com/gpudb/GPUdb/createjointable#createJoinTable(java.lang.String,java.util.List,java.util.List,java.util.List,java.util.Map))
method.
...
tutorial using
[createProjection()](/content/api/java/com/gpudb/GPUdb/createprojection#createProjection(java.lang.String,java.lang.String,java.util.List,java.util.Map)).
</Info>
...
<a id="union-intersect-except"></a>
## Union, Intersect, & Except


[Union](/content/concepts/unions) can be used to combine homogeneous data
sets into one larger data set.  When calling the
[createUnion()](/content/api/java/com/gpudb/GPUdb/createunion#createUnion(java.lang.String,java.util.List,java.util.List,java.util.List,java.util.Map))
method, a
...
or [UNION_DISTINCT](/content/api/java/com/gpudb/protocol/CreateUnionRequest.Options#UNION_DISTINCT)
...
[MODE](/content/api/java/com/gpudb/protocol/CreateUnionRequest.Options#MODE)
of [UNION_ALL](/content/api/java/com/gpudb/protocol/CreateUnionRequest.Options#UNION_ALL)
...
[MODE](/content/api/java/com/gpudb/protocol/CreateUnionRequest.Options#MODE)
of [INTERSECT_ALL](/content/api/java/com/gpudb/protocol/CreateUnionRequest.Options#INTERSECT_ALL)
...
[MODE](/content/api/java/com/gpudb/protocol/CreateUnionRequest.Options#MODE)
of [EXCEPT_ALL](/content/api/java/com/gpudb/protocol/CreateUnionRequest.Options#EXCEPT_ALL)

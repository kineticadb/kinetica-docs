...
* A UDF management program,
  [udf_tc_py_manager.py](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/udf/python/examples/table_copy/udf_tc_py_manager.py),
  written using the Python API, which creates the input & output tables, and
  creates the UDF and executes it.
* A UDF,
  [udf_tc_py_proc.py](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/udf/python/examples/table_copy/udf_tc_py_proc.py),
  written using the Python UDF API, which contains a table copying example.
* A CSV input file,
  [rank_tom.csv](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/data/rank_tom.csv), used to
  identify which processing nodes should copy data.


<a id="api-download-and-installation"></a>
...
[execute_proc()](/content/api/python/source/gpudb/execute-proc#gpudb.GPUdb.execute_proc)
...
[create_proc()](/content/api/python/source/gpudb/create-proc#gpudb.GPUdb.create_proc)
and
[execute_proc()](/content/api/python/source/gpudb/execute-proc#gpudb.GPUdb.execute_proc)
(respectively).
...
<a id="initialization-(udf-tc-py-manager.py-init)"></a>
<a id="initialization-udf-tc-py-manager-py-init"></a>
...
<a id="execution-udf-tc-py-manager-py-exec"></a>

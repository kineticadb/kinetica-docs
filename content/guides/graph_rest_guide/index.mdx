...
<VideoEmbed id="oLYIPBRteEM" thumb="/content/guides/graph_rest_guide/video-graph-modeling.jpg" title="Graph Modeling Concepts" caption="Model a graph with four components" />
...
A call to the [/create/graph](/content/api/rest/create_graph_rest) endpoint looks like:
...
<VideoEmbed id="lmrCY_CDF_k" thumb="/content/guides/graph_rest_guide/video-create-graph.jpg" title="Create a Graph" caption="Creating a graph with four components" />
...
<a id="solve-the-graph-shortest-path"></a>
### Solve the Graph (Shortest Path)


<VideoEmbed id="-lUZo2GMSes" thumb="/content/guides/graph_rest_guide/video-dijkstra.jpg" title="Dijkstra's Shortest Path" caption="An illustration of Dijkstra in Kinetica" />
...
<a id="solve-the-graph-multiple-routing"></a>
...
* [Graph tutorial script](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/bash/graph/rest_tutorial/graphs_rest.sh)
* [/create/graph JSON](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/bash/graph/rest_tutorial/create_graph.json)
* [/solve/graph JSON (shortest path)](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/bash/graph/rest_tutorial/solve_graph_shortest_path.json)
* [/solve/graph JSON (multiple routing)](https://raw.githubusercontent.com/kineticadb/kinetica-docs/master/content/examples/bash/graph/rest_tutorial/solve_graph_multiple_routing.json)

...
* Added schema-based namespacing for
  ...
  [streams](/content/sql/ddl/create-stream#sql-create-stream); allowing any of these object types
  with a given name to exist in more than one schema
* Added [PREDICT](/content/sql/query/ml-functions#sql-ml-functions-predict) &
  [OUTLIERS](/content/sql/query/ml-functions#sql-ml-functions-outliers) SQL ML functions for
  predicting values and calculating outliers from a data set without a model
* Added `SKEW` & `KURTOSIS` (and variants of each)
  [SQL aggregation functions](/content/sql/query/aggregation-functions#sql-aggregation-functions)
...
* Added support for ingesting Avro files using an
  [external table](/content/sql/ddl/create-external-table#sql-create-ext-table) or
...
* Added [functions](/content/sql/query/conversion-functions#sql-conversion-functions) to convert
...
<a id="geospatial-network-graph-visualization-4"></a>
### Geospatial/Network Graph/Visualization
...
* Added data sinks, which are references to external systems that can receive
  data streamed from *Kinetica*, in [SQL](/content/sql/ddl/create-data-sink#sql-create-data-sink)
...
<a id="geospatial-network-graph-visualization-5"></a>
### Geospatial/Network Graph/Visualization
...
* Added managed credential framework for authenticating to external data sources
  and model repositories, in [SQL](/content/sql/ddl/create-credential#sql-create-credential) and
...
<a id="geospatial-network-graph-visualization-6"></a>
### Geospatial/Network Graph/Visualization
...
<a id="geospatial-network-graph-visualization-7"></a>
### Geospatial/Network Graph/Visualization
...
* Improved performance of handling `GROUP BY`
  [operations](/content/sql/query/aggregation#sql-aggregation) resulting in a
...
<a id="geospatial-network-graph-visualization-8"></a>
### Geospatial/Network Graph/Visualization
...
<a id="geospatial-network-graph-visualization-9"></a>
### Geospatial/Network Graph/Visualization

...
* Improvements to [aggregation](/content/api/rest/aggregate_groupby_rest):
  ...
  * Aggregates can now be listed before grouping attributes in the column name
    list
  * Additional grouping functions (for both [SQL](/content/sql/query/grouping#sql-grouping)
...
* Full Materialized View support via [SQL](/content/sql/ddl/create-view#sql-create-view) or the
...
* SQL Views & Materialized Views
  ...
  * [Create View](/content/sql/ddl/create-view#sql-create-view)
  * [Alter View](/content/sql/ddl/alter-view#sql-alter-view)
  * [Refresh View](/content/sql/ddl/refresh-view#sql-refresh-view)
  * [Drop View](/content/sql/ddl/drop-view#sql-drop-view)

* Operations:

  * [Window](/content/sql/query/window#sql-window) Functions
  * [Pivot](/content/sql/query/pivot#sql-pivot)
  * [Unpivot](/content/sql/query/unpivot#sql-unpivot)
  * Grouping Functions
...
<a id="user-defined-functions-udfs"></a>

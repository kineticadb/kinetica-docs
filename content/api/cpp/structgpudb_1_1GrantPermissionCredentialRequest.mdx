...
<p>\[DEPRECATED&ndash;please use <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb#a9634c497d7035ee98062b6f92a63be8d">GPUdb::grantPermission</a> instead\] Grants a <a href="/content/security/sec_concepts/#security-concepts-permissions-credential" target="_top">credential-level permission</a> to a user or role. </p>

...
<div id="a9e3cf621f47f06fb5211ae54f1e46f93"></div>
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/altersystemproperties#a9e3cf621f47f06fb5211ae54f1e46f93">&#9670;&#160;</a></span>alterSystemProperties() <span className="overload">\[1/4\]</span></h2>
...
<p>The <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/altersystemproperties#a9e3cf621f47f06fb5211ae54f1e46f93">alterSystemProperties</a> endpoint is primarily used to simplify the testing of the system and is not expected to be used during normal execution. </p>
...
<div id="a725871fdb042d46d3ba27650b0cbd6d4"></div>
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/altersystemproperties#a725871fdb042d46d3ba27650b0cbd6d4">&#9670;&#160;</a></span>alterSystemProperties() <span className="overload">\[2/4\]</span></h2>
<div className="memitem">
<div className="memproto">
<table className="memname">
<tr>
...
<div id="a3c2c2636d3219216039c6ea52176acfd"></div>
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/altersystemproperties#a3c2c2636d3219216039c6ea52176acfd">&#9670;&#160;</a></span>alterSystemProperties() <span className="overload">\[3/4\]</span></h2>
<div className="memitem">
<div className="memproto">
<table className="memname">
<tr>
...
<div className="memdoc">
<p>The <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/altersystemproperties#a3c2c2636d3219216039c6ea52176acfd">alterSystemProperties</a> endpoint is primarily used to simplify the testing of the system and is not expected to be used during normal execution. </p>
...
<li> <a className="el" href="/content/api/cpp/namespacegpudb#ace6ae643f8e0ca48bec6bf1453987439">alter\_system\_properties\_request\_timeout</a>: Number of minutes after which filtering (e.g., <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/filter#ac5b65e73c01c331f1fcfb21b0e8d67ce">filter</a>) and aggregating (e.g., <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/aggregategroupby#a30cac962c6aedc8efc312e2b4217ff31">aggregateGroupBy</a>) queries will timeout. The default value is '20'. The minimum allowed value is '0'. The maximum allowed value is '1440'. </li>
...
<div id="a4bdc47a1dd96b3a0af606a967eb8b00a"></div>
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/altersystemproperties#a4bdc47a1dd96b3a0af606a967eb8b00a">&#9670;&#160;</a></span>alterSystemProperties() <span className="overload">\[4/4\]</span></h2>
<div className="memitem">
<div className="memproto">
<table className="memname">
<tr>

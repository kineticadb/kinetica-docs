...
<p>\[DEPRECATED&ndash;please use <a className="el" href="#a9634c497d7035ee98062b6f92a63be8d">grantPermission</a> instead\] Grants a table-level permission to a user or role. </p>
...
<div className="memdoc">
<p>\[DEPRECATED&ndash;please use <a className="el" href="#ad2439e67beadacbe234814ad9c4e4691">grantPermission</a> instead\] Grants a table-level permission to a user or role. </p>
<div className="dl params">
<div className="dt">Parameters</div>
<div className="dd">
<table className="params">

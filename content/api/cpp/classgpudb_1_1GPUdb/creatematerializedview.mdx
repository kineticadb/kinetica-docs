...
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/creatematerializedview#a494c22211d9100d2c5ca53d4f6cef62a">&#9670;&#160;</a></span>createMaterializedView() <span className="overload">\[1/4\]</span></h2>
...
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/creatematerializedview#ad86909729ba25bf8a3c781bb50c954dd">&#9670;&#160;</a></span>createMaterializedView() <span className="overload">\[2/4\]</span></h2>
<div className="memitem">
<div className="memproto">
<table className="memname">
<tr>
...
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/creatematerializedview#a4c585a19766a2de5755448429f034b61">&#9670;&#160;</a></span>createMaterializedView() <span className="overload">\[3/4\]</span></h2>
<div className="memitem">
<div className="memproto">
<table className="memname">
<tr>
...
Optional parameters. 
<ul>
<li> <a className="el" href="/content/api/cpp/namespacegpudb#a58d239e3cec45a6b09e1a17b687047e3">create\_materialized\_view\_collection\_name</a>: \[DEPRECATED&ndash;please specify the containing schema for the materialized view as part of <span className="em arg">tableName</span> and use <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/createschema#a33d9a0a8e738d14b688f9f869f9640ad">createSchema</a> to create the schema if non-existent\] Name of a schema which is to contain the newly created view. If the schema provided is non-existent, it will be automatically created. </li>
...
<ul>
<li> <a className="el" href="/content/api/cpp/namespacegpudb#ac0c7b9d1607509c6795e19c216459568">create\_materialized\_view\_manual</a>: Refresh only occurs when manually requested by calling <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/altertable#a25df43fa85e02f0cdb3dab9e498995ce">alterTable</a> with an 'action' of 'refresh'. </li>
...
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/creatematerializedview#abfa74ba57b3f32437a9855e2ffbc93f2">&#9670;&#160;</a></span>createMaterializedView() <span className="overload">\[4/4\]</span></h2>
<div className="memitem">
<div className="memproto">
<table className="memname">
<tr>

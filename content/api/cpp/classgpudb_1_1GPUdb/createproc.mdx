...
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/createproc#aece60959dc14eef09c0a3b390ddee6ea">&#9670;&#160;</a></span>createProc() <span className="overload">\[1/4\]</span></h2>
...
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/createproc#a7d1cc69f145c8d5bfe9d49defc76f52c">&#9670;&#160;</a></span>createProc() <span className="overload">\[2/4\]</span></h2>
<div className="memitem">
<div className="memproto">
<table className="memname">
<tr>
...
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/createproc#ace48ccb741aa8b5aaec6fca25b235fe0">&#9670;&#160;</a></span>createProc() <span className="overload">\[3/4\]</span></h2>
<div className="memitem">
<div className="memproto">
<table className="memname">
<tr>
...
<li> <a className="el" href="/content/api/cpp/namespacegpudb#a188933cd80dde132f4ee0bb4778f6104">create\_proc\_nondistributed</a>: The proc command will be invoked only once per execution, and will not have direct access to any tables named as input or output table parameters in the call to <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/executeproc#a19f569cb61a53022021bbfd9e031468d">executeProc</a>. It will, however, be able to access the database using native API calls. </li>
</ul>
...
<h2 className="memtitle"><span className="permalink"><a href="/content/api/cpp/classgpudb_1_1GPUdb/createproc#ac9fc234ac65973e64a8a832afeab6017">&#9670;&#160;</a></span>createProc() <span className="overload">\[4/4\]</span></h2>
<div className="memitem">
<div className="memproto">
<table className="memname">
<tr>

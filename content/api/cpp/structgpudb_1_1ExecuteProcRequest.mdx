...
<p>A set of parameters for <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/executeproc#aec2cf18c6185bf22d4fa351019b9924e">GPUdb::executeProc</a>. <a href="#details">More...</a></p>
<p><code>#include &lt;<a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">gpudb/protocol/execute\_proc.h</a>&gt;</code></p>
...
<p>A set of parameters for <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/executeproc#aec2cf18c6185bf22d4fa351019b9924e">GPUdb::executeProc</a>. </p>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h#L26">26</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">execute\_proc.h</a>.</p>
</div>
<h2 className="groupheader">Constructor &amp; Destructor Documentation</h2>
<div id="a802334a14d87aaff102ff561ca632174"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h#L31">31</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">execute\_proc.h</a>.</p>
</div>
</div>
<div id="a96cabc001440545f27d3eba700d71ff3"></div>
...
<li> <a className="el" href="/content/api/cpp/namespacegpudb#acf184a4291134ee67002d73c05e2d52a">execute\_proc\_run\_tag</a>: A string that, if not empty, can be used in subsequent calls to <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/showprocstatus#a1d460da9ead16a63d91e8a104805d0a6">GPUdb::showProcStatus</a> or <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/killproc#ac8fff6e61ada09d2fdb3bb336ccc321a">GPUdb::killProc</a> to identify the proc instance. The default value is ''. </li>
<li> <a className="el" href="/content/api/cpp/namespacegpudb#a696f20b78bdb37031a10510c6b99ed1a">execute\_proc\_max\_output\_lines</a>: The maximum number of lines of output from stdout and stderr to return via <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/showprocstatus#a1d460da9ead16a63d91e8a104805d0a6">GPUdb::showProcStatus</a>. If the number of lines output exceeds the maximum, earlier lines are discarded. The default value is '100'. </li>
<li>
<a className="el" href="/content/api/cpp/namespacegpudb#af73f384cadee446e2a1d258d74bb83bd">execute\_proc\_execute\_at\_startup</a>: If <a className="el" href="/content/api/cpp/namespacegpudb#a4da8f3f4e4c507d4ba6bf1d496959b32">true</a>, an instance of the proc will run when the database is started instead of running immediately. The <a className="el" href="/content/api/cpp/structgpudb_1_1ExecuteProcResponse#a8b7bda3af69d5ce923ea4d16dfe67e6c">runId</a> can be retrieved using <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/showproc#ae7427428b2214adb5622e723382cb304">GPUdb::showProc</a> and used in <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/showprocstatus#a1d460da9ead16a63d91e8a104805d0a6">GPUdb::showProcStatus</a>. Supported values: 
<ul>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h#L171">171</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">execute\_proc.h</a>.</p>
</div>
</div>
<h2 className="groupheader">Member Data Documentation</h2>
<div id="a78091ef439284eae3bb4ccafe6e9c7e6"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h#L200">200</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">execute\_proc.h</a>.</p>
</div>
</div>
<div id="a6aa3d53ecdf763b74bf7156977dbd9e2"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h#L223">223</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">execute\_proc.h</a>.</p>
</div>
</div>
<div id="a25c972ab3d77a44d9fb6351f421f2ddf"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h#L212">212</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">execute\_proc.h</a>.</p>
</div>
</div>
<div id="a7f587f45c407ec9ada774001491397ba"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h#L293">293</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">execute\_proc.h</a>.</p>
</div>
</div>
<div id="a35ea220760e3f98e614f82775f3188c9"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h#L241">241</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">execute\_proc.h</a>.</p>
</div>
</div>
<div id="a83c9d66c7fecc1867f5f363dbd8b9025"></div>
...
<p>Each key/value pair specifies the name of a parameter and its value. The default value is an empty map. </p>
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h#L193">193</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">execute\_proc.h</a>.</p>
</div>
</div>
<div id="af815ca8df1f283d69972edf3195e57f4"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h#L186">186</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">execute\_proc.h</a>.</p>
</div>
</div>
<hr />
The documentation for this struct was generated from the following file:
<ul>
<li>gpudb/protocol/<a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/execute_proc.h">execute\_proc.h</a></li>
</ul>
</div>
</div>

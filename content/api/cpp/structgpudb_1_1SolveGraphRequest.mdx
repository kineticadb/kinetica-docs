...
<p>A set of parameters for <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/solvegraph#a53c721cb54a46730bbc465ee3a4a6dc3">GPUdb::solveGraph</a>. <a href="#details">More...</a></p>
<p><code>#include &lt;<a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">gpudb/protocol/solve\_graph.h</a>&gt;</code></p>
...
<p>A set of parameters for <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/solvegraph#a53c721cb54a46730bbc465ee3a4a6dc3">GPUdb::solveGraph</a>. </p>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h#L26">26</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a>.</p>
</div>
<h2 className="groupheader">Constructor &amp; Destructor Documentation</h2>
<div id="af447ca9b00d29575f7f681d9cfa65843"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h#L31">31</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a>.</p>
</div>
</div>
<div id="a030faabf2ca1112dfdfeb7f007f42ace"></div>
...
<li> <a className="el" href="/content/api/cpp/namespacegpudb#a3d701158a1bd0fa7bf0db839cb61712c">solve\_graph\_left\_turn\_penalty</a>: This will add an additional weight over the edges labeled as 'left turn' if the 'add\_turn' option parameter of the <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/creategraph#a4055b3b0cd047d5c78f8ab61350e1c4e">GPUdb::createGraph</a> was invoked at graph creation. The default value is '0.0'. </li>
<li> <a className="el" href="/content/api/cpp/namespacegpudb#a3c5821a9881f792878c7afdbbd6c0ee3">solve\_graph\_right\_turn\_penalty</a>: This will add an additional weight over the edges labeled as' right turn' if the 'add\_turn' option parameter of the <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/creategraph#a4055b3b0cd047d5c78f8ab61350e1c4e">GPUdb::createGraph</a> was invoked at graph creation. The default value is '0.0'. </li>
...
<li> <a className="el" href="/content/api/cpp/namespacegpudb#a5d9de19fd9cab98fc0a756bb2d9e6260">solve\_graph\_sharp\_turn\_penalty</a>: This will add an additional weight over the edges labeled as 'sharp turn' or 'u-turn' if the 'add\_turn' option parameter of the <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/creategraph#a4055b3b0cd047d5c78f8ab61350e1c4e">GPUdb::createGraph</a> was invoked at graph creation. The default value is '0.0'. </li>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h#L438">438</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a>.</p>
</div>
</div>
<h2 className="groupheader">Member Data Documentation</h2>
<div id="ace73a2a778c397d2261615f63276508d"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h#L564">564</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a>.</p>
</div>
</div>
<div id="a6ddc40c5d8241cdab240b198058bd954"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h#L453">453</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a>.</p>
</div>
</div>
<div id="ad6e408e0edfa4305ca94071029bddc97"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h#L746">746</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a>.</p>
</div>
</div>
<div id="a27edb8af90c3f6357d48f5ffb2aa9637"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h#L492">492</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a>.</p>
</div>
</div>
<div id="af80e7a304539de595c34bf5f84fa87a1"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h#L573">573</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a>.</p>
</div>
</div>
<div id="a68481c127833f10e35544feafebb1a3b"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h#L548">548</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a>.</p>
</div>
</div>
<div id="adff99592f7dcf9fded9d3adc8effedd8"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h#L556">556</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a>.</p>
</div>
</div>
<div id="a8290685ecc5f8fc6648da75bc004b930"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h#L472">472</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a>.</p>
</div>
</div>
<hr />
The documentation for this struct was generated from the following file:
<ul>
<li>gpudb/protocol/<a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/solve_graph.h">solve\_graph.h</a></li>
</ul>
</div>
</div>

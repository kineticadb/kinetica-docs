...
<p>A set of parameters for <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/filterbyseries#aa46f3221490a48a0145d65ed38a97563">GPUdb::filterBySeries</a>. <a href="#details">More...</a></p>
...
<p>A set of parameters for <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/filterbyseries#aa46f3221490a48a0145d65ed38a97563">GPUdb::filterBySeries</a>. </p>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h#L31">31</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h">filter\_by\_series.h</a>.</p>
</div>
<h2 className="groupheader">Constructor &amp; Destructor Documentation</h2>
<div id="ac4e3300c6c30dc9f25a0aae3c1c5fa02"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h#L36">36</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h">filter\_by\_series.h</a>.</p>
</div>
</div>
<div id="ae128c6c92e9f1671d9cfa5c113d551dc"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h#L156">156</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h">filter\_by\_series.h</a>.</p>
</div>
</div>
<h2 className="groupheader">Member Data Documentation</h2>
<div id="a2a785e9827ee9b245cdc210d1892aa7b"></div>
...
<li> <a className="el" href="/content/api/cpp/namespacegpudb#a0f1949519a0fb2b6a89bc27b55521629">filter\_by\_series\_collection\_name</a>: \[DEPRECATED&ndash;please specify the containing schema for the view as part of <a className="el" href="#a5528c1af9cefaf87b9fed1cf00b043ae">viewName</a> and use <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/createschema#a4aa5990ebebfab30b5961654f546cfd0">GPUdb::createSchema</a> to create the schema if non-existent\] Name of a schema for the newly created view. If the schema is non-existent, it will be automatically created. </li>
<li> <a className="el" href="/content/api/cpp/namespacegpudb#a92ef044c5b90a62b14df3c825c1dd7a8">filter\_by\_series\_spatial\_radius</a>: A positive number passed as a string representing the radius of the search area centered around each track point's geospatial coordinates. The value is interpreted in meters. Required parameter. The minimum allowed value is '0'. </li>
<li> <a className="el" href="/content/api/cpp/namespacegpudb#a32e0f3da5be3ec4af3e907c5ba6e7877">filter\_by\_series\_time\_radius</a>: A positive number passed as a string representing the maximum allowable time difference between the timestamps of a filtered object and the given track's points. The value is interpreted in seconds. Required parameter. The minimum allowed value is '0'. </li>
<li>
<a className="el" href="/content/api/cpp/namespacegpudb#afac16963cfa0d1d47e7a5a2054a0a3d6">filter\_by\_series\_spatial\_distance\_metric</a>: A string representing the coordinate system to use for the spatial search criteria. Acceptable values are 'euclidean' and 'great\_circle'. Optional parameter; default is 'euclidean'. Supported values: 
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h#L254">254</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h">filter\_by\_series.h</a>.</p>
</div>
</div>
<div id="a5f79f733665941347a71626fd23da2e8"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h#L173">173</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h">filter\_by\_series.h</a>.</p>
</div>
</div>
<div id="a043fb6d74605d4978bcb70487abdcc8c"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h#L196">196</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h">filter\_by\_series.h</a>.</p>
</div>
</div>
<div id="a9f29c816e51861d209badc2362e88e87"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h#L190">190</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h">filter\_by\_series.h</a>.</p>
</div>
</div>
<div id="a5528c1af9cefaf87b9fed1cf00b043ae"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h#L184">184</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/filter_by_series.h">filter\_by\_series.h</a>.</p>
</div>
</div>
<hr />

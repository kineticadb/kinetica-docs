...
<p>A set of parameters for <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/createprojection#aab22a8ee1b42ec6fa1acfc3b2f70cf4c">GPUdb::createProjection</a>. <a href="#details">More...</a></p>
<p><code>#include &lt;<a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h">gpudb/protocol/create\_projection.h</a>&gt;</code></p>
...
<p>A set of parameters for <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/createprojection#aab22a8ee1b42ec6fa1acfc3b2f70cf4c">GPUdb::createProjection</a>. </p>
...
<p><a href="/content/concepts/window/" target="_top">Window functions</a>, which can perform operations like moving averages, are available through this endpoint as well as <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/getrecordsbycolumn#aaf391f0f2e29974de30e9aa91dbed1ef">GPUdb::getRecordsByColumn</a>.</p>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h#L49">49</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h">create\_projection.h</a>.</p>
</div>
<h2 className="groupheader">Constructor &amp; Destructor Documentation</h2>
<div id="a7fda62880500749fd4d37f3eae9337de"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h#L54">54</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h">create\_projection.h</a>.</p>
</div>
</div>
<div id="ae9b5755a5d139068bc7d0a963312afc6"></div>
...
<li> <a className="el" href="/content/api/cpp/namespacegpudb#a4b085fdf38a2720aad2dcef61baa782c">create\_projection\_collection\_name</a>: \[DEPRECATED&ndash;please specify the containing schema for the projection as part of <span className="em arg">projectionName\_</span> and use <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/createschema#a4aa5990ebebfab30b5961654f546cfd0">GPUdb::createSchema</a> to create the schema if non-existent\] Name of a schema for the projection. If the schema is non-existent, it will be automatically created. The default value is ''. </li>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h#L432">432</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h">create\_projection.h</a>.</p>
</div>
</div>
<h2 className="groupheader">Member Data Documentation</h2>
<div id="ac3fa6b7eb768d6fb99461057d67648cb"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h#L465">465</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h">create\_projection.h</a>.</p>
</div>
</div>
<div id="ab3da6e601e28243ad11370543365571b"></div>
...
<li> <a className="el" href="/content/api/cpp/namespacegpudb#a4b085fdf38a2720aad2dcef61baa782c">create\_projection\_collection\_name</a>: \[DEPRECATED&ndash;please specify the containing schema for the projection as part of <a className="el" href="#a6f67f184f9bbfa164eab722aa9afa002">projectionName</a> and use <a className="el" href="/content/api/cpp/classgpudb_1_1GPUdb/createschema#a4aa5990ebebfab30b5961654f546cfd0">GPUdb::createSchema</a> to create the schema if non-existent\] Name of a schema for the projection. If the schema is non-existent, it will be automatically created. The default value is ''. </li>
<li> <a className="el" href="/content/api/cpp/namespacegpudb#aa1e7e946d6844a9b7b0b0842ed6f15c2">create\_projection\_expression</a>: An optional filter <a href="/content/concepts/expressions/" target="_top">expression</a> to be applied to the source table prior to the projection. The default value is ''. </li>
<li>
<a className="el" href="/content/api/cpp/namespacegpudb#ab815eac2419fe91846599262a0622361">create\_projection\_is\_replicated</a>: If <a className="el" href="/content/api/cpp/namespacegpudb#a5b599c793afdd772ef44a4215aa85cf5">true</a> then the projection will be replicated even if the source table is not. Supported values: 
<ul>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h#L707">707</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h">create\_projection.h</a>.</p>
</div>
</div>
<div id="a6f67f184f9bbfa164eab722aa9afa002"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h#L458">458</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h">create\_projection.h</a>.</p>
</div>
</div>
<div id="a13ca13a16564a1d19aa4572618771f7b"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h#L448">448</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h">create\_projection.h</a>.</p>
</div>
</div>
<hr />
The documentation for this struct was generated from the following file:
<ul>
<li>gpudb/protocol/<a className="el" href="https://github.com/kineticadb/kinetica-api-cpp/blob/master/gpudb/protocol/create_projection.h">create\_projection.h</a></li>
</ul>
</div>
</div>

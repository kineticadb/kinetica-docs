...
[max_get_records_size](../../config/#config-main-general) records), they
...
An array of binary-encoded data for the records to be binded to the SQL query.  Or use *query_parameters* to pass the data in JSON format.
...
'execute_sql_response' or 'none' in case of an error

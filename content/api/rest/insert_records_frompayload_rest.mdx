---
title: /insert/records/frompayload
---
...
Number of tasks for reading file per rank. Default will be [external_file_reader_num_tasks](../../config/#config-main-external-files).
...
When inserting records from multiple files: if *table_per_file*, then insert from each file into a new table. Currently supported only for shapefiles.

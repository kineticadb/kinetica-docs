...
[/admin/remove/ranks](/content/api/rest/admin_remove_ranks_rest) or manually
switched over to a new host using
[/admin/switchover](/content/api/rest/admin_switchover_rest) prior to host removal.
...
If set to *true*, only validation checks will be performed. No host is removed.
...
'admin_remove_host_response' or 'none' in case of an error

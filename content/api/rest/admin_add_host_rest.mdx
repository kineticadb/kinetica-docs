...
The publicly-accessible full path URL to the host manager on the host being added, e.g., 'http://172.123.45.67:9300'. The default host manager port can be found in the [list of ports](../../install/shared/ports/) used by Kinetica.
...
'admin_add_host_response' or 'none' in case of an error

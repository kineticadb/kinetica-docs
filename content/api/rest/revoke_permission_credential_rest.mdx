...
'revoke_permission_credential_response' or 'none' in case of an error
...
This embedded JSON represents the result of the /revoke/permission/credential endpoint:

...
Name of the table on which the filter by range operation will be performed, in [schema_name.]table_name format, using standard [name resolution rules](../../concepts/tables/#table-name-resolution). Must be an existing table.
...
'filter_by_range_response' or 'none' in case of an error

---
title: /insert/records/fromquery
---
...
Number of splits for reading data per rank. Default will be [external_file_reader_num_tasks](../../config/#config-main-external-files).
...
Number of tasks for reading data per rank. Default will be [external_file_reader_num_tasks](../../config/#config-main-external-files).
...
If set to *true*, truncates the table specified by input parameter *table_name* prior to loading the data.

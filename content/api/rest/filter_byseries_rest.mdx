...
Name of the table on which the filter by track operation will be performed, in [schema_name.]table_name format, using standard [name resolution rules](../../concepts/tables/#table-name-resolution). Must be a currently existing table with a [track](../../location_intelligence/geo_objects/) present.

...
Names of the tables to be cleared, in [schema_name.]table_name format, using standard [name resolution rules](../../concepts/tables/#table-name-resolution). Must be existing tables. Empty list clears all available tables, though this behavior is prevented by default via system configuration parameter [disable_clear_all](../../config/#config-main-general).

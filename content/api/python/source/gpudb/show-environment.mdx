...
<div className="dd">
<p>Shows information about a specified <a className="reference external" href="/content/udf_overview">user-defined function</a> (UDF) environment or all environments. Returns detailed information about existing environments.</p>

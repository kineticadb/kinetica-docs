...
<div className="dd">
<p>If True, then if the type is not already found, then to look it up by invoking <a className="reference internal" href="/content/api/python/source/gpudb/show-types#gpudb.GPUdb.show_types" title="gpudb.GPUdb.show_types"><code className="xref py py-meth docutils literal notranslate"><span className="pre">show\_types()</span></code></a>, save it for the future, and return it.</p>
</div>
</div>
</div>
</div>

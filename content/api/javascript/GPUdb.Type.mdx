...
<h2><span className="attribs"><span className="type-signature"></span></span> <span className="ancestors"><a href="/content/api/javascript/GPUdb">GPUdb</a>.</span>Type<span className="signature">(label, &hellip;columns)</span><span className="type-signature"></span></h2>
...
<ul className="dummy">
<li> <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js">GPUdb.js</a>, <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js#L1105">line 1105</a> </li>
</ul>
</div>
</div>
</div>
...
<h4 className="name" id="columns"><span className="type-signature"></span>columns<span className="type-signature"> :Array.&lt;<a href="/content/api/javascript/GPUdb.Type.Column">GPUdb.Type.Column</a>&gt;</span></h4>
...
<div className="dd tag-source">
<ul className="dummy">
<li> <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js">GPUdb.js</a>, <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js#L1115">line 1115</a> </li>
</ul>
</div>
</div>
...
<div className="dd tag-source">
<ul className="dummy">
<li> <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js">GPUdb.js</a>, <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js#L1106">line 1106</a> </li>
</ul>
</div>
</div>
<h3 className="subsection-title">Methods</h3>
<h4 className="name" id="create"><span className="type-signature"></span>create<span className="signature">(gpudb, callback<span className="signature-attributes">opt</span>)</span><span className="type-signature"> &rarr; {"{"}String{"}"}</span></h4>
...
<div className="dd tag-source">
<ul className="dummy">
<li> <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js">GPUdb.js</a>, <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js#L1492">line 1492</a> </li>
</ul>
</div>
</div>
<h5>Returns:</h5>
...
<div className="dd tag-source">
<ul className="dummy">
<li> <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js">GPUdb.js</a>, <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js#L1233">line 1233</a> </li>
</ul>
</div>
</div>
<h5>Returns:</h5>
...
<h4 className="name" id=".from_table"><span className="type-signature">(static) </span>from\_table<span className="signature">(gpudb, table\_name, callback<span className="signature-attributes">opt</span>)</span><span className="type-signature"> &rarr; {"{"}<a href="/content/api/javascript/GPUdb.Type">GPUdb.Type</a>{"}"}</span></h4>
<div className="description">
...
<div className="dd tag-source">
<ul className="dummy">
<li> <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js">GPUdb.js</a>, <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js#L1384">line 1384</a> </li>
</ul>
</div>
</div>
<h5>Returns:</h5>
...
<h4 className="name" id=".from_type"><span className="type-signature">(static) </span>from\_type<span className="signature">(gpudb, type\_id, callback<span className="signature-attributes">opt</span>)</span><span className="type-signature"> &rarr; {"{"}<a href="/content/api/javascript/GPUdb.Type">GPUdb.Type</a>{"}"}</span></h4>
<div className="description">
...
<div className="dd tag-source">
<ul className="dummy">
<li> <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js">GPUdb.js</a>, <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js#L1443">line 1443</a> </li>
</ul>
</div>
</div>
<h5>Returns:</h5>
...
<h4 className="name" id=".from_type_info"><span className="type-signature">(static) </span>from\_type\_info<span className="signature">(label, type\_schema, properties)</span><span className="type-signature"> &rarr; {"{"}<a href="/content/api/javascript/GPUdb.Type">GPUdb.Type</a>{"}"}</span></h4>
...
<div className="dd tag-source">
<ul className="dummy">
<li> <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js">GPUdb.js</a>, <a href="https://github.com/kineticadb/kinetica-api-javascript/blob/master/javascript/GPUdb.js#L1202">line 1202</a> </li>
</ul>
</div>
</div>
<h5>Returns:</h5>

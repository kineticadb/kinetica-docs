...
<div className="ttdef"><span className="b">Definition</span> MurMurHash3.cs:23</div>
</div>
...
<div className="ttdef"><span className="b">Definition</span> MurMurHash3.cs:20</div>
</div>
...
<div className="ttdef"><span className="b">Definition</span> MurMurHash3.cs:57</div>
</div>
</div>
<p className="definition">Definition at line 19 of file MurMurHash3.cs.</p>
</div>
...
<p className="definition">Definition at line 57 of file MurMurHash3.cs.</p>
</div>
</div>

...
<p className="definition">Definition at line 26 of file FilterByBoxGeometry.cs.</p>
</div>
...
<p className="definition">Definition at line 71 of file FilterByBoxGeometry.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 53 of file FilterByBoxGeometry.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 61 of file FilterByBoxGeometry.cs.</p>
</div>
</div>
...
<div className="memdoc">
<p>A boolean constant for the <a className="el" href="/content/api/cs/structkinetica_1_1FilterByBoxGeometryRequest_1_1Options" title="A set of string constants for the parameter FilterByBoxGeometryRequest.options.">FilterByBoxGeometryRequest.Options</a> options. </p>
<p className="definition">Definition at line 57 of file FilterByBoxGeometry.cs.</p>
</div>
</div>
<hr />

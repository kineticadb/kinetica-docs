...
<p className="definition">Definition at line 30 of file DeleteRecords.cs.</p>
</div>
...
<p className="definition">Definition at line 68 of file DeleteRecords.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 76 of file DeleteRecords.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 35 of file DeleteRecords.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 45 of file DeleteRecords.cs.</p>
</div>
</div>
...
<div className="memdoc">
<p>A boolean constant for the <a className="el" href="/content/api/cs/structkinetica_1_1DeleteRecordsRequest_1_1Options" title="A set of string constants for the parameter DeleteRecordsRequest.options.">DeleteRecordsRequest.Options</a> options. </p>
<p className="definition">Definition at line 72 of file DeleteRecords.cs.</p>
</div>
</div>
<hr />

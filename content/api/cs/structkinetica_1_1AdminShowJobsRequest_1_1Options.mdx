...
<p className="definition">Definition at line 20 of file AdminShowJobs.cs.</p>
</div>
...
<p className="definition">Definition at line 50 of file AdminShowJobs.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 42 of file AdminShowJobs.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 69 of file AdminShowJobs.cs.</p>
</div>
</div>
...
<div className="memdoc">
<p>A boolean constant for the <a className="el" href="/content/api/cs/structkinetica_1_1AdminShowJobsRequest_1_1Options" title="A set of string constants for the parameter AdminShowJobsRequest.options.">AdminShowJobsRequest.Options</a> options. </p>
<p className="definition">Definition at line 46 of file AdminShowJobs.cs.</p>
</div>
</div>
<hr />

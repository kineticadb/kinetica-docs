...
<p className="definition">Definition at line 28 of file CheckTable.cs.</p>
</div>
...
<p className="definition">Definition at line 54 of file CheckTable.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 46 of file CheckTable.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 71 of file CheckTable.cs.</p>
</div>
</div>
...
<div className="memdoc">
<p>A boolean constant for the <a className="el" href="/content/api/cs/structkinetica_1_1CheckTableRequest_1_1Options" title="A set of string constants for the parameter CheckTableRequest.options.">CheckTableRequest.Options</a> options. </p>
<p className="definition">Definition at line 50 of file CheckTable.cs.</p>
</div>
</div>
<hr />

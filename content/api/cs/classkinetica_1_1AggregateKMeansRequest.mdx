...
<p>A set of parameters for <a className="el" href="/content/api/cs/classkinetica_1_1Kinetica/aggregatekmeans#abc00522ae443d7867f3ee878a5ad7221">Kinetica.aggregateKMeans</a>. <a href="#details">More...</a></p>
...
<td className="mdescRight">A set of string constants for the parameter <a className="el" href="#a4c7705d78798730d956903f4a764e20a" title="Optional parameters.">AggregateKMeansRequest.options</a>. <a href="/content/api/cs/structkinetica_1_1AggregateKMeansRequest_1_1Options#details">More...</a><br /></td>
</tr>
...
<td className="memItemLeft" align="right" valign="top">&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#adde7a9414051487c22747a43a27676c5">AggregateKMeansRequest</a> (string <a className="el" href="#a49b260093f958dc7853881068f4a6eb2">table\_name</a>, IList&lt; string &gt; <a className="el" href="#ab006e785b0c8e73010cde4763be2b1c0">column\_names</a>, int <a className="el" href="#ad04882a0ec5b4e785534b0d7f00ac3e9">k</a>, double <a className="el" href="#a72038352ade189e5d6912f163f48a980">tolerance</a>, IDictionary&lt; string, string &gt; <a className="el" href="#a4c7705d78798730d956903f4a764e20a">options</a>=null)</td>
</tr>
...
<tr className="memitem:a49b260093f958dc7853881068f4a6eb2" id="r_a49b260093f958dc7853881068f4a6eb2">
<td className="memItemLeft" align="right" valign="top">string&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#a49b260093f958dc7853881068f4a6eb2">table\_name</a><code> \[get, set\]</code></td>
</tr>
<tr className="memdesc:a49b260093f958dc7853881068f4a6eb2">
<td className="mdescLeft">&#160;</td>
<td className="mdescRight">Name of the table on which the operation will be performed. <br /></td>
</tr>
<tr className="separator:a49b260093f958dc7853881068f4a6eb2">
<td className="memSeparator" colSpan="2">&#160;</td>
</tr>
<tr className="memitem:ab006e785b0c8e73010cde4763be2b1c0" id="r_ab006e785b0c8e73010cde4763be2b1c0">
<td className="memItemLeft" align="right" valign="top">IList&lt; string &gt;&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#ab006e785b0c8e73010cde4763be2b1c0">column\_names</a> = new List&lt;string&gt;()<code> \[get, set\]</code></td>
</tr>
<tr className="memdesc:ab006e785b0c8e73010cde4763be2b1c0">
<td className="mdescLeft">&#160;</td>
<td className="mdescRight">List of column names on which the operation would be performed. <br /></td>
</tr>
<tr className="separator:ab006e785b0c8e73010cde4763be2b1c0">
<td className="memSeparator" colSpan="2">&#160;</td>
</tr>
<tr className="memitem:ad04882a0ec5b4e785534b0d7f00ac3e9" id="r_ad04882a0ec5b4e785534b0d7f00ac3e9">
<td className="memItemLeft" align="right" valign="top">int&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#ad04882a0ec5b4e785534b0d7f00ac3e9">k</a><code> \[get, set\]</code></td>
</tr>
<tr className="memdesc:ad04882a0ec5b4e785534b0d7f00ac3e9">
<td className="mdescLeft">&#160;</td>
<td className="mdescRight">The number of mean points to be determined by the algorithm. <br /></td>
</tr>
<tr className="separator:ad04882a0ec5b4e785534b0d7f00ac3e9">
<td className="memSeparator" colSpan="2">&#160;</td>
</tr>
<tr className="memitem:a72038352ade189e5d6912f163f48a980" id="r_a72038352ade189e5d6912f163f48a980">
<td className="memItemLeft" align="right" valign="top">double&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#a72038352ade189e5d6912f163f48a980">tolerance</a><code> \[get, set\]</code></td>
</tr>
<tr className="memdesc:a72038352ade189e5d6912f163f48a980">
<td className="mdescLeft">&#160;</td>
...
<tr className="separator:a72038352ade189e5d6912f163f48a980">
<td className="memSeparator" colSpan="2">&#160;</td>
</tr>
<tr className="memitem:a4c7705d78798730d956903f4a764e20a" id="r_a4c7705d78798730d956903f4a764e20a">
<td className="memItemLeft" align="right" valign="top">IDictionary&lt; string, string &gt;&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#a4c7705d78798730d956903f4a764e20a">options</a> = new Dictionary&lt;string, string&gt;()<code> \[get, set\]</code></td>
</tr>
<tr className="memdesc:a4c7705d78798730d956903f4a764e20a">
<td className="mdescLeft">&#160;</td>
<td className="mdescRight">Optional parameters. <br /></td>
</tr>
<tr className="separator:a4c7705d78798730d956903f4a764e20a">
<td className="memSeparator" colSpan="2">&#160;</td>
</tr>
...
<p>A set of parameters for <a className="el" href="/content/api/cs/classkinetica_1_1Kinetica/aggregatekmeans#abc00522ae443d7867f3ee878a5ad7221">Kinetica.aggregateKMeans</a>. </p>
...
<h2 className="memtitle"><span className="permalink"><a href="#ad8479df137666465cb9cfedd3680e9df">&#9670;&#160;</a></span>AggregateKMeansRequest() <span className="overload">\[1/2\]</span></h2>
...
<h2 className="memtitle"><span className="permalink"><a href="#adde7a9414051487c22747a43a27676c5">&#9670;&#160;</a></span>AggregateKMeansRequest() <span className="overload">\[2/2\]</span></h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>
...
<div id="ab006e785b0c8e73010cde4763be2b1c0"></div>
<h2 className="memtitle"><span className="permalink"><a href="#ab006e785b0c8e73010cde4763be2b1c0">&#9670;&#160;</a></span>column\_names</h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>
...
<div id="ad04882a0ec5b4e785534b0d7f00ac3e9"></div>
<h2 className="memtitle"><span className="permalink"><a href="#ad04882a0ec5b4e785534b0d7f00ac3e9">&#9670;&#160;</a></span>k</h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>
...
<div id="a4c7705d78798730d956903f4a764e20a"></div>
<h2 className="memtitle"><span className="permalink"><a href="#a4c7705d78798730d956903f4a764e20a">&#9670;&#160;</a></span>options</h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>
...
<div id="a49b260093f958dc7853881068f4a6eb2"></div>
<h2 className="memtitle"><span className="permalink"><a href="#a49b260093f958dc7853881068f4a6eb2">&#9670;&#160;</a></span>table\_name</h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>
...
<div id="a72038352ade189e5d6912f163f48a980"></div>
<h2 className="memtitle"><span className="permalink"><a href="#a72038352ade189e5d6912f163f48a980">&#9670;&#160;</a></span>tolerance</h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>

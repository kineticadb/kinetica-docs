...
<p className="definition">Definition at line 73 of file FilterByString.cs.</p>
</div>
...
<p className="definition">Definition at line 139 of file FilterByString.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 117 of file FilterByString.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 99 of file FilterByString.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 107 of file FilterByString.cs.</p>
</div>
</div>
...
<div className="memdoc">
<p>A boolean constant for the <a className="el" href="/content/api/cs/structkinetica_1_1FilterByStringRequest_1_1Options" title="A set of string constants for the parameter FilterByStringRequest.options.">FilterByStringRequest.Options</a> options. </p>
<p className="definition">Definition at line 103 of file FilterByString.cs.</p>
</div>
</div>
<hr />

...
<p>\[DEPRECATED&ndash;please use <a className="el" href="#a6d480be0eeec131c56e35ef7f393b6a6">revokePermission</a> instead\] Revokes a <a href="/content/security/sec_concepts/#security-concepts-permissions-credential" target="_top">credential-level permission</a> from a user or role. </p>

...
<p className="definition">Definition at line 30 of file FilterByRadius.cs.</p>
</div>
...
<p className="definition">Definition at line 74 of file FilterByRadius.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 56 of file FilterByRadius.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 64 of file FilterByRadius.cs.</p>
</div>
</div>
...
<div className="memdoc">
<p>A boolean constant for the <a className="el" href="/content/api/cs/structkinetica_1_1FilterByRadiusRequest_1_1Options" title="A set of string constants for the parameter FilterByRadiusRequest.options.">FilterByRadiusRequest.Options</a> options. </p>
<p className="definition">Definition at line 60 of file FilterByRadius.cs.</p>
</div>
</div>
<hr />

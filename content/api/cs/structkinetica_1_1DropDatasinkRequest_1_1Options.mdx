...
<p className="definition">Definition at line 27 of file DropDatasink.cs.</p>
</div>
...
<p className="definition">Definition at line 47 of file DropDatasink.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 55 of file DropDatasink.cs.</p>
</div>
</div>
...
<div className="memdoc">
<p>A boolean constant for the <a className="el" href="/content/api/cs/structkinetica_1_1DropDatasinkRequest_1_1Options" title="A set of string constants for the parameter DropDatasinkRequest.options.">DropDatasinkRequest.Options</a> options. </p>
<p className="definition">Definition at line 51 of file DropDatasink.cs.</p>
</div>
</div>
<hr />

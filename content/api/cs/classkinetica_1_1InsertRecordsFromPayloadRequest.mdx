...
<p>A set of parameters for <a className="el" href="/content/api/cs/classkinetica_1_1Kinetica/insertrecordsfrompayload#a347dae3a4302dee47025ba5fa6290a64">Kinetica.insertRecordsFromPayload</a>. <a href="#details">More...</a></p>
...
<td className="mdescRight">A set of string constants for the parameter <a className="el" href="#a5bc794418dc5d097bdbd7b8e176a43a5" title="Options used when creating the target table.">InsertRecordsFromPayloadRequest.create\_table\_options</a>. <a href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1CreateTableOptions#details">More...</a><br /></td>
</tr>
...
<tr className="memdesc:">
<td className="mdescLeft">&#160;</td>
<td className="mdescRight">A set of string constants for the parameter <a className="el" href="#ae3342a7d4e030b48944f5766f986e804" title="Optional parameters.">InsertRecordsFromPayloadRequest.options</a>. <a href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1Options#details">More...</a><br /></td>
</tr>
<tr className="separator:">
<td className="memSeparator" colSpan="2">&#160;</td>
</tr>
...
<td className="memItemLeft" align="right" valign="top">&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#a85aeed68a059f34029e1a0307a1bb095">InsertRecordsFromPayloadRequest</a> (string <a className="el" href="#a224cc7e6a6023c2334f8c24a7445993e">table\_name</a>, string <a className="el" href="#ac3a945bcec83ea5d61980b443176a3cb">data\_text</a>, byte\[\] <a className="el" href="#a793f8af958f90dc199f2bb07f544ad05">data\_bytes</a>, IDictionary&lt; string, IDictionary&lt; string, string &gt; &gt; <a className="el" href="#a70134c1a705dcce10276d85c15923be9">modify\_columns</a>=null, IDictionary&lt; string, string &gt; <a className="el" href="#a5bc794418dc5d097bdbd7b8e176a43a5">create\_table\_options</a>=null, IDictionary&lt; string, string &gt; <a className="el" href="#ae3342a7d4e030b48944f5766f986e804">options</a>=null)</td>
</tr>
...
<tr className="memitem:a224cc7e6a6023c2334f8c24a7445993e" id="r_a224cc7e6a6023c2334f8c24a7445993e">
<td className="memItemLeft" align="right" valign="top">string&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#a224cc7e6a6023c2334f8c24a7445993e">table\_name</a><code> \[get, set\]</code></td>
</tr>
<tr className="memdesc:a224cc7e6a6023c2334f8c24a7445993e">
<td className="mdescLeft">&#160;</td>
<td className="mdescRight">Name of the table into which the data will be inserted, in \[schema\_name. <br /></td>
</tr>
<tr className="separator:a224cc7e6a6023c2334f8c24a7445993e">
<td className="memSeparator" colSpan="2">&#160;</td>
</tr>
<tr className="memitem:ac3a945bcec83ea5d61980b443176a3cb" id="r_ac3a945bcec83ea5d61980b443176a3cb">
<td className="memItemLeft" align="right" valign="top">string&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#ac3a945bcec83ea5d61980b443176a3cb">data\_text</a><code> \[get, set\]</code></td>
</tr>
<tr className="memdesc:ac3a945bcec83ea5d61980b443176a3cb">
<td className="mdescLeft">&#160;</td>
...
<tr className="separator:ac3a945bcec83ea5d61980b443176a3cb">
<td className="memSeparator" colSpan="2">&#160;</td>
</tr>
...
<tr className="memitem:a70134c1a705dcce10276d85c15923be9" id="r_a70134c1a705dcce10276d85c15923be9">
<td className="memItemLeft" align="right" valign="top">IDictionary&lt; string, IDictionary&lt; string, string &gt; &gt;&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#a70134c1a705dcce10276d85c15923be9">modify\_columns</a> = new Dictionary&lt;string, IDictionary&lt;string, string&gt;&gt;()<code> \[get, set\]</code></td>
</tr>
<tr className="memdesc:a70134c1a705dcce10276d85c15923be9">
<td className="mdescLeft">&#160;</td>
<td className="mdescRight">Not implemented yet. <br /></td>
</tr>
<tr className="separator:a70134c1a705dcce10276d85c15923be9">
<td className="memSeparator" colSpan="2">&#160;</td>
</tr>
<tr className="memitem:a5bc794418dc5d097bdbd7b8e176a43a5" id="r_a5bc794418dc5d097bdbd7b8e176a43a5">
<td className="memItemLeft" align="right" valign="top">IDictionary&lt; string, string &gt;&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#a5bc794418dc5d097bdbd7b8e176a43a5">create\_table\_options</a> = new Dictionary&lt;string, string&gt;()<code> \[get, set\]</code></td>
</tr>
<tr className="memdesc:a5bc794418dc5d097bdbd7b8e176a43a5">
<td className="mdescLeft">&#160;</td>
...
<tr className="separator:a5bc794418dc5d097bdbd7b8e176a43a5">
<td className="memSeparator" colSpan="2">&#160;</td>
</tr>
<tr className="memitem:ae3342a7d4e030b48944f5766f986e804" id="r_ae3342a7d4e030b48944f5766f986e804">
<td className="memItemLeft" align="right" valign="top">IDictionary&lt; string, string &gt;&#160;</td>
<td className="memItemRight" valign="bottom"><a className="el" href="#ae3342a7d4e030b48944f5766f986e804">options</a> = new Dictionary&lt;string, string&gt;()<code> \[get, set\]</code></td>
</tr>
<tr className="memdesc:ae3342a7d4e030b48944f5766f986e804">
<td className="mdescLeft">&#160;</td>
<td className="mdescRight">Optional parameters. <br /></td>
</tr>
<tr className="separator:ae3342a7d4e030b48944f5766f986e804">
<td className="memSeparator" colSpan="2">&#160;</td>
</tr>
...
<p>A set of parameters for <a className="el" href="/content/api/cs/classkinetica_1_1Kinetica/insertrecordsfrompayload#a347dae3a4302dee47025ba5fa6290a64">Kinetica.insertRecordsFromPayload</a>. </p>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs#L18">18</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs">InsertRecordsFromPayload.cs</a>.</p>
</div>
<h2 className="groupheader">Constructor &amp; Destructor Documentation</h2>
<div id="a443a8a97c7846f01c00776446e52fc74"></div>
<h2 className="memtitle"><span className="permalink"><a href="#a443a8a97c7846f01c00776446e52fc74">&#9670;&#160;</a></span>InsertRecordsFromPayloadRequest() <span className="overload">\[1/2\]</span></h2>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs#L2651">2651</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs">InsertRecordsFromPayload.cs</a>.</p>
</div>
</div>
<div id="a85aeed68a059f34029e1a0307a1bb095"></div>
<h2 className="memtitle"><span className="permalink"><a href="#a85aeed68a059f34029e1a0307a1bb095">&#9670;&#160;</a></span>InsertRecordsFromPayloadRequest() <span className="overload">\[2/2\]</span></h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>
...
<td>
<a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1Options" title="A set of string constants for the parameter InsertRecordsFromPayloadRequest.options.">Options</a> used when creating the target table. Includes type to use. The other options match those in <a className="el" href="/content/api/cs/classkinetica_1_1Kinetica/createtable#ae10c184acd9c83d0063e8e4615270aba">Kinetica.createTable</a>. 
<ul>
...
Optional parameters. 
<ul>
<li> <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1Options#a7c02b501312fbcf48d63850aeb60a0cf">AVRO\_SCHEMA</a>: String representing the Avro schema, for data that includes only records (i.e. does not embed its own schema). </li>
<li> <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1Options#ab6f54c6dbc92a2e38896188bb14d27e6">AVRO\_SCHEMA\_NO\_INFERENCE</a>: Create table solely from the Avro schema definition, when <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1Options#a7c02b501312fbcf48d63850aeb60a0cf">AVRO\_SCHEMA</a> exists; do not infer from data. </li>
...
<li> <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1Options#ae20f8e22843bfa9e7548c921524621b5">NUM\_TASKS\_PER\_RANK</a>: Number of tasks for reading file per rank. Default will be <a href="/content/config/#config-main-external-files" target="_top">external\_file\_reader\_num\_tasks</a>. </li>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs#L3980">3980</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs">InsertRecordsFromPayload.cs</a>.</p>
</div>
</div>
<h2 className="groupheader">Property Documentation</h2>
<div id="a5bc794418dc5d097bdbd7b8e176a43a5"></div>
<h2 className="memtitle"><span className="permalink"><a href="#a5bc794418dc5d097bdbd7b8e176a43a5">&#9670;&#160;</a></span>create\_table\_options</h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>
...
<p>Includes type to use. The other options match those in <a className="el" href="/content/api/cs/classkinetica_1_1Kinetica/createtable#ae10c184acd9c83d0063e8e4615270aba">Kinetica.createTable</a>. </p>
<ul>
<li> <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1CreateTableOptions#a426cc4dbcf7ae4e46cd55a4922d4660f">CHUNK\_COLUMN\_MAX\_MEMORY</a>: Indicates the target maximum data size for each column in a chunk to be used for this table. </li>
<li> <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1CreateTableOptions#a99d013cf80ddd61d16975577f5e4f2d9">CHUNK\_MAX\_MEMORY</a>: Indicates the target maximum data size for all columns in a chunk to be used for this table. </li>
<li> <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1CreateTableOptions#aea1ba3cb95212647e9927c7c42d58876">CHUNK\_SIZE</a>: Indicates the number of records per chunk to be used for this table. </li>
...
<li> <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1CreateTableOptions#aff1cb4066971a6815d5409bcda77475d">STRATEGY\_DEFINITION</a>: The <a href="/content/rm/concepts/#tier-strategies" target="_top">tier strategy</a> for the table and its columns. </li>
<li> <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1CreateTableOptions#ad153635e229419468b1a7de36b415b55">TTL</a>: Sets the <a href="/content/concepts/ttl/" target="_top">TTL</a> of the table specified in <a className="el" href="#a224cc7e6a6023c2334f8c24a7445993e" title="Name of the table into which the data will be inserted, in [schema_name.">InsertRecordsFromPayloadRequest.table\_name</a>. </li>
<li> <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1CreateTableOptions#adb1e74dd4352afe9875d0e56c4619414">TYPE\_ID</a>: ID of a currently registered <a href="/content/concepts/types/" target="_top">type</a>. The default value is ''. </li>
</ul>
<p>The default value is an empty Dictionary.</p>
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs#L1614">1614</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs">InsertRecordsFromPayload.cs</a>.</p>
</div>
</div>
<div id="a793f8af958f90dc199f2bb07f544ad05"></div>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs#L1325">1325</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs">InsertRecordsFromPayload.cs</a>.</p>
</div>
</div>
<div id="ac3a945bcec83ea5d61980b443176a3cb"></div>
<h2 className="memtitle"><span className="permalink"><a href="#ac3a945bcec83ea5d61980b443176a3cb">&#9670;&#160;</a></span>data\_text</h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs#L1322">1322</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs">InsertRecordsFromPayload.cs</a>.</p>
</div>
</div>
<div id="a70134c1a705dcce10276d85c15923be9"></div>
<h2 className="memtitle"><span className="permalink"><a href="#a70134c1a705dcce10276d85c15923be9">&#9670;&#160;</a></span>modify\_columns</h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>
...
<p>The default value is an empty Dictionary.</p>
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs#L1330">1330</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs">InsertRecordsFromPayload.cs</a>.</p>
</div>
</div>
<div id="ae3342a7d4e030b48944f5766f986e804"></div>
<h2 className="memtitle"><span className="permalink"><a href="#ae3342a7d4e030b48944f5766f986e804">&#9670;&#160;</a></span>options</h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>
...
<li>
<a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1Options#aeb494e60f5d5df96e6851a052bb8d3ed">TRUNCATE\_TABLE</a>: If set to <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1Options#a5e41d65eb7b549d3abf7164fcf21eabb">TRUE</a>, truncates the table specified by <a className="el" href="#a224cc7e6a6023c2334f8c24a7445993e" title="Name of the table into which the data will be inserted, in [schema_name.">InsertRecordsFromPayloadRequest.table\_name</a> prior to loading the file(s). Supported values: 
<ul>
<li> <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1Options#a5e41d65eb7b549d3abf7164fcf21eabb">TRUE</a> </li>
<li> <a className="el" href="/content/api/cs/structkinetica_1_1InsertRecordsFromPayloadRequest_1_1Options#a40b242a5cd1a9f6fbbcd1744985187fa">FALSE</a> </li>
</ul>
...
<p>The default value is an empty Dictionary.</p>
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs#L2647">2647</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs">InsertRecordsFromPayload.cs</a>.</p>
</div>
</div>
<div id="a224cc7e6a6023c2334f8c24a7445993e"></div>
<h2 className="memtitle"><span className="permalink"><a href="#a224cc7e6a6023c2334f8c24a7445993e">&#9670;&#160;</a></span>table\_name</h2>
<div className="memitem">
<div className="memproto">
<table className="mlabels">
<tr>
...
<p className="definition">Definition at line <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs#L1319">1319</a> of file <a className="el" href="https://github.com/kineticadb/kinetica-api-cs/blob/master/Kinetica/Protocol/InsertRecordsFromPayload.cs">InsertRecordsFromPayload.cs</a>.</p>
</div>
</div>
<hr />

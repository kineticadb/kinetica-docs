...
<p className="definition">Definition at line 770 of file VisualizeIsochrone.cs.</p>
</div>
...
<p className="definition">Definition at line 801 of file VisualizeIsochrone.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 793 of file VisualizeIsochrone.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 808 of file VisualizeIsochrone.cs.</p>
</div>
</div>
...
<div className="memdoc">
<p>A boolean constant for the <a className="el" href="/content/api/cs/structkinetica_1_1VisualizeIsochroneRequest_1_1SolveOptions" title="A set of string constants for the parameter VisualizeIsochroneRequest.solve_options.">VisualizeIsochroneRequest.SolveOptions</a> options. </p>
<p className="definition">Definition at line 797 of file VisualizeIsochrone.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 815 of file VisualizeIsochrone.cs.</p>
</div>
</div>
<hr />

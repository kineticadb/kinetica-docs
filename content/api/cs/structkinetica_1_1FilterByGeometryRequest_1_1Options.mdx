...
<p className="definition">Definition at line 57 of file FilterByGeometry.cs.</p>
</div>
...
<p className="definition">Definition at line 102 of file FilterByGeometry.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 84 of file FilterByGeometry.cs.</p>
</div>
</div>
...
<p className="definition">Definition at line 92 of file FilterByGeometry.cs.</p>
</div>
</div>
...
<div className="memdoc">
<p>A boolean constant for the <a className="el" href="/content/api/cs/structkinetica_1_1FilterByGeometryRequest_1_1Options" title="A set of string constants for the parameter FilterByGeometryRequest.options.">FilterByGeometryRequest.Options</a> options. </p>
<p className="definition">Definition at line 88 of file FilterByGeometry.cs.</p>
</div>
</div>
<hr />

...
For some endpoints (e.g. [/aggregate/groupby](/content/api/rest/aggregate_groupby_rest),
[/aggregate/unique](/content/api/rest/aggregate_unique_rest), [/get/records/bycolumn](/content/api/rest/get_records_bycolumn_rest)), the response
...
[aggregate_groupby](/content/api/python/source/gpudb/aggregate-group-by#gpudb.GPUdb.aggregate_group_by)

...
<div className="block">A set of configurable options for the GPUdb API. May be passed into the <a href="/content/api/java/com/gpudb/GPUdb/gpudb#%3Cinit%3E(java.lang.String,com.gpudb.GPUdbBase.Options)"><code>GPUdb constructor</code></a> to override the default options.</div>
</div>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getTcpKeepAlive()" className="member-name-link">getTcpKeepAlive</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Gets the value of the flag indicating whether TCP keepalive is enabled on sockets.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>int</code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getTcpKeepCount()" className="member-name-link">getTcpKeepCount</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Gets the TCP keepalive probe count.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>int</code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getTcpKeepIdle()" className="member-name-link">getTcpKeepIdle</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Gets the TCP keepalive idle time in seconds.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>int</code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getTcpKeepInterval()" className="member-name-link">getTcpKeepInterval</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Gets the TCP keepalive probe interval in seconds.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>int</code></div>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb">GPUdbBase.Options</a></code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setTcpKeepAlive(boolean)" className="member-name-link">setTcpKeepAlive</a><wbr />(boolean&nbsp;value)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Sets whether TCP keepalive is enabled on sockets.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb">GPUdbBase.Options</a></code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setTcpKeepCount(int)" className="member-name-link">setTcpKeepCount</a><wbr />(int&nbsp;count)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Sets the TCP keepalive probe count.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb">GPUdbBase.Options</a></code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setTcpKeepIdle(int)" className="member-name-link">setTcpKeepIdle</a><wbr />(int&nbsp;seconds)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Sets the TCP keepalive idle time in seconds.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb">GPUdbBase.Options</a></code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setTcpKeepInterval(int)" className="member-name-link">setTcpKeepInterval</a><wbr />(int&nbsp;seconds)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Sets the TCP keepalive probe interval in seconds.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb">GPUdbBase.Options</a></code></div>
...
<li>
<div className="section detail" id="getTcpKeepAlive()">
<h3>getTcpKeepAlive</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">boolean</span>&nbsp;<span className="element-name">getTcpKeepAlive</span>()</div>
<div className="block">
Gets the value of the flag indicating whether TCP keepalive is enabled on sockets. When enabled, the operating system will send periodic keepalive probes on idle connections, which can help prevent firewalls and NAT devices from silently dropping the connection during long-running queries. 
<p>The default is <code>true</code>. Disabling TCP keepalive may cause clients to hang indefinitely if an intermediary (firewall, NAT, load balancer) silently drops an idle connection during a long-running query.</p>
<p><span className="b">Note:</span> TCP keepalive alone may not be sufficient. The keepalive interval is OS-controlled (default 2 hours on Linux). For robust protection, also set a non-infinite timeout using <a href="#setTimeout(int)"><code>setTimeout(int)</code></a>.</p>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd"><code>true</code> if TCP keepalive is enabled, <code>false</code> otherwise</div>
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="#setTcpKeepAlive(boolean)"><code>setTcpKeepAlive(boolean)</code></a></li>
<li><a href="#setTimeout(int)"><code>setTimeout(int)</code></a></li>
</ul>
</div>
</div>
...
<li>
<div className="section detail" id="getTcpKeepIdle()">
<h3>getTcpKeepIdle</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">int</span>&nbsp;<span className="element-name">getTcpKeepIdle</span>()</div>
<div className="block">
Gets the TCP keepalive idle time in seconds. This is the time a connection must be idle before the first keepalive probe is sent. 
<p>A value of 0 (the default) means use the operating system default, which is typically 7200 seconds (2 hours) on Linux.</p>
<p><span className="b">Note:</span> This option requires Java 11+ and OS support for <code>TCP\_KEEPIDLE</code>. If not supported, the setting will be ignored.</p>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">the TCP keepalive idle time in seconds, or 0 for OS default</div>
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="#setTcpKeepIdle(int)"><code>setTcpKeepIdle(int)</code></a></li>
<li><a href="#getTcpKeepAlive()"><code>getTcpKeepAlive()</code></a></li>
</ul>
</div>
</div>
</div>
...
<li>
<div className="section detail" id="getTcpKeepInterval()">
<h3>getTcpKeepInterval</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">int</span>&nbsp;<span className="element-name">getTcpKeepInterval</span>()</div>
<div className="block">
Gets the TCP keepalive probe interval in seconds. This is the time between successive keepalive probes when no acknowledgment is received. 
<p>A value of 0 (the default) means use the operating system default, which is typically 75 seconds on Linux.</p>
<p><span className="b">Note:</span> This option requires Java 11+ and OS support for <code>TCP\_KEEPINTERVAL</code>. If not supported, the setting will be ignored.</p>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">the TCP keepalive interval in seconds, or 0 for OS default</div>
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="#setTcpKeepInterval(int)"><code>setTcpKeepInterval(int)</code></a></li>
<li><a href="#getTcpKeepAlive()"><code>getTcpKeepAlive()</code></a></li>
</ul>
</div>
</div>
...
<li>
<div className="section detail" id="getTcpKeepCount()">
<h3>getTcpKeepCount</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">int</span>&nbsp;<span className="element-name">getTcpKeepCount</span>()</div>
<div className="block">
Gets the TCP keepalive probe count. This is the number of unacknowledged probes to send before considering the connection dead. 
<p>A value of 0 (the default) means use the operating system default, which is typically 9 probes on Linux.</p>
<p><span className="b">Note:</span> This option requires Java 11+ and OS support for <code>TCP\_KEEPCOUNT</code>. If not supported, the setting will be ignored.</p>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">the TCP keepalive probe count, or 0 for OS default</div>
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="#setTcpKeepCount(int)"><code>setTcpKeepCount(int)</code></a></li>
<li><a href="#getTcpKeepAlive()"><code>getTcpKeepAlive()</code></a></li>
</ul>
</div>
</div>
...
<li>
<div className="section detail" id="setTcpKeepAlive(boolean)">
<h3>setTcpKeepAlive</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb">GPUdbBase.Options</a></span>&nbsp;<span className="element-name">setTcpKeepAlive</span><wbr /><span className="parameters">(boolean&nbsp;value)</span></div>
<div className="block">
Sets whether TCP keepalive is enabled on sockets. When enabled, the operating system will send periodic keepalive probes on idle connections, which can help prevent firewalls and NAT devices from silently dropping the connection during long-running queries. 
<p>The default is <code>true</code>. Disabling TCP keepalive may cause clients to hang indefinitely if an intermediary (firewall, NAT, load balancer) silently drops an idle connection during a long-running query.</p>
<p><span className="b">Important:</span> TCP keepalive alone may not be sufficient to prevent hangs. The keepalive interval is controlled at the operating system level (e.g., <code>tcp\_keepalive\_time</code> on Linux, which defaults to 2 hours). If the firewall's idle timeout is shorter than the OS keepalive interval, the connection may still be dropped before the first keepalive probe is sent.</p>
<p>For robust protection against connection drops during long-running queries, you should also set a non-infinite socket timeout using <a href="#setTimeout(int)"><code>setTimeout(int)</code></a>. This ensures the client will eventually receive a <code>SocketTimeoutException</code> rather than hanging forever, allowing the application to detect the issue and retry.</p>
<p>To tune OS-level keepalive parameters on Linux:</p>
<ul>
<li><code>tcp\_keepalive\_time</code> - seconds before first probe (default: 7200)</li>
<li><code>tcp\_keepalive\_intvl</code> - seconds between probes (default: 75)</li>
<li><code>tcp\_keepalive\_probes</code> - number of probes before giving up (default: 9)</li>
</ul>
</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>value</code> - <code>true</code> to enable TCP keepalive, <code>false</code> to disable</div>
<div className="dt">Returns:</div>
<div className="dd">the current <a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb"><code>GPUdbBase.Options</code></a> instance</div>
<div className="dt">See Also:</div>
<div className="dd">
...
<li>
<div className="section detail" id="setTcpKeepIdle(int)">
<h3>setTcpKeepIdle</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb">GPUdbBase.Options</a></span>&nbsp;<span className="element-name">setTcpKeepIdle</span><wbr /><span className="parameters">(int&nbsp;seconds)</span></div>
<div className="block">
Sets the TCP keepalive idle time in seconds. This is the time a connection must be idle before the first keepalive probe is sent. 
<p>A value of 0 (the default) means use the operating system default, which is typically 7200 seconds (2 hours) on Linux. Setting a lower value (e.g., 60-300 seconds) can help detect dead connections faster and prevent firewalls from dropping idle connections during long-running queries.</p>
<p><span className="b">Note:</span> This option requires Java 11+ and OS support for <code>TCP\_KEEPIDLE</code> (equivalent to Linux's <code>tcp\_keepalive\_time</code>). If not supported on the current platform, the setting will be silently ignored.</p>
<p><span className="b">Important:</span> TCP keepalive must be enabled via <a href="#setTcpKeepAlive(boolean)"><code>setTcpKeepAlive(boolean)</code></a> for this setting to have any effect. If <code>tcpKeepAlive</code> is <code>false</code> and this option is set to a non-zero value, a warning will be logged and the setting will be ignored.</p>
</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>seconds</code> - the idle time in seconds before first probe, or 0 for OS default</div>
<div className="dt">Returns:</div>
<div className="dd">the current <a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb"><code>GPUdbBase.Options</code></a> instance</div>
<div className="dt">Throws:</div>
<div className="dd"><code><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/IllegalArgumentException.html" title="class or interface in java.lang" className="external-link">IllegalArgumentException</a></code> - if seconds is negative</div>
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="#getTcpKeepIdle()"><code>getTcpKeepIdle()</code></a></li>
<li><a href="#setTcpKeepAlive(boolean)"><code>setTcpKeepAlive(boolean)</code></a></li>
<li><a href="#setTcpKeepInterval(int)"><code>setTcpKeepInterval(int)</code></a></li>
<li><a href="#setTcpKeepCount(int)"><code>setTcpKeepCount(int)</code></a></li>
</ul>
...
<li>
<div className="section detail" id="setTcpKeepInterval(int)">
<h3>setTcpKeepInterval</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb">GPUdbBase.Options</a></span>&nbsp;<span className="element-name">setTcpKeepInterval</span><wbr /><span className="parameters">(int&nbsp;seconds)</span></div>
<div className="block">
Sets the TCP keepalive probe interval in seconds. This is the time between successive keepalive probes when no acknowledgment is received. 
<p>A value of 0 (the default) means use the operating system default, which is typically 75 seconds on Linux. Setting a lower value can help detect dead connections more quickly once keepalive probing has started.</p>
<p><span className="b">Note:</span> This option requires Java 11+ and OS support for <code>TCP\_KEEPINTERVAL</code> (equivalent to Linux's <code>tcp\_keepalive\_intvl</code>). If not supported on the current platform, the setting will be silently ignored.</p>
<p><span className="b">Important:</span> TCP keepalive must be enabled via <a href="#setTcpKeepAlive(boolean)"><code>setTcpKeepAlive(boolean)</code></a> for this setting to have any effect. If <code>tcpKeepAlive</code> is <code>false</code> and this option is set to a non-zero value, a warning will be logged and the setting will be ignored.</p>
</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>seconds</code> - the interval in seconds between probes, or 0 for OS default</div>
<div className="dt">Returns:</div>
<div className="dd">the current <a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb"><code>GPUdbBase.Options</code></a> instance</div>
<div className="dt">Throws:</div>
<div className="dd"><code><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/IllegalArgumentException.html" title="class or interface in java.lang" className="external-link">IllegalArgumentException</a></code> - if seconds is negative</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="#getTcpKeepInterval()"><code>getTcpKeepInterval()</code></a></li>
<li><a href="#setTcpKeepAlive(boolean)"><code>setTcpKeepAlive(boolean)</code></a></li>
<li><a href="#setTcpKeepIdle(int)"><code>setTcpKeepIdle(int)</code></a></li>
<li><a href="#setTcpKeepCount(int)"><code>setTcpKeepCount(int)</code></a></li>
</ul>
...
<li>
<div className="section detail" id="setTcpKeepCount(int)">
<h3>setTcpKeepCount</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb">GPUdbBase.Options</a></span>&nbsp;<span className="element-name">setTcpKeepCount</span><wbr /><span className="parameters">(int&nbsp;count)</span></div>
<div className="block">
Sets the TCP keepalive probe count. This is the number of unacknowledged probes to send before considering the connection dead. 
<p>A value of 0 (the default) means use the operating system default, which is typically 9 probes on Linux. Setting a lower value can help fail faster when a connection is truly dead.</p>
<p><span className="b">Note:</span> This option requires Java 11+ and OS support for <code>TCP\_KEEPCOUNT</code> (equivalent to Linux's <code>tcp\_keepalive\_probes</code>). If not supported on the current platform, the setting will be silently ignored.</p>
<p><span className="b">Important:</span> TCP keepalive must be enabled via <a href="#setTcpKeepAlive(boolean)"><code>setTcpKeepAlive(boolean)</code></a> for this setting to have any effect. If <code>tcpKeepAlive</code> is <code>false</code> and this option is set to a non-zero value, a warning will be logged and the setting will be ignored.</p>
</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>count</code> - the number of probes before giving up, or 0 for OS default</div>
<div className="dt">Returns:</div>
<div className="dd">the current <a href="/content/api/java/com/gpudb/GPUdbBase.Options" title="class in com.gpudb"><code>GPUdbBase.Options</code></a> instance</div>
<div className="dt">Throws:</div>
<div className="dd"><code><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/IllegalArgumentException.html" title="class or interface in java.lang" className="external-link">IllegalArgumentException</a></code> - if count is negative</div>
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="#getTcpKeepCount()"><code>getTcpKeepCount()</code></a></li>
<li><a href="#setTcpKeepAlive(boolean)"><code>setTcpKeepAlive(boolean)</code></a></li>
<li><a href="#setTcpKeepIdle(int)"><code>setTcpKeepIdle(int)</code></a></li>
<li><a href="#setTcpKeepInterval(int)"><code>setTcpKeepInterval(int)</code></a></li>
</ul>

...
<div className="block">Alters an existing environment which can be referenced by a <a href="/content/udf_overview" target="_top">user-defined function</a> (UDF).</div>

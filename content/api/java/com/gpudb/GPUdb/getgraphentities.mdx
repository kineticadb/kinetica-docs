...
<div className="block">Retrieves node or edge entities from an existing graph, with pagination support via offset and limit. Use <a href="/content/api/java/com/gpudb/GPUdb/showgraph#showGraph(com.gpudb.protocol.ShowGraphRequest)"><code>showGraph</code></a> to obtain the total number of nodes and edges.</div>
...
<div className="block">Retrieves node or edge entities from an existing graph, with pagination support via offset and limit. Use <a href="/content/api/java/com/gpudb/GPUdb/showgraph#showGraph(java.lang.String,java.util.Map)"><code>showGraph</code></a> to obtain the total number of nodes and edges.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

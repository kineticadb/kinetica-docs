...
<li><a href="/content/api/java/com/gpudb/protocol/InsertRecordsFromQueryRequest.Options#NUM_SPLITS_PER_RANK"><code>NUM\_SPLITS\_PER\_RANK</code></a>: Number of splits for reading data per rank. Default will be <a href="/content/config/#config-main-external-files" target="_top">external\_file\_reader\_num\_tasks</a>. The default value is ''. </li>
<li><a href="/content/api/java/com/gpudb/protocol/InsertRecordsFromQueryRequest.Options#NUM_TASKS_PER_RANK"><code>NUM\_TASKS\_PER\_RANK</code></a>: Number of tasks for reading data per rank. Default will be <a href="/content/config/#config-main-external-files" target="_top">external\_file\_reader\_num\_tasks</a>. </li>

...
<div className="col-last even-row-color class-summary class-summary-tab2">Deprecated, for removal: This API element is subject to removal in a future version. <div className="deprecation-comment">This class has been superseded by <a href="/content/api/java/com/gpudb/WorkerList" title="class in com.gpudb"><code>com.gpudb.WorkerList</code></a>.</div> </div>

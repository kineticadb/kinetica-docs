---
title: "TypeObjectMap.ConvertingMethodHandler"
description: "TypeObjectMap.ConvertingMethodHandler — Kinetica Java API"
---
...
<h1 title="Class TypeObjectMap.ConvertingMethodHandler" className="title">Class TypeObjectMap.ConvertingMethodHandler</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.TypeObjectMap.ConvertingMethodHandler</div> </div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(java.lang.reflect.Method,java.lang.reflect.Method,com.gpudb.Type.Column)" className="member-name-link">ConvertingMethodHandler</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/reflect/Method.html" title="class or interface in java.lang.reflect" className="external-link">Method</a>&nbsp;getMethod, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/reflect/Method.html" title="class or interface in java.lang.reflect" className="external-link">Method</a>&nbsp;setMethod, <a href="/content/api/java/com/gpudb/Type.Column" title="class in com.gpudb">Type.Column</a>&nbsp;column)</code></div>
<div className="col-last even-row-color">
<div className="block">Creates a <a href="/content/api/java/com/gpudb/TypeObjectMap.ConvertingMethodHandler" title="class in com.gpudb"><code>TypeObjectMap.ConvertingMethodHandler</code></a> for the specified get and set methods and GPUdb <a href="/content/api/java/com/gpudb/Type.Column" title="class in com.gpudb"><code>column</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="block">Returns a value from the specified object via the get method specified in the constructor, converting it to the data type of the GPUdb <a href="/content/api/java/com/gpudb/Type.Column" title="class in com.gpudb"><code>column</code></a> specified in the constructor.</div>
</div>
...
<div className="block">Sets a value in the specified object via the set method specified in the constructor after converting it from the data type of the GPUdb <a href="/content/api/java/com/gpudb/Type.Column" title="class in com.gpudb"><code>column</code></a> specified in the constructor.</div>
</div>
</div>
</div>
</div>
...
<li>
<div className="section detail" id="&lt;init&gt;(java.lang.reflect.Method,java.lang.reflect.Method,com.gpudb.Type.Column)">
<h3>ConvertingMethodHandler</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">ConvertingMethodHandler</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/reflect/Method.html" title="class or interface in java.lang.reflect" className="external-link">Method</a>&nbsp;getMethod, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/reflect/Method.html" title="class or interface in java.lang.reflect" className="external-link">Method</a>&nbsp;setMethod, <a href="/content/api/java/com/gpudb/Type.Column" title="class in com.gpudb">Type.Column</a>&nbsp;column)</span></div>
<div className="block">Creates a <a href="/content/api/java/com/gpudb/TypeObjectMap.ConvertingMethodHandler" title="class in com.gpudb"><code>TypeObjectMap.ConvertingMethodHandler</code></a> for the specified get and set methods and GPUdb <a href="/content/api/java/com/gpudb/Type.Column" title="class in com.gpudb"><code>column</code></a>. Field values will be converted to and from the data type of the column.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>getMethod</code> - the get method</div>
<div className="dd"><code>setMethod</code> - the set method</div>
<div className="dd"><code>column</code> - the column</div>
<div className="dt">Throws:</div>
<div className="dd"><code><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/IllegalArgumentException.html" title="class or interface in java.lang" className="external-link">IllegalArgumentException</a></code> - if the specified methods are not of the correct form or the field does not have a data type that is supported for conversion</div>
</div>
</div>
</li>
</ul>
...
<div className="block">Returns a value from the specified object via the get method specified in the constructor, converting it to the data type of the GPUdb <a href="/content/api/java/com/gpudb/Type.Column" title="class in com.gpudb"><code>column</code></a> specified in the constructor. The object must belong to the class containing the method.</div>
<div className="dl notes">
...
<div className="block">Sets a value in the specified object via the set method specified in the constructor after converting it from the data type of the GPUdb <a href="/content/api/java/com/gpudb/Type.Column" title="class in com.gpudb"><code>column</code></a> specified in the constructor. The object must belong to the class containing the method.</div>
<div className="dl notes">
<div className="dt">Specified by:</div>

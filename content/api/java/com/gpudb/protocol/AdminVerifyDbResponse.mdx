---
title: "AdminVerifyDbResponse"
description: "AdminVerifyDbResponse — Kinetica Java API"
---
...
<h1 title="Class AdminVerifyDbResponse" className="title">Class AdminVerifyDbResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AdminVerifyDbResponse</div> </div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AdminVerifyDbResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AdminVerifyDbResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getErrorList()" className="member-name-link">getErrorList</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">List of errors found while validating the database internal state.</div>
</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getOrphanedTablesTotalSize()" className="member-name-link">getOrphanedTablesTotalSize</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">If <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#VERIFY_PERSIST"><code>VERIFY\_PERSIST</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a>, <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#VERIFY_ORPHANED_TABLES_ONLY"><code>VERIFY\_ORPHANED\_TABLES\_ONLY</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a> or <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#DELETE_ORPHANED_TABLES"><code>DELETE\_ORPHANED\_TABLES</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a>, this is the sum in bytes of all orphaned tables found.</div>
</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getVerifiedOk()" className="member-name-link">getVerifiedOk</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">True if no errors were found, false otherwise.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setErrorList(java.util.List)" className="member-name-link">setErrorList</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;errorList)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">List of errors found while validating the database internal state.</div>
</div>
...
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbResponse" title="class in com.gpudb.protocol">AdminVerifyDbResponse</a></code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setOrphanedTablesTotalSize(long)" className="member-name-link">setOrphanedTablesTotalSize</a><wbr />(long&nbsp;orphanedTablesTotalSize)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">If <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#VERIFY_PERSIST"><code>VERIFY\_PERSIST</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a>, <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#VERIFY_ORPHANED_TABLES_ONLY"><code>VERIFY\_ORPHANED\_TABLES\_ONLY</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a> or <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#DELETE_ORPHANED_TABLES"><code>DELETE\_ORPHANED\_TABLES</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a>, this is the sum in bytes of all orphaned tables found.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbResponse" title="class in com.gpudb.protocol">AdminVerifyDbResponse</a></code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setVerifiedOk(boolean)" className="member-name-link">setVerifiedOk</a><wbr />(boolean&nbsp;verifiedOk)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">True if no errors were found, false otherwise.</div>
</div>
...
<h3>AdminVerifyDbResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AdminVerifyDbResponse</span>()</div>
<div className="block">Constructs an AdminVerifyDbResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<li>
<div className="section detail" id="getVerifiedOk()">
<h3>getVerifiedOk</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">boolean</span>&nbsp;<span className="element-name">getVerifiedOk</span>()</div>
<div className="block">True if no errors were found, false otherwise. The default value is <code>false</code>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>verifiedOk</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setVerifiedOk(boolean)">
<h3>setVerifiedOk</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbResponse" title="class in com.gpudb.protocol">AdminVerifyDbResponse</a></span>&nbsp;<span className="element-name">setVerifiedOk</span><wbr /><span className="parameters">(boolean&nbsp;verifiedOk)</span></div>
<div className="block">True if no errors were found, false otherwise. The default value is <code>false</code>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>verifiedOk</code> - The new value for <code>verifiedOk</code>.</div>
<div className="dt">Returns:</div>
...
<li>
<div className="section detail" id="getErrorList()">
<h3>getErrorList</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;</span>&nbsp;<span className="element-name">getErrorList</span>()</div>
<div className="block">List of errors found while validating the database internal state. The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link"><code>List</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>errorList</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setErrorList(java.util.List)">
<h3>setErrorList</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbResponse" title="class in com.gpudb.protocol">AdminVerifyDbResponse</a></span>&nbsp;<span className="element-name">setErrorList</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;errorList)</span></div>
<div className="block">List of errors found while validating the database internal state. The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link"><code>List</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>errorList</code> - The new value for <code>errorList</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<li>
<div className="section detail" id="getOrphanedTablesTotalSize()">
<h3>getOrphanedTablesTotalSize</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">long</span>&nbsp;<span className="element-name">getOrphanedTablesTotalSize</span>()</div>
<div className="block">If <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#VERIFY_PERSIST"><code>VERIFY\_PERSIST</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a>, <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#VERIFY_ORPHANED_TABLES_ONLY"><code>VERIFY\_ORPHANED\_TABLES\_ONLY</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a> or <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#DELETE_ORPHANED_TABLES"><code>DELETE\_ORPHANED\_TABLES</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a>, this is the sum in bytes of all orphaned tables found. Otherwise, -1.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>orphanedTablesTotalSize</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setOrphanedTablesTotalSize(long)">
<h3>setOrphanedTablesTotalSize</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbResponse" title="class in com.gpudb.protocol">AdminVerifyDbResponse</a></span>&nbsp;<span className="element-name">setOrphanedTablesTotalSize</span><wbr /><span className="parameters">(long&nbsp;orphanedTablesTotalSize)</span></div>
<div className="block">If <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#VERIFY_PERSIST"><code>VERIFY\_PERSIST</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a>, <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#VERIFY_ORPHANED_TABLES_ONLY"><code>VERIFY\_ORPHANED\_TABLES\_ONLY</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a> or <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#DELETE_ORPHANED_TABLES"><code>DELETE\_ORPHANED\_TABLES</code></a> is <a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbRequest.Options#TRUE"><code>TRUE</code></a>, this is the sum in bytes of all orphaned tables found. Otherwise, -1.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>orphanedTablesTotalSize</code> - The new value for <code> orphanedTablesTotalSize</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminVerifyDbResponse" title="class in com.gpudb.protocol">AdminVerifyDbResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

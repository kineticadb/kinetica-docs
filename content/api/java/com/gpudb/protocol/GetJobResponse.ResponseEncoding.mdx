...
<div className="inheritance">com.gpudb.protocol.GetJobResponse.ResponseEncoding</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GetJobResponse" title="class in com.gpudb.protocol"><code>GetJobResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GetJobResponse#getResponseEncoding()"><code>responseEncoding</code></a>. 
<p> The encoding of the job result (contained in <a href="/content/api/java/com/gpudb/protocol/GetJobResponse#getJobResponse()"><code>jobResponse</code></a> or <a href="/content/api/java/com/gpudb/protocol/GetJobResponse#getJobResponseStr()"><code>jobResponseStr</code></a>.</p>
</div>
</div>

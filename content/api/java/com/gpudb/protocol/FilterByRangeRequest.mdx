...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/filterbyrange#filterByRange(com.gpudb.protocol.FilterByRangeRequest)"><code>GPUdb.filterByRange</code></a>. 

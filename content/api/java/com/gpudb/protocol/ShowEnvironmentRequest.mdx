...
<div className="inheritance">com.gpudb.protocol.ShowEnvironmentRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showenvironment#showEnvironment(com.gpudb.protocol.ShowEnvironmentRequest)"><code>GPUdb.showEnvironment</code></a>. 
...
<ul>
<li>
<a href="/content/api/java/com/gpudb/protocol/ShowEnvironmentRequest.Options#NO_ERROR_IF_NOT_EXISTS"><code>NO\_ERROR\_IF\_NOT\_EXISTS</code></a>: If <a href="/content/api/java/com/gpudb/protocol/ShowEnvironmentRequest.Options#TRUE"><code>TRUE</code></a> and if the environment specified in <a href="#getEnvironmentName()"><code>environmentName</code></a> does not exist, no error is returned. If <a href="/content/api/java/com/gpudb/protocol/ShowEnvironmentRequest.Options#FALSE"><code>FALSE</code></a> and if the environment specified in <a href="#getEnvironmentName()"><code>environmentName</code></a> does not exist, then an error is returned. Supported values: 
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ShowEnvironmentRequest.Options#TRUE"><code>TRUE</code></a> </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowEnvironmentRequest.Options#FALSE"><code>FALSE</code></a> </li>
</ul>

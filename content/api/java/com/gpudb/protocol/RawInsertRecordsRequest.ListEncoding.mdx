...
<div className="inheritance">com.gpudb.protocol.RawInsertRecordsRequest.ListEncoding</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RawInsertRecordsRequest" title="class in com.gpudb.protocol"><code>RawInsertRecordsRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RawInsertRecordsRequest#getListEncoding()"><code>listEncoding</code></a>. 

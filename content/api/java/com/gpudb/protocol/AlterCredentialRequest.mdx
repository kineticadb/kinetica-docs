...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#alterCredential(com.gpudb.protocol.AlterCredentialRequest)"><code>GPUdb.alterCredential</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.AlterCredentialRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/altercredential#alterCredential(com.gpudb.protocol.AlterCredentialRequest)"><code>GPUdb.alterCredential</code></a>. 

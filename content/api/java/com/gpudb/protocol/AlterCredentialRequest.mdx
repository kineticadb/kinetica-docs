---
title: "AlterCredentialRequest"
description: "AlterCredentialRequest — Kinetica Java API"
---
...
<h1 title="Class AlterCredentialRequest" className="title">Class AlterCredentialRequest</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AlterCredentialRequest</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AlterCredentialRequest</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
<div className="block">A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#alterCredential(com.gpudb.protocol.AlterCredentialRequest)"><code>GPUdb.alterCredential</code></a>. <p> Alter the properties of an existing <a href="/content/concepts/credentials/" target="_top">credential</a>.</p></div>
</div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap" className="type-name-link" title="class in com.gpudb.protocol">AlterCredentialRequest.CredentialUpdatesMap</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest" title="class in com.gpudb.protocol"><code>AlterCredentialRequest</code></a> parameter <a href="#getCredentialUpdatesMap()"><code>credentialUpdatesMap</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AlterCredentialRequest</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AlterCredentialRequest object with default parameters.</div>
</div>
<div className="col-constructor-name odd-row-color"><code><a href="#%3Cinit%3E(java.lang.String,java.util.Map,java.util.Map)" className="member-name-link">AlterCredentialRequest</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;credentialName, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;credentialUpdatesMap, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</code></div>
<div className="col-last odd-row-color">
<div className="block">Constructs an AlterCredentialRequest object with the specified parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Name of the credential to be altered.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getCredentialUpdatesMap()" className="member-name-link">getCredentialUpdatesMap</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Map containing the properties of the credential to be updated.</div>
</div>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest" title="class in com.gpudb.protocol">AlterCredentialRequest</a></code></div>
...
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest" title="class in com.gpudb.protocol">AlterCredentialRequest</a></code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setCredentialUpdatesMap(java.util.Map)" className="member-name-link">setCredentialUpdatesMap</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;credentialUpdatesMap)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Map containing the properties of the credential to be updated.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest" title="class in com.gpudb.protocol">AlterCredentialRequest</a></code></div>
...
<h3>AlterCredentialRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AlterCredentialRequest</span>()</div>
<div className="block">Constructs an AlterCredentialRequest object with default parameters.</div>
</div>
</li>
<li>
...
<h3>AlterCredentialRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AlterCredentialRequest</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;credentialName, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;credentialUpdatesMap, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</span></div>
<div className="block">Constructs an AlterCredentialRequest object with the specified parameters.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>credentialName</code> - Name of the credential to be altered. Must be an existing credential.</div>
<div className="dd"><code>credentialUpdatesMap</code> - Map containing the properties of the credential to be updated. Error if empty. <ul> <li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#TYPE"><code>TYPE</code></a>: New type for the credential. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AWS_ACCESS_KEY"><code>AWS\_ACCESS\_KEY</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AWS_IAM_ROLE"><code>AWS\_IAM\_ROLE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_AD"><code>AZURE\_AD</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_OAUTH"><code>AZURE\_OAUTH</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_SAS"><code>AZURE\_SAS</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_STORAGE_KEY"><code>AZURE\_STORAGE\_KEY</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#DOCKER"><code>DOCKER</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#GCS_SERVICE_ACCOUNT_ID"><code>GCS\_SERVICE\_ACCOUNT\_ID</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#GCS_SERVICE_ACCOUNT_KEYS"><code>GCS\_SERVICE\_ACCOUNT\_KEYS</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#HDFS"><code>HDFS</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#KAFKA"><code>KAFKA</code></a> </li></ul> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#IDENTITY"><code>IDENTITY</code></a>: New user for the credential. </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SECRET"><code>SECRET</code></a>: New password for the credential. </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SCHEMA_NAME"><code>SCHEMA\_NAME</code></a>: Updates the schema name. If <a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SCHEMA_NAME"><code>SCHEMA\_NAME</code></a> doesn't exist, an error will be thrown. If <a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SCHEMA_NAME"><code>SCHEMA\_NAME</code></a> is empty, then the user's default schema will be used. </li></ul></div>
...
<div className="block">Name of the credential to be altered. Must be an existing credential.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest" title="class in com.gpudb.protocol">AlterCredentialRequest</a></span>&nbsp;<span className="element-name">setCredentialName</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;credentialName)</span></div>
<div className="block">Name of the credential to be altered. Must be an existing credential.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<li>
<div className="section detail" id="getCredentialUpdatesMap()">
<h3>getCredentialUpdatesMap</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;</span>&nbsp;<span className="element-name">getCredentialUpdatesMap</span>()</div>
<div className="block">Map containing the properties of the credential to be updated. Error if empty. <ul> <li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#TYPE"><code>TYPE</code></a>: New type for the credential. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AWS_ACCESS_KEY"><code>AWS\_ACCESS\_KEY</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AWS_IAM_ROLE"><code>AWS\_IAM\_ROLE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_AD"><code>AZURE\_AD</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_OAUTH"><code>AZURE\_OAUTH</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_SAS"><code>AZURE\_SAS</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_STORAGE_KEY"><code>AZURE\_STORAGE\_KEY</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#DOCKER"><code>DOCKER</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#GCS_SERVICE_ACCOUNT_ID"><code>GCS\_SERVICE\_ACCOUNT\_ID</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#GCS_SERVICE_ACCOUNT_KEYS"><code>GCS\_SERVICE\_ACCOUNT\_KEYS</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#HDFS"><code>HDFS</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#KAFKA"><code>KAFKA</code></a> </li></ul> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#IDENTITY"><code>IDENTITY</code></a>: New user for the credential. </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SECRET"><code>SECRET</code></a>: New password for the credential. </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SCHEMA_NAME"><code>SCHEMA\_NAME</code></a>: Updates the schema name. If <a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SCHEMA_NAME"><code>SCHEMA\_NAME</code></a> doesn't exist, an error will be thrown. If <a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SCHEMA_NAME"><code>SCHEMA\_NAME</code></a> is empty, then the user's default schema will be used. </li></ul></div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>credentialUpdatesMap</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setCredentialUpdatesMap(java.util.Map)">
<h3>setCredentialUpdatesMap</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest" title="class in com.gpudb.protocol">AlterCredentialRequest</a></span>&nbsp;<span className="element-name">setCredentialUpdatesMap</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;credentialUpdatesMap)</span></div>
<div className="block">Map containing the properties of the credential to be updated. Error if empty. <ul> <li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#TYPE"><code>TYPE</code></a>: New type for the credential. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AWS_ACCESS_KEY"><code>AWS\_ACCESS\_KEY</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AWS_IAM_ROLE"><code>AWS\_IAM\_ROLE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_AD"><code>AZURE\_AD</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_OAUTH"><code>AZURE\_OAUTH</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_SAS"><code>AZURE\_SAS</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#AZURE_STORAGE_KEY"><code>AZURE\_STORAGE\_KEY</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#DOCKER"><code>DOCKER</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#GCS_SERVICE_ACCOUNT_ID"><code>GCS\_SERVICE\_ACCOUNT\_ID</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#GCS_SERVICE_ACCOUNT_KEYS"><code>GCS\_SERVICE\_ACCOUNT\_KEYS</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#HDFS"><code>HDFS</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#KAFKA"><code>KAFKA</code></a> </li></ul> </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#IDENTITY"><code>IDENTITY</code></a>: New user for the credential. </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SECRET"><code>SECRET</code></a>: New password for the credential. </li><li><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SCHEMA_NAME"><code>SCHEMA\_NAME</code></a>: Updates the schema name. If <a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SCHEMA_NAME"><code>SCHEMA\_NAME</code></a> doesn't exist, an error will be thrown. If <a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest.CredentialUpdatesMap#SCHEMA_NAME"><code>SCHEMA\_NAME</code></a> is empty, then the user's default schema will be used. </li></ul></div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>credentialUpdatesMap</code> - The new value for <code> credentialUpdatesMap</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<h3>setOptions</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterCredentialRequest" title="class in com.gpudb.protocol">AlterCredentialRequest</a></span>&nbsp;<span className="element-name">setOptions</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</span></div>
<div className="block">Optional parameters.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

...
<div className="inheritance">com.gpudb.protocol.AlterSchemaRequest.Action</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AlterSchemaRequest" title="class in com.gpudb.protocol"><code>AlterSchemaRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AlterSchemaRequest#getAction()"><code>action</code></a>. 

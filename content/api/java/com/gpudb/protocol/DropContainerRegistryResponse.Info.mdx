---
title: "DropContainerRegistryResponse.Info"
description: "DropContainerRegistryResponse.Info — Kinetica Java API"
---
...
<h1 title="Class DropContainerRegistryResponse.Info" className="title">Class DropContainerRegistryResponse.Info</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.DropContainerRegistryResponse.Info</div> </div>
<div className="section class-description" id="class-description">
<div className="dl notes">
<div className="dt">Enclosing class:</div>
<div className="dd"><code><a href="/content/api/java/com/gpudb/protocol/DropContainerRegistryResponse" title="class in com.gpudb.protocol">DropContainerRegistryResponse</a></code></div>
</div>
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">DropContainerRegistryResponse.Info</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.DropContainerRegistryResponse.Info.KML_RESPONSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

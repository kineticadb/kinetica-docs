...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#aggregateUnique(com.gpudb.protocol.AggregateUniqueRequest)"><code>GPUdb.aggregateUnique</code></a>. 

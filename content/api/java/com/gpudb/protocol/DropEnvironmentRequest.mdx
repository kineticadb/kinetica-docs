...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#dropEnvironment(com.gpudb.protocol.DropEnvironmentRequest)"><code>GPUdb.dropEnvironment</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#filterByRadiusGeometry(com.gpudb.protocol.FilterByRadiusGeometryRequest)"><code>GPUdb.filterByRadiusGeometry</code></a>. 

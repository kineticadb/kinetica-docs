...
<div className="inheritance">com.gpudb.protocol.RevokePermissionProcRequest.Permission</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RevokePermissionProcRequest" title="class in com.gpudb.protocol"><code>RevokePermissionProcRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RevokePermissionProcRequest#getPermission()"><code>permission</code></a>. 

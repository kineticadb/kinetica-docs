...
<div className="inheritance">com.gpudb.protocol.ShowSystemTimingRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showsystemtiming#showSystemTiming(com.gpudb.protocol.ShowSystemTimingRequest)"><code>GPUdb.showSystemTiming</code></a>. 

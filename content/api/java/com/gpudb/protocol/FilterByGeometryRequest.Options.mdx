...
<div className="inheritance">com.gpudb.protocol.FilterByGeometryRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByGeometryRequest" title="class in com.gpudb.protocol"><code>FilterByGeometryRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByGeometryRequest#getOptions()"><code>options</code></a>. 

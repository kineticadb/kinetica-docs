...
<div className="inheritance">com.gpudb.protocol.CreateMaterializedViewResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/CreateMaterializedViewResponse.Info#QUALIFIED_TABLE_NAME"><code>QUALIFIED\_TABLE\_NAME</code></a>: The fully qualified name of the result table (i.e. including the schema). </li>
</ul>

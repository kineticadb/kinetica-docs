...
<div className="inheritance">com.gpudb.protocol.AlterResourceGroupRequest.TierAttributes</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AlterResourceGroupRequest" title="class in com.gpudb.protocol"><code>AlterResourceGroupRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AlterResourceGroupRequest#getTierAttributes()"><code>tierAttributes</code></a>. 

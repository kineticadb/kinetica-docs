...
<div className="inheritance">com.gpudb.protocol.RevokePermissionDirectoryRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/revokepermissiondirectory#revokePermissionDirectory(com.gpudb.protocol.RevokePermissionDirectoryRequest)"><code>GPUdb.revokePermissionDirectory</code></a>. 
<p> \[DEPRECATED--please use <a href="/content/api/java/com/gpudb/GPUdb/revokepermission#revokePermission(com.gpudb.protocol.RevokePermissionRequest)"><code>GPUdb.revokePermission</code></a> instead\] Revokes a <a href="/content/tools/kifs/" target="_top">KiFS</a> directory-level permission from a user or role.</p>
</div>
</div>

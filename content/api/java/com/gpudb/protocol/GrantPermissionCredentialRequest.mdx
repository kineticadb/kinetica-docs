...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#grantPermissionCredential(com.gpudb.protocol.GrantPermissionCredentialRequest)"><code>GPUdb.grantPermissionCredential</code></a>. 
<p> \[DEPRECATED--please use <a href="/content/api/java/com/gpudb/GPUdb#grantPermission(com.gpudb.protocol.GrantPermissionRequest)"><code>GPUdb.grantPermission</code></a> instead\] Grants a <a href="/content/security/sec_concepts/#security-concepts-permissions-credential" target="_top">credential-level permission</a> to a user or role.</p>
</div>
</div>

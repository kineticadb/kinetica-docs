...
<div className="inheritance">com.gpudb.protocol.GrantPermissionSystemRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/grantpermissionsystem#grantPermissionSystem(com.gpudb.protocol.GrantPermissionSystemRequest)"><code>GPUdb.grantPermissionSystem</code></a>. 
<p> \[DEPRECATED--please use <a href="/content/api/java/com/gpudb/GPUdb/grantpermission#grantPermission(com.gpudb.protocol.GrantPermissionRequest)"><code>GPUdb.grantPermission</code></a> instead\] Grants a system-level permission to a user or role.</p>
</div>
</div>

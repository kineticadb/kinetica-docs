...
<div className="inheritance">com.gpudb.protocol.AdminAddHostRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminaddhost#adminAddHost(com.gpudb.protocol.AdminAddHostRequest)"><code>GPUdb.adminAddHost</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/getrecordsfromcollection#getRecordsFromCollection(com.gpudb.protocol.GetRecordsFromCollectionRequest)"><code>GPUdb.getRecordsFromCollection</code></a>. 
<p> Retrieves records from a collection. The operation can optionally return the record IDs which can be used in certain queries such as <a href="/content/api/java/com/gpudb/GPUdb/deleterecords#deleteRecords(com.gpudb.protocol.DeleteRecordsRequest)"><code>GPUdb.deleteRecords</code></a>. </p>

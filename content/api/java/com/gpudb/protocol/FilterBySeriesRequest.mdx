...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/filterbyseries#filterBySeries(com.gpudb.protocol.FilterBySeriesRequest)"><code>GPUdb.filterBySeries</code></a>. 

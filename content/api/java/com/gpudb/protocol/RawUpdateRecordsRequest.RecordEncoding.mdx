---
title: "RawUpdateRecordsRequest.RecordEncoding"
description: "RawUpdateRecordsRequest.RecordEncoding — Kinetica Java API"
---
...
<h1 title="Class RawUpdateRecordsRequest.RecordEncoding" className="title">Class RawUpdateRecordsRequest.RecordEncoding</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.RawUpdateRecordsRequest.RecordEncoding</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">RawUpdateRecordsRequest.RecordEncoding</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RawUpdateRecordsRequest" title="class in com.gpudb.protocol"><code>RawUpdateRecordsRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RawUpdateRecordsRequest#getRecordEncoding()"><code>recordEncoding</code></a>. <p> Identifies which of <a href="/content/api/java/com/gpudb/protocol/RawUpdateRecordsRequest#getRecordsToInsert()"><code>recordsToInsert</code></a> and <a href="/content/api/java/com/gpudb/protocol/RawUpdateRecordsRequest#getRecordsToInsertStr()"><code>recordsToInsertStr</code></a> should be used.</p></div>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.RawUpdateRecordsRequest.RecordEncoding.BINARY">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.RawUpdateRecordsRequest.RecordEncoding.JSON">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

...
<div className="inheritance">com.gpudb.protocol.DropBackupRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/DropBackupRequest" title="class in com.gpudb.protocol"><code>DropBackupRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/DropBackupRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
Whether or not to perform a dry run of a backup deletion. Supported values: 
<ul>
...
<div className="block">
Allow multiple backups to be deleted if <a href="#TRUE"><code>TRUE</code></a> and multiple backup names are found matching <a href="/content/api/java/com/gpudb/protocol/DropBackupRequest#getBackupName()"><code>backupName</code></a>. Supported values: 
<ul>
<li><a href="#TRUE"><code>TRUE</code></a> </li>
<li><a href="#FALSE"><code>FALSE</code></a> </li>
</ul>

...
<div className="inheritance">com.gpudb.protocol.FilterByRadiusGeometryResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByRadiusGeometryResponse" title="class in com.gpudb.protocol"><code>FilterByRadiusGeometryResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByRadiusGeometryResponse#getInfo()"><code>info</code></a>. 

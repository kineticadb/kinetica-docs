...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#createUserExternal(com.gpudb.protocol.CreateUserExternalRequest)"><code>GPUdb.createUserExternal</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.CreateUserExternalRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/createuserexternal#createUserExternal(com.gpudb.protocol.CreateUserExternalRequest)"><code>GPUdb.createUserExternal</code></a>. 

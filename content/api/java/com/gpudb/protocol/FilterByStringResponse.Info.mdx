...
<div className="inheritance">com.gpudb.protocol.FilterByStringResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByStringResponse" title="class in com.gpudb.protocol"><code>FilterByStringResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByStringResponse#getInfo()"><code>info</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.AggregateMinMaxResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse" title="class in com.gpudb.protocol"><code>AggregateMinMaxResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse#getInfo()"><code>info</code></a>. 

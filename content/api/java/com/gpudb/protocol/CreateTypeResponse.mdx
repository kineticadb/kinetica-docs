...
<div className="block">An identifier representing the created type. This type\_id can be used in subsequent calls to <a href="/content/api/java/com/gpudb/GPUdb/createtable#createTable(com.gpudb.protocol.CreateTableRequest)"><code>create a table</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>

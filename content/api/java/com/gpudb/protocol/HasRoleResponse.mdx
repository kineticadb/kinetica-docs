...
<div className="inheritance">com.gpudb.protocol.HasRoleResponse</div>
</div>
...
<div className="block">
Indicates whether the specified user has membership in the specified target <a href="/content/api/java/com/gpudb/protocol/HasRoleRequest#getRole()"><code>role</code></a>. Supported values: 
<ul>
<li><code>true</code>: User has membership in the role. </li>
<li><code>false</code>: User does not have membership in the role. </li>
</ul>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<ul>
<li>
<a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#DIRECT"><code>DIRECT</code></a>: <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#TRUE"><code>TRUE</code></a> when principal is directly a member of the role. Supported values: 
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#TRUE"><code>TRUE</code></a> </li>
<li><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#FALSE"><code>FALSE</code></a> </li>
</ul>
 The default value is <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#FALSE"><code>FALSE</code></a>. 
</li>
</ul>

---
title: "HasRoleResponse"
description: "HasRoleResponse — Kinetica Java API"
---
...
<h1 title="Class HasRoleResponse" className="title">Class HasRoleResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.HasRoleResponse</div> </div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.HasRole" className="type-name-link" title="class in com.gpudb.protocol">HasRoleResponse.HasRole</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse" title="class in com.gpudb.protocol"><code>HasRoleResponse</code></a> parameter <a href="#getHasRole()"><code>hasRole</code></a>.</div>
</div>
<div className="col-first odd-row-color"><code>static final class&nbsp;</code></div>
<div className="col-second odd-row-color"><code><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info" className="type-name-link" title="class in com.gpudb.protocol">HasRoleResponse.Info</a></code></div>
<div className="col-last odd-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse" title="class in com.gpudb.protocol"><code>HasRoleResponse</code></a> parameter <a href="#getInfo()"><code>info</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">HasRoleResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a HasRoleResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getHasRole()" className="member-name-link">getHasRole</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates whether the specified user has membership in the specified target <a href="/content/api/java/com/gpudb/protocol/HasRoleRequest#getRole()"><code>role</code></a>.</div>
</div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/HasRoleRequest#getPrincipal()"><code>principal</code></a>.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getRole()" className="member-name-link">getRole</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block"><a href="/content/api/java/com/gpudb/protocol/HasRoleRequest#getRole()"><code>role</code></a> for which membership is being checked.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setHasRole(boolean)" className="member-name-link">setHasRole</a><wbr />(boolean&nbsp;hasRole)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates whether the specified user has membership in the specified target <a href="/content/api/java/com/gpudb/protocol/HasRoleRequest#getRole()"><code>role</code></a>.</div>
</div>
...
<h3>HasRoleResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">HasRoleResponse</span>()</div>
<div className="block">Constructs a HasRoleResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setPrincipal</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse" title="class in com.gpudb.protocol">HasRoleResponse</a></span>&nbsp;<span className="element-name">setPrincipal</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;principal)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/HasRoleRequest#getPrincipal()"><code>principal</code></a>.</div>
<div className="dl notes">
...
<h3>setRole</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse" title="class in com.gpudb.protocol">HasRoleResponse</a></span>&nbsp;<span className="element-name">setRole</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;role)</span></div>
<div className="block"><a href="/content/api/java/com/gpudb/protocol/HasRoleRequest#getRole()"><code>role</code></a> for which membership is being checked.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<li>
<div className="section detail" id="getHasRole()">
<h3>getHasRole</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">boolean</span>&nbsp;<span className="element-name">getHasRole</span>()</div>
<div className="block">Indicates whether the specified user has membership in the specified target <a href="/content/api/java/com/gpudb/protocol/HasRoleRequest#getRole()"><code>role</code></a>. Supported values: <ul> <li><code>true</code>: User has membership in the role. </li><li><code>false</code>: User does not have membership in the role. </li></ul></div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>hasRole</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setHasRole(boolean)">
<h3>setHasRole</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse" title="class in com.gpudb.protocol">HasRoleResponse</a></span>&nbsp;<span className="element-name">setHasRole</span><wbr /><span className="parameters">(boolean&nbsp;hasRole)</span></div>
<div className="block">Indicates whether the specified user has membership in the specified target <a href="/content/api/java/com/gpudb/protocol/HasRoleRequest#getRole()"><code>role</code></a>. Supported values: <ul> <li><code>true</code>: User has membership in the role. </li><li><code>false</code>: User does not have membership in the role. </li></ul></div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>hasRole</code> - The new value for <code>hasRole</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<div className="block">Additional information. <ul> <li><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#DIRECT"><code>DIRECT</code></a>: <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#TRUE"><code>TRUE</code></a> when principal is directly a member of the role. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#FALSE"><code>FALSE</code></a>. </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse" title="class in com.gpudb.protocol">HasRoleResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information. <ul> <li><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#DIRECT"><code>DIRECT</code></a>: <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#TRUE"><code>TRUE</code></a> when principal is directly a member of the role. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse.Info#FALSE"><code>FALSE</code></a>. </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

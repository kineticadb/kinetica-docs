...
<div className="inheritance">com.gpudb.protocol.ShowWalRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showwal#showWal(com.gpudb.protocol.ShowWalRequest)"><code>GPUdb.showWal</code></a>. 

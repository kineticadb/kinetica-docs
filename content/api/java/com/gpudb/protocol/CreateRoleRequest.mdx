...
<div className="inheritance">com.gpudb.protocol.CreateRoleRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/createrole#createRole(com.gpudb.protocol.CreateRoleRequest)"><code>GPUdb.createRole</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#uploadFilesFromurl(com.gpudb.protocol.UploadFilesFromurlRequest)"><code>GPUdb.uploadFilesFromurl</code></a>. 

---
title: "MatchGraphResponse"
description: "MatchGraphResponse — Kinetica Java API"
---
...
<h1 title="Class MatchGraphResponse" className="title">Class MatchGraphResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.MatchGraphResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">MatchGraphResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">MatchGraphResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a MatchGraphResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getMatchScore()" className="member-name-link">getMatchScore</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">The mean square error calculation representing the map matching score.</div>
</div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates a successful solution.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setMatchScore(float)" className="member-name-link">setMatchScore</a><wbr />(float&nbsp;matchScore)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">The mean square error calculation representing the map matching score.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/MatchGraphResponse" title="class in com.gpudb.protocol">MatchGraphResponse</a></code></div>
...
<h3>MatchGraphResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">MatchGraphResponse</span>()</div>
<div className="block">Constructs a MatchGraphResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setResult</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/MatchGraphResponse" title="class in com.gpudb.protocol">MatchGraphResponse</a></span>&nbsp;<span className="element-name">setResult</span><wbr /><span className="parameters">(boolean&nbsp;result)</span></div>
<div className="block">Indicates a successful solution.</div>
<div className="dl notes">
...
<li>
<div className="section detail" id="getMatchScore()">
<h3>getMatchScore</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">float</span>&nbsp;<span className="element-name">getMatchScore</span>()</div>
<div className="block">The mean square error calculation representing the map matching score. Values closer to zero are better.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>matchScore</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setMatchScore(float)">
<h3>setMatchScore</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/MatchGraphResponse" title="class in com.gpudb.protocol">MatchGraphResponse</a></span>&nbsp;<span className="element-name">setMatchScore</span><wbr /><span className="parameters">(float&nbsp;matchScore)</span></div>
<div className="block">The mean square error calculation representing the map matching score. Values closer to zero are better.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>matchScore</code> - The new value for <code>matchScore</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/MatchGraphResponse" title="class in com.gpudb.protocol">MatchGraphResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

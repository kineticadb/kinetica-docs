...
<div className="inheritance">com.gpudb.protocol.GrantPermissionCredentialRequest.Permission</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GrantPermissionCredentialRequest" title="class in com.gpudb.protocol"><code>GrantPermissionCredentialRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GrantPermissionCredentialRequest#getPermission()"><code>permission</code></a>. 

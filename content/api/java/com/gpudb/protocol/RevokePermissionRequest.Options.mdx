...
<div className="inheritance">com.gpudb.protocol.RevokePermissionRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RevokePermissionRequest" title="class in com.gpudb.protocol"><code>RevokePermissionRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RevokePermissionRequest#getOptions()"><code>options</code></a>. 

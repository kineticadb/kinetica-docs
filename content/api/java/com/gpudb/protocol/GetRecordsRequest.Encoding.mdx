...
<div className="inheritance">com.gpudb.protocol.GetRecordsRequest.Encoding</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GetRecordsRequest" title="class in com.gpudb.protocol"><code>GetRecordsRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GetRecordsRequest#getEncoding()"><code>encoding</code></a>. 
<p> Specifies the encoding for returned records; one of <a href="#BINARY"><code>BINARY</code></a>, <a href="#JSON"><code>JSON</code></a>, or <a href="#GEOJSON"><code>GEOJSON</code></a>.</p>
</div>
</div>

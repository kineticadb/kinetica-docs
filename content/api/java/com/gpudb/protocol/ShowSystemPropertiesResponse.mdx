---
title: "ShowSystemPropertiesResponse"
description: "ShowSystemPropertiesResponse — Kinetica Java API"
---
...
<h1 title="Class ShowSystemPropertiesResponse" className="title">Class ShowSystemPropertiesResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.ShowSystemPropertiesResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">ShowSystemPropertiesResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap" className="type-name-link" title="class in com.gpudb.protocol">ShowSystemPropertiesResponse.PropertyMap</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse" title="class in com.gpudb.protocol"><code>ShowSystemPropertiesResponse</code></a> parameter <a href="#getPropertyMap()"><code>propertyMap</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">ShowSystemPropertiesResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a ShowSystemPropertiesResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getPropertyMap()" className="member-name-link">getPropertyMap</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">A map of server configuration parameters and version information.</div>
</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setPropertyMap(java.util.Map)" className="member-name-link">setPropertyMap</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;propertyMap)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">A map of server configuration parameters and version information.</div>
</div>
...
<h3>ShowSystemPropertiesResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">ShowSystemPropertiesResponse</span>()</div>
<div className="block">Constructs a ShowSystemPropertiesResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<li>
<div className="section detail" id="getPropertyMap()">
<h3>getPropertyMap</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;</span>&nbsp;<span className="element-name">getPropertyMap</span>()</div>
<div className="block">A map of server configuration parameters and version information. <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_ENABLE_WORKER_HTTP_SERVERS"><code>CONF\_ENABLE\_WORKER\_HTTP\_SERVERS</code></a>: Boolean value indicating whether the system is configured for multi-head ingestion. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#TRUE"><code>TRUE</code></a>: Indicates that the system is configured for multi-head ingestion. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#FALSE"><code>FALSE</code></a>: Indicates that the system is NOT configured for multi-head ingestion. </li></ul> </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_WORKER_HTTP_SERVER_IPS"><code>CONF\_WORKER\_HTTP\_SERVER\_IPS</code></a>: Semicolon (';') separated string of IP addresses of all the ingestion-enabled worker heads of the system. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_WORKER_HTTP_SERVER_PORTS"><code>CONF\_WORKER\_HTTP\_SERVER\_PORTS</code></a>: Semicolon (';') separated string of the port numbers of all the ingestion-enabled worker ranks of the system. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_HM_HTTP_PORT"><code>CONF\_HM\_HTTP\_PORT</code></a>: The host manager port number (an integer value). </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_ENABLE_HA"><code>CONF\_ENABLE\_HA</code></a>: Flag indicating whether high availability (HA) is set up (a boolean value). </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_HA_RING_HEAD_NODES"><code>CONF\_HA\_RING\_HEAD\_NODES</code></a>: A comma-separated string of high availability (HA) ring node URLs. If HA is not set up, then an empty string. </li></ul></div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>propertyMap</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setPropertyMap(java.util.Map)">
<h3>setPropertyMap</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse" title="class in com.gpudb.protocol">ShowSystemPropertiesResponse</a></span>&nbsp;<span className="element-name">setPropertyMap</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;propertyMap)</span></div>
<div className="block">A map of server configuration parameters and version information. <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_ENABLE_WORKER_HTTP_SERVERS"><code>CONF\_ENABLE\_WORKER\_HTTP\_SERVERS</code></a>: Boolean value indicating whether the system is configured for multi-head ingestion. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#TRUE"><code>TRUE</code></a>: Indicates that the system is configured for multi-head ingestion. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#FALSE"><code>FALSE</code></a>: Indicates that the system is NOT configured for multi-head ingestion. </li></ul> </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_WORKER_HTTP_SERVER_IPS"><code>CONF\_WORKER\_HTTP\_SERVER\_IPS</code></a>: Semicolon (';') separated string of IP addresses of all the ingestion-enabled worker heads of the system. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_WORKER_HTTP_SERVER_PORTS"><code>CONF\_WORKER\_HTTP\_SERVER\_PORTS</code></a>: Semicolon (';') separated string of the port numbers of all the ingestion-enabled worker ranks of the system. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_HM_HTTP_PORT"><code>CONF\_HM\_HTTP\_PORT</code></a>: The host manager port number (an integer value). </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_ENABLE_HA"><code>CONF\_ENABLE\_HA</code></a>: Flag indicating whether high availability (HA) is set up (a boolean value). </li><li><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse.PropertyMap#CONF_HA_RING_HEAD_NODES"><code>CONF\_HA\_RING\_HEAD\_NODES</code></a>: A comma-separated string of high availability (HA) ring node URLs. If HA is not set up, then an empty string. </li></ul></div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>propertyMap</code> - The new value for <code>propertyMap</code>.</div>
<div className="dt">Returns:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesResponse" title="class in com.gpudb.protocol">ShowSystemPropertiesResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

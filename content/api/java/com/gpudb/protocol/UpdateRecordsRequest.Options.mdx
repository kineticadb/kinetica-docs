---
title: "UpdateRecordsRequest.Options"
description: "UpdateRecordsRequest.Options — Kinetica Java API"
---
...
<h1 title="Class UpdateRecordsRequest.Options" className="title">Class UpdateRecordsRequest.Options</h1>
</div>
...
<div className="inheritance">com.gpudb.protocol.UpdateRecordsRequest.Options</div>
</div>
<div className="section class-description" id="class-description">
<div className="dl notes">
<div className="dt">Enclosing class:</div>
<div className="dd"><code><a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest" title="class in com.gpudb.protocol">UpdateRecordsRequest</a>&lt;<a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest" title="type parameter in UpdateRecordsRequest">T</a>&gt;</code></div>
</div>
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">UpdateRecordsRequest.Options</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest" title="class in com.gpudb.protocol"><code>UpdateRecordsRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">Stops the update and rejects the remaining batch when any record is incorrect.</div>
</div>
...
<div className="col-second odd-row-color"><code><a href="#BYPASS_SAFETY_CHECKS" className="member-name-link">BYPASS\_SAFETY\_CHECKS</a></code></div>
...
<div className="col-first odd-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
<div className="col-second odd-row-color"><code><a href="#ENABLE_WORKER_OOP_UPDATE" className="member-name-link">ENABLE\_WORKER\_OOP\_UPDATE</a></code></div>
<div className="col-last odd-row-color">
<div className="block">For an out-of-place update (delete and insert), controls where the replacement records are reinserted.</div>
</div>
<div className="col-first even-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
<div className="col-second even-row-color"><code><a href="#ERROR_HANDLING" className="member-name-link">ERROR\_HANDLING</a></code></div>
<div className="col-last even-row-color">
<div className="block">Specifies how record errors are handled during the update's reinsert (including any alternate insert records supplied via <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getData()"><code>data</code></a>).</div>
</div>
<div className="col-first odd-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
...
<div className="col-last even-row-color">
<div className="block">An optional global expression to reduce the search space of the predicates listed in <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getExpressions()"><code>expressions</code></a>.</div>
</div>
<div className="col-first odd-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
...
<div className="col-last even-row-color">
<div className="block">Records with bad column values are kept when possible: the offending column is filled with its default value if one exists, otherwise with null if the column is nullable; if neither is possible the record is skipped and reported.</div>
</div>
<div className="col-first odd-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
...
<div className="col-last odd-row-color">
<div className="block">ID of a single record to be updated (returned in the call to <a href="/content/api/java/com/gpudb/GPUdb#insertRecords(com.gpudb.protocol.InsertRecordsRequest)"><code>GPUdb.insertRecords</code></a> or <a href="/content/api/java/com/gpudb/GPUdb#getRecordsFromCollection(com.gpudb.protocol.GetRecordsFromCollectionRequest)"><code>GPUdb.getRecordsFromCollection</code></a>).</div>
</div>
<div className="col-first even-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
<div className="col-second even-row-color"><code><a href="#SKIP" className="member-name-link">SKIP</a></code></div>
<div className="col-last even-row-color">
<div className="block">Records with bad values are skipped and reported; the rest of the batch is applied.</div>
</div>
<div className="col-first odd-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
...
<div className="col-first even-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
<div className="col-second even-row-color"><code><a href="#UPDATE_PARTITION" className="member-name-link">UPDATE\_PARTITION</a></code></div>
<div className="col-last even-row-color">
...
<div className="col-first odd-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
<div className="col-second odd-row-color"><code><a href="#USE_EXPRESSIONS_IN_NEW_VALUES_MAPS" className="member-name-link">USE\_EXPRESSIONS\_IN\_NEW\_VALUES\_MAPS</a></code></div>
<div className="col-last odd-row-color">
<div className="block">When set to <a href="#TRUE"><code>TRUE</code></a>, all new values in <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getNewValuesMaps()"><code>newValuesMaps</code></a> are considered as expression values.</div>
</div>
</div>
</div>
</li>
...
<div className="block">An optional global expression to reduce the search space of the predicates listed in <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getExpressions()"><code>expressions</code></a>. The default value is ''.</div>
<div className="dl notes">
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.GLOBAL_EXPRESSION">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.BYPASS_SAFETY_CHECKS">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="block">
Specifies how record errors are handled during the update's reinsert (including any alternate insert records supplied via <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getData()"><code>data</code></a>). When set, this option is authoritative for the reinsert. Primary-key collision behavior is governed by <a href="#UPDATE_ON_EXISTING_PK"><code>UPDATE\_ON\_EXISTING\_PK</code></a> and <a href="#IGNORE_EXISTING_PK"><code>IGNORE\_EXISTING\_PK</code></a>. Supported values: 
<ul>
<li><a href="#PERMISSIVE"><code>PERMISSIVE</code></a>: Records with bad column values are kept when possible: the offending column is filled with its default value if one exists, otherwise with null if the column is nullable; if neither is possible the record is skipped and reported. </li>
<li><a href="#SKIP"><code>SKIP</code></a>: Records with bad values are skipped and reported; the rest of the batch is applied. </li>
<li><a href="#ABORT"><code>ABORT</code></a>: Stops the update and rejects the remaining batch when any record is incorrect. </li>
</ul>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.ERROR_HANDLING">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.PERMISSIVE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.SKIP">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.ABORT">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<p> The second is an "insert collision", which occurs when a given filter in <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getExpressions()"><code>expressions</code></a> finds no records to update, and the alternate insert record given in <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getData()"><code>data</code></a> (or <code>recordsToInsertStr</code>) contains a primary key matching that of an existing record in the table. </p>
<p> If <a href="#UPDATE_ON_EXISTING_PK"><code>UPDATE\_ON\_EXISTING\_PK</code></a> is set to <a href="#TRUE"><code>TRUE</code></a>, "update collisions" will result in the existing record collided into being removed and the record updated with values specified in <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getNewValuesMaps()"><code>newValuesMaps</code></a> taking its place; "insert collisions" will result in the collided-into record being updated with the values in <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getData()"><code>data</code></a> / <code>recordsToInsertStr</code> (if given). </p>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.UPDATE_ON_EXISTING_PK">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.PK_CONFLICT_PREDICATE_HIGHER">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.PK_CONFLICT_PREDICATE_LOWER">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.IGNORE_EXISTING_PK">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.UPDATE_PARTITION">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.ENABLE_INPLACE_UPDATES">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<li>
<div className="section detail" id="ENABLE_WORKER_OOP_UPDATE">
<h3>ENABLE\_WORKER\_OOP\_UPDATE</h3>
<div className="member-signature"><span className="modifiers">public static final</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></span>&nbsp;<span className="element-name">ENABLE\_WORKER\_OOP\_UPDATE</span></div>
<div className="block">
For an out-of-place update (delete and insert), controls where the replacement records are reinserted. If set to <a href="#TRUE"><code>TRUE</code></a>, the workers that own the data reinsert them directly, avoiding a round trip through the head node; a shard-key change reshards the replacements to their new owning workers. If set to <a href="#FALSE"><code>FALSE</code></a>, the replacement records are reinserted from the head node. Overrides the {"{"}feature.enable\_worker\_oop\_update{"}"}@ configuration default. Supported values: 
<ul>
<li><a href="#TRUE"><code>TRUE</code></a> </li>
<li><a href="#FALSE"><code>FALSE</code></a> </li>
</ul>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.ENABLE_WORKER_OOP_UPDATE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.TRUNCATE_STRINGS">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="block">
When set to <a href="#TRUE"><code>TRUE</code></a>, all new values in <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getNewValuesMaps()"><code>newValuesMaps</code></a> are considered as expression values. When set to <a href="#FALSE"><code>FALSE</code></a>, all new values in <a href="/content/api/java/com/gpudb/protocol/UpdateRecordsRequest#getNewValuesMaps()"><code>newValuesMaps</code></a> are considered as constants. NOTE: When <a href="#TRUE"><code>TRUE</code></a>, string constants will need to be quoted to avoid being evaluated as expressions. Supported values: 
<ul>
<li><a href="#TRUE"><code>TRUE</code></a> </li>
<li><a href="#FALSE"><code>FALSE</code></a> </li>
</ul>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.USE_EXPRESSIONS_IN_NEW_VALUES_MAPS">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.UpdateRecordsRequest.Options.RECORD_ID">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

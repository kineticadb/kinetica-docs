...
<div className="inheritance">com.gpudb.protocol.FilterByListResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByListResponse" title="class in com.gpudb.protocol"><code>FilterByListResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByListResponse#getInfo()"><code>info</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.FilterRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/filter#filter(com.gpudb.protocol.FilterRequest)"><code>GPUdb.filter</code></a>. 
<p> Filters data based on the specified expression. The results are stored in a <a href="/content/concepts/filtered_views/" target="_top">result set</a> with the given <a href="#getViewName()"><code>viewName</code></a>. </p>
...
<ul>
<li>
<a href="/content/api/java/com/gpudb/protocol/FilterRequest.Options#CREATE_TEMP_TABLE"><code>CREATE\_TEMP\_TABLE</code></a>: If <a href="/content/api/java/com/gpudb/protocol/FilterRequest.Options#TRUE"><code>TRUE</code></a>, a unique temporary table name will be generated in the sys\_temp schema and used in place of <a href="#getViewName()"><code>viewName</code></a>. This is always allowed even if the caller does not have permission to create tables. The generated name is returned in <a href="/content/api/java/com/gpudb/protocol/FilterResponse.Info#QUALIFIED_VIEW_NAME"><code>QUALIFIED\_VIEW\_NAME</code></a>. Supported values: 
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/FilterRequest.Options#TRUE"><code>TRUE</code></a> </li>
<li><a href="/content/api/java/com/gpudb/protocol/FilterRequest.Options#FALSE"><code>FALSE</code></a> </li>
</ul>
...
<li><a href="/content/api/java/com/gpudb/protocol/FilterRequest.Options#VIEW_ID"><code>VIEW\_ID</code></a>: View this filtered-view is part of. The default value is ''. </li>
<li><a href="/content/api/java/com/gpudb/protocol/FilterRequest.Options#TTL"><code>TTL</code></a>: Sets the <a href="/content/concepts/ttl/" target="_top">TTL</a> of the view specified in <a href="#getViewName()"><code>viewName</code></a>. </li>
</ul>
 The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.
</div>
<div className="dl notes">

...
<div className="inheritance">com.gpudb.protocol.ClearTriggerRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/cleartrigger#clearTrigger(com.gpudb.protocol.ClearTriggerRequest)"><code>GPUdb.clearTrigger</code></a>. 

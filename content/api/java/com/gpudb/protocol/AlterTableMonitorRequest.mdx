...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#alterTableMonitor(com.gpudb.protocol.AlterTableMonitorRequest)"><code>GPUdb.alterTableMonitor</code></a>. 
<p> Alters a table monitor previously created with <a href="/content/api/java/com/gpudb/GPUdb#createTableMonitor(com.gpudb.protocol.CreateTableMonitorRequest)"><code>GPUdb.createTableMonitor</code></a>.</p>
</div>
</div>

...
<div className="inheritance">com.gpudb.protocol.AlterTableMonitorRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/altertablemonitor#alterTableMonitor(com.gpudb.protocol.AlterTableMonitorRequest)"><code>GPUdb.alterTableMonitor</code></a>. 
<p> Alters a table monitor previously created with <a href="/content/api/java/com/gpudb/GPUdb/createtablemonitor#createTableMonitor(com.gpudb.protocol.CreateTableMonitorRequest)"><code>GPUdb.createTableMonitor</code></a>.</p>
</div>
</div>
...
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">The topic ID returned by <a href="/content/api/java/com/gpudb/GPUdb/createtablemonitor#createTableMonitor(com.gpudb.protocol.CreateTableMonitorRequest)"><code>GPUdb.createTableMonitor</code></a>.</div>
</div>
...
<div className="dd"><code>topicId</code> - The topic ID returned by <a href="/content/api/java/com/gpudb/GPUdb/createtablemonitor#createTableMonitor(com.gpudb.protocol.CreateTableMonitorRequest)"><code>GPUdb.createTableMonitor</code></a>.</div>
<div className="dd">

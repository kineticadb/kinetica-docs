---
title: "VisualizeGetFeatureInfoRequest.Options"
description: "VisualizeGetFeatureInfoRequest.Options — Kinetica Java API"
---
...
<h1 title="Class VisualizeGetFeatureInfoRequest.Options" className="title">Class VisualizeGetFeatureInfoRequest.Options</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.VisualizeGetFeatureInfoRequest.Options</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">VisualizeGetFeatureInfoRequest.Options</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
</div>
...
<div className="col-second even-row-color"><code><a href="#AUTO_COLUMN_SELECTION" className="member-name-link">AUTO\_COLUMN\_SELECTION</a></code></div>
...
<li>
<div className="section detail" id="AUTO_COLUMN_SELECTION">
<h3>AUTO\_COLUMN\_SELECTION</h3>
<div className="member-signature"><span className="modifiers">public static final</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></span>&nbsp;<span className="element-name">AUTO\_COLUMN\_SELECTION</span></div>
<div className="dl notes">
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.VisualizeGetFeatureInfoRequest.Options.AUTO_COLUMN_SELECTION">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.VisualizeGetFeatureInfoRequest.Options.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.VisualizeGetFeatureInfoRequest.Options.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

...
<div className="inheritance">com.gpudb.protocol.AdminHaOfflineRequest.Offline</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminHaOfflineRequest" title="class in com.gpudb.protocol"><code>AdminHaOfflineRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AdminHaOfflineRequest#getOffline()"><code>offline</code></a>. 

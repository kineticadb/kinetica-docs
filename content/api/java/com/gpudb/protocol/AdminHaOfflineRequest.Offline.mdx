---
title: "AdminHaOfflineRequest.Offline"
description: "AdminHaOfflineRequest.Offline — Kinetica Java API"
---
...
<h1 title="Class AdminHaOfflineRequest.Offline" className="title">Class AdminHaOfflineRequest.Offline</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AdminHaOfflineRequest.Offline</div> </div>
<div className="section class-description" id="class-description">
<div className="dl notes">
<div className="dt">Enclosing class:</div>
<div className="dd"><code><a href="/content/api/java/com/gpudb/protocol/AdminHaOfflineRequest" title="class in com.gpudb.protocol">AdminHaOfflineRequest</a></code></div>
</div>
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">AdminHaOfflineRequest.Offline</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminHaOfflineRequest" title="class in com.gpudb.protocol"><code>AdminHaOfflineRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AdminHaOfflineRequest#getOffline()"><code>offline</code></a>. <p> Set to true if desired state is offline.</p></div>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminHaOfflineRequest.Offline.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminHaOfflineRequest.Offline.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

...
<div className="inheritance">com.gpudb.protocol.ShowProcRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showproc#showProc(com.gpudb.protocol.ShowProcRequest)"><code>GPUdb.showProc</code></a>. 

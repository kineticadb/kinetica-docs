...
<div className="inheritance">com.gpudb.protocol.FilterByRadiusResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByRadiusResponse" title="class in com.gpudb.protocol"><code>FilterByRadiusResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByRadiusResponse#getInfo()"><code>info</code></a>. 

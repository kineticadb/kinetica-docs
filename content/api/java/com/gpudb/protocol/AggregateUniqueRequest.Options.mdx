...
<div className="inheritance">com.gpudb.protocol.AggregateUniqueRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateUniqueRequest" title="class in com.gpudb.protocol"><code>AggregateUniqueRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AggregateUniqueRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a>, a unique temporary table name will be generated in the sys\_temp schema and used in place of <a href="#RESULT_TABLE"><code>RESULT\_TABLE</code></a>. If <a href="#RESULT_TABLE_PERSIST"><code>RESULT\_TABLE\_PERSIST</code></a> is <a href="#FALSE"><code>FALSE</code></a> (or unspecified), then this is always allowed even if the caller does not have permission to create tables. The generated name is returned in <a href="/content/api/java/com/gpudb/protocol/AggregateUniqueResponse.Info#QUALIFIED_RESULT_TABLE_NAME"><code>QUALIFIED\_RESULT\_TABLE\_NAME</code></a>. Supported values: 
<ul>
...
<div className="block">
String indicating how the returned values should be sorted. Supported values: 
<ul>

...
<div className="inheritance">com.gpudb.protocol.ClearTableRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ClearTableRequest" title="class in com.gpudb.protocol"><code>ClearTableRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ClearTableRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a> and if the table specified in <a href="/content/api/java/com/gpudb/protocol/ClearTableRequest#getTableName()"><code>tableName</code></a> does not exist no error is returned. If <a href="#FALSE"><code>FALSE</code></a> and if the table specified in <a href="/content/api/java/com/gpudb/protocol/ClearTableRequest#getTableName()"><code>tableName</code></a> does not exist then an error is returned. Supported values: 
<ul>

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#grantPermissionDatasource(com.gpudb.protocol.GrantPermissionDatasourceRequest)"><code>GPUdb.grantPermissionDatasource</code></a>. 
<p> \[DEPRECATED--please use <a href="/content/api/java/com/gpudb/GPUdb#grantPermission(com.gpudb.protocol.GrantPermissionRequest)"><code>GPUdb.grantPermission</code></a> instead\] Grants a <a href="/content/concepts/data_sources/" target="_top">data source</a> permission to a user or role.</p>
</div>
</div>

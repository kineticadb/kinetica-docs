...
<div className="inheritance">com.gpudb.protocol.DropCredentialRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/dropcredential#dropCredential(com.gpudb.protocol.DropCredentialRequest)"><code>GPUdb.dropCredential</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#dropCredential(com.gpudb.protocol.DropCredentialRequest)"><code>GPUdb.dropCredential</code></a>. 

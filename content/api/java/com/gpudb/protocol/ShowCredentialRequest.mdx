...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#showCredential(com.gpudb.protocol.ShowCredentialRequest)"><code>GPUdb.showCredential</code></a>. 

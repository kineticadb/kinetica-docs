...
<div className="inheritance">com.gpudb.protocol.ShowCredentialRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showcredential#showCredential(com.gpudb.protocol.ShowCredentialRequest)"><code>GPUdb.showCredential</code></a>. 

---
title: "CreateStateTableResponse"
description: "CreateStateTableResponse — Kinetica Java API"
---
...
<h1 title="Class CreateStateTableResponse" className="title">Class CreateStateTableResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.CreateStateTableResponse</div> </div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">CreateStateTableResponse</a>()</code></div>
...
<h3>CreateStateTableResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">CreateStateTableResponse</span>()</div>
</div>
</li>
</ul>
</div>

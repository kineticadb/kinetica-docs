...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/alterdatasink#alterDatasink(com.gpudb.protocol.AlterDatasinkRequest)"><code>GPUdb.alterDatasink</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.FilterByAreaResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByAreaResponse" title="class in com.gpudb.protocol"><code>FilterByAreaResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByAreaResponse#getInfo()"><code>info</code></a>. 

...
<li><a href="/content/api/java/com/gpudb/protocol/InsertRecordsFromQueryRequest.Options#IGNORE_BAD_RECORDS"><code>IGNORE\_BAD\_RECORDS</code></a>: Alias for skip. </li>

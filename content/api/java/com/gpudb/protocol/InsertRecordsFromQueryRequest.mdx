...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/insertrecordsfromquery#insertRecordsFromQuery(com.gpudb.protocol.InsertRecordsFromQueryRequest)"><code>GPUdb.insertRecordsFromQuery</code></a>. 

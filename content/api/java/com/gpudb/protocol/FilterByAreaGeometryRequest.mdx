...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#filterByAreaGeometry(com.gpudb.protocol.FilterByAreaGeometryRequest)"><code>GPUdb.filterByAreaGeometry</code></a>. 

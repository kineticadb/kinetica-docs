...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#alterDatasource(com.gpudb.protocol.AlterDatasourceRequest)"><code>GPUdb.alterDatasource</code></a>. 

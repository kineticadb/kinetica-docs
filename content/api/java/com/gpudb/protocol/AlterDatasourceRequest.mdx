...
<div className="inheritance">com.gpudb.protocol.AlterDatasourceRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/alterdatasource#alterDatasource(com.gpudb.protocol.AlterDatasourceRequest)"><code>GPUdb.alterDatasource</code></a>. 

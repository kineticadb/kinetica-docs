...
<div className="inheritance">com.gpudb.protocol.ShowTypesRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showtypes#showTypes(com.gpudb.protocol.ShowTypesRequest)"><code>GPUdb.showTypes</code></a>. 
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Option string that was supplied by user in a call to <a href="/content/api/java/com/gpudb/GPUdb/createtype#createType(com.gpudb.protocol.CreateTypeRequest)"><code>GPUdb.createType</code></a>.</div>
</div>
...
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Type Id returned in response to a call to <a href="/content/api/java/com/gpudb/GPUdb/createtype#createType(com.gpudb.protocol.CreateTypeRequest)"><code>GPUdb.createType</code></a>.</div>
</div>
...
<div className="dd"><code>typeId</code> - Type Id returned in response to a call to <a href="/content/api/java/com/gpudb/GPUdb/createtype#createType(com.gpudb.protocol.CreateTypeRequest)"><code>GPUdb.createType</code></a>.</div>
<div className="dd"><code>label</code> - Option string that was supplied by user in a call to <a href="/content/api/java/com/gpudb/GPUdb/createtype#createType(com.gpudb.protocol.CreateTypeRequest)"><code>GPUdb.createType</code></a>.</div>
<div className="dd">

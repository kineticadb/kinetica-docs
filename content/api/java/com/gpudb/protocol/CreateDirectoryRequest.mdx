...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#createDirectory(com.gpudb.protocol.CreateDirectoryRequest)"><code>GPUdb.createDirectory</code></a>. 
<p> Creates a new directory in <a href="/content/tools/kifs/" target="_top">KiFS</a>. The new directory serves as a location in which the user can upload files using <a href="/content/api/java/com/gpudb/GPUdb#uploadFiles(com.gpudb.protocol.UploadFilesRequest)"><code>GPUdb.uploadFiles</code></a>.</p>
</div>
</div>

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminShowAlerts(com.gpudb.protocol.AdminShowAlertsRequest)"><code>GPUdb.adminShowAlerts</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.AdminShowAlertsRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminshowalerts#adminShowAlerts(com.gpudb.protocol.AdminShowAlertsRequest)"><code>GPUdb.adminShowAlerts</code></a>. 

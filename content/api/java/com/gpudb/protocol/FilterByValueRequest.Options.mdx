...
<div className="inheritance">com.gpudb.protocol.FilterByValueRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByValueRequest" title="class in com.gpudb.protocol"><code>FilterByValueRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByValueRequest#getOptions()"><code>options</code></a>. 

---
title: "FilterByValueRequest.Options"
description: "FilterByValueRequest.Options — Kinetica Java API"
---
...
<h1 title="Class FilterByValueRequest.Options" className="title">Class FilterByValueRequest.Options</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.FilterByValueRequest.Options</div> </div>
<div className="section class-description" id="class-description">
<div className="dl notes">
<div className="dt">Enclosing class:</div>
<div className="dd"><code><a href="/content/api/java/com/gpudb/protocol/FilterByValueRequest" title="class in com.gpudb.protocol">FilterByValueRequest</a></code></div>
</div>
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">FilterByValueRequest.Options</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByValueRequest" title="class in com.gpudb.protocol"><code>FilterByValueRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByValueRequest#getOptions()"><code>options</code></a>. <p> Optional parameters.</p></div>
</div>
...
<div className="block">If <a href="#TRUE"><code>TRUE</code></a>, a unique temporary table name will be generated in the sys\_temp schema and used in place of <a href="/content/api/java/com/gpudb/protocol/FilterByValueRequest#getViewName()"><code>viewName</code></a>.</div>
</div>
<div className="col-first even-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
...
<div className="block">If <a href="#TRUE"><code>TRUE</code></a>, a unique temporary table name will be generated in the sys\_temp schema and used in place of <a href="/content/api/java/com/gpudb/protocol/FilterByValueRequest#getViewName()"><code>viewName</code></a>. This is always allowed even if the caller does not have permission to create tables. The generated name is returned in <a href="/content/api/java/com/gpudb/protocol/FilterByValueResponse.Info#QUALIFIED_VIEW_NAME"><code>QUALIFIED\_VIEW\_NAME</code></a>. Supported values: <ul> <li><a href="#TRUE"><code>TRUE</code></a> </li><li><a href="#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="#FALSE"><code>FALSE</code></a>.</div>
<div className="dl notes">
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.FilterByValueRequest.Options.CREATE_TEMP_TABLE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.FilterByValueRequest.Options.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.FilterByValueRequest.Options.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.FilterByValueRequest.Options.COLLECTION_NAME">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

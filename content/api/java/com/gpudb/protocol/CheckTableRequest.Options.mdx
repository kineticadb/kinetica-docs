...
<div className="inheritance">com.gpudb.protocol.CheckTableRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CheckTableRequest" title="class in com.gpudb.protocol"><code>CheckTableRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CheckTableRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a> only locally persisted files will be checked. Supported values: 
<ul>
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a> reports individual chunk errors. Supported values: 
<ul>
<li><a href="#TRUE"><code>TRUE</code></a> </li>
<li><a href="#FALSE"><code>FALSE</code></a> </li>
</ul>

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/repartitiongraph#repartitionGraph(com.gpudb.protocol.RepartitionGraphRequest)"><code>GPUdb.repartitionGraph</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.RepartitionGraphRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#repartitionGraph(com.gpudb.protocol.RepartitionGraphRequest)"><code>GPUdb.repartitionGraph</code></a>. 

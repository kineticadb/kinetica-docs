...
<div className="inheritance">com.gpudb.protocol.GetRecordsBySeriesRequest.Encoding</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GetRecordsBySeriesRequest" title="class in com.gpudb.protocol"><code>GetRecordsBySeriesRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GetRecordsBySeriesRequest#getEncoding()"><code>encoding</code></a>. 

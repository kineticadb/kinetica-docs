...
<div className="inheritance">com.gpudb.protocol.AggregateUnpivotRequest.Encoding</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateUnpivotRequest" title="class in com.gpudb.protocol"><code>AggregateUnpivotRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AggregateUnpivotRequest#getEncoding()"><code>encoding</code></a>. 

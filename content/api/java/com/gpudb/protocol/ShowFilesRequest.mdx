...
<div className="inheritance">com.gpudb.protocol.ShowFilesRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showfiles#showFiles(com.gpudb.protocol.ShowFilesRequest)"><code>GPUdb.showFiles</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/revokerole#revokeRole(com.gpudb.protocol.RevokeRoleRequest)"><code>GPUdb.revokeRole</code></a>. 

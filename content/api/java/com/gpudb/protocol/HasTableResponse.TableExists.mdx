...
<div className="inheritance">com.gpudb.protocol.HasTableResponse.TableExists</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasTableResponse" title="class in com.gpudb.protocol"><code>HasTableResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/HasTableResponse#getTableExists()"><code>tableExists</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminSendAlert(com.gpudb.protocol.AdminSendAlertRequest)"><code>GPUdb.adminSendAlert</code></a>. 

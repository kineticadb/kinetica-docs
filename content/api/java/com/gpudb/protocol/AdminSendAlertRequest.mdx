---
title: "AdminSendAlertRequest"
description: "AdminSendAlertRequest — Kinetica Java API"
---
...
<h1 title="Class AdminSendAlertRequest" className="title">Class AdminSendAlertRequest</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AdminSendAlertRequest</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AdminSendAlertRequest</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
<div className="block">A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminSendAlert(com.gpudb.protocol.AdminSendAlertRequest)"><code>GPUdb.adminSendAlert</code></a>. <p> Sends a user generated alert to the monitoring system.</p></div>
</div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel" className="type-name-link" title="class in com.gpudb.protocol">AdminSendAlertRequest.LogLevel</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest" title="class in com.gpudb.protocol"><code>AdminSendAlertRequest</code></a> parameter <a href="#getLogLevel()"><code>logLevel</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AdminSendAlertRequest</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AdminSendAlertRequest object with default parameters.</div>
</div>
<div className="col-constructor-name odd-row-color"><code><a href="#%3Cinit%3E(java.lang.String,java.lang.String,java.lang.String,java.util.Map)" className="member-name-link">AdminSendAlertRequest</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;message, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;label, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;logLevel, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</code></div>
<div className="col-last odd-row-color">
<div className="block">Constructs an AdminSendAlertRequest object with the specified parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Label to add to alert message.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getLogLevel()" className="member-name-link">getLogLevel</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Alert message logging criteria.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getMessage()" className="member-name-link">getMessage</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Alert message body.</div>
</div>
...
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest" title="class in com.gpudb.protocol">AdminSendAlertRequest</a></code></div>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest" title="class in com.gpudb.protocol">AdminSendAlertRequest</a></code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setLogLevel(java.lang.String)" className="member-name-link">setLogLevel</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;logLevel)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Alert message logging criteria.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest" title="class in com.gpudb.protocol">AdminSendAlertRequest</a></code></div>
...
<h3>AdminSendAlertRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AdminSendAlertRequest</span>()</div>
<div className="block">Constructs an AdminSendAlertRequest object with default parameters.</div>
</div>
</li>
<li>
...
<h3>AdminSendAlertRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AdminSendAlertRequest</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;message, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;label, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;logLevel, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</span></div>
<div className="block">Constructs an AdminSendAlertRequest object with the specified parameters.</div>
<div className="dl notes">
...
<div className="dd"><code>logLevel</code> - Alert message logging criteria. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#FATAL"><code>FATAL</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#ERROR"><code>ERROR</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#WARN"><code>WARN</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#INFO"><code>INFO</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#DEBUG"><code>DEBUG</code></a> </li></ul></div>
...
<div className="block">Alert message body. The default value is ''.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<h3>setMessage</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest" title="class in com.gpudb.protocol">AdminSendAlertRequest</a></span>&nbsp;<span className="element-name">setMessage</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;message)</span></div>
<div className="block">Alert message body. The default value is ''.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<div className="block">Label to add to alert message. The default value is ''.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<h3>setLabel</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest" title="class in com.gpudb.protocol">AdminSendAlertRequest</a></span>&nbsp;<span className="element-name">setLabel</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;label)</span></div>
<div className="block">Label to add to alert message. The default value is ''.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<li>
<div className="section detail" id="getLogLevel()">
<h3>getLogLevel</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></span>&nbsp;<span className="element-name">getLogLevel</span>()</div>
<div className="block">Alert message logging criteria. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#FATAL"><code>FATAL</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#ERROR"><code>ERROR</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#WARN"><code>WARN</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#INFO"><code>INFO</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#DEBUG"><code>DEBUG</code></a> </li></ul></div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>logLevel</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setLogLevel(java.lang.String)">
<h3>setLogLevel</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest" title="class in com.gpudb.protocol">AdminSendAlertRequest</a></span>&nbsp;<span className="element-name">setLogLevel</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;logLevel)</span></div>
<div className="block">Alert message logging criteria. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#FATAL"><code>FATAL</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#ERROR"><code>ERROR</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#WARN"><code>WARN</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#INFO"><code>INFO</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest.LogLevel#DEBUG"><code>DEBUG</code></a> </li></ul></div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>logLevel</code> - The new value for <code>logLevel</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<h3>setOptions</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminSendAlertRequest" title="class in com.gpudb.protocol">AdminSendAlertRequest</a></span>&nbsp;<span className="element-name">setOptions</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</span></div>
<div className="block">Optional parameters. The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

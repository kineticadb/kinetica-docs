...
<div className="inheritance">com.gpudb.protocol.AdminSendAlertRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminsendalert#adminSendAlert(com.gpudb.protocol.AdminSendAlertRequest)"><code>GPUdb.adminSendAlert</code></a>. 

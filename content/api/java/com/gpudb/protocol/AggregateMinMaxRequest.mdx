...
<div className="inheritance">com.gpudb.protocol.AggregateMinMaxRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/aggregateminmax#aggregateMinMax(com.gpudb.protocol.AggregateMinMaxRequest)"><code>GPUdb.aggregateMinMax</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#aggregateMinMax(com.gpudb.protocol.AggregateMinMaxRequest)"><code>GPUdb.aggregateMinMax</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.ShowSecurityRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showsecurity#showSecurity(com.gpudb.protocol.ShowSecurityRequest)"><code>GPUdb.showSecurity</code></a>. 

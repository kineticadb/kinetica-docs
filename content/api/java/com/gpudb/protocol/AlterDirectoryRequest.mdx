...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#alterDirectory(com.gpudb.protocol.AlterDirectoryRequest)"><code>GPUdb.alterDirectory</code></a>. 

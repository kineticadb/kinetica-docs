...
<div className="inheritance">com.gpudb.protocol.AlterDirectoryRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/alterdirectory#alterDirectory(com.gpudb.protocol.AlterDirectoryRequest)"><code>GPUdb.alterDirectory</code></a>. 

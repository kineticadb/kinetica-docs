...
<div className="inheritance">com.gpudb.protocol.ShowSqlProcRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showsqlproc#showSqlProc(com.gpudb.protocol.ShowSqlProcRequest)"><code>GPUdb.showSqlProc</code></a>. 

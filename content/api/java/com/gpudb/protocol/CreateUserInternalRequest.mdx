...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#createUserInternal(com.gpudb.protocol.CreateUserInternalRequest)"><code>GPUdb.createUserInternal</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.VerifyBackupRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/verifybackup#verifyBackup(com.gpudb.protocol.VerifyBackupRequest)"><code>GPUdb.verifyBackup</code></a>. 
<p> Inspects the requested database <a href="/content/admin/backup_restore/#database-backup" target="_top">backup(s)</a> for conformity at the remote file store accessible via the <a href="/content/concepts/data_sources/" target="_top">data source</a> specified by <a href="#getDatasourceName()"><code>datasourceName</code></a>. By default all snapshots are inspected unless the option <a href="/content/api/java/com/gpudb/protocol/VerifyBackupRequest.Options#BACKUP_ID"><code>BACKUP\_ID</code></a> is used to target a specific instance. Returns backup verification results.</p>
</div>
</div>

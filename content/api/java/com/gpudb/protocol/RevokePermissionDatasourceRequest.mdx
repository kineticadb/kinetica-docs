...
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.RevokePermissionDatasourceRequest</div> </div>
...
<div className="block">A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#revokePermissionDatasource(com.gpudb.protocol.RevokePermissionDatasourceRequest)"><code>GPUdb.revokePermissionDatasource</code></a>. <p> Revokes a <a href="/content/concepts/data_sources/" target="_top">data source</a> permission from a user or role.</p></div>
</div>
...
<div className="dd"><code>permission</code> - Permission to revoke from the user or role. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/RevokePermissionDatasourceRequest.Permission#ADMIN"><code>ADMIN</code></a>: Admin access on the given data source. </li><li><a href="/content/api/java/com/gpudb/protocol/RevokePermissionDatasourceRequest.Permission#CONNECT"><code>CONNECT</code></a>: Connect access on the given data source. </li></ul></div>
...
<div className="block">Permission to revoke from the user or role. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/RevokePermissionDatasourceRequest.Permission#ADMIN"><code>ADMIN</code></a>: Admin access on the given data source. </li><li><a href="/content/api/java/com/gpudb/protocol/RevokePermissionDatasourceRequest.Permission#CONNECT"><code>CONNECT</code></a>: Connect access on the given data source. </li></ul></div>
<div className="dl notes">
<div className="dt">Returns:</div>

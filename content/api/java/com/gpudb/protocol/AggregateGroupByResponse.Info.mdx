...
<div className="inheritance">com.gpudb.protocol.AggregateGroupByResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateGroupByResponse" title="class in com.gpudb.protocol"><code>AggregateGroupByResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AggregateGroupByResponse#getInfo()"><code>info</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.DeleteResourceGroupRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/DeleteResourceGroupRequest" title="class in com.gpudb.protocol"><code>DeleteResourceGroupRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/DeleteResourceGroupRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a>, delete any existing entities owned by this group. Otherwise this request will return an error of any such entities exist. Supported values: 
<ul>

...
<div className="inheritance">com.gpudb.protocol.AdminOfflineRequest.Offline</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest" title="class in com.gpudb.protocol"><code>AdminOfflineRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest#getOffline()"><code>offline</code></a>. 

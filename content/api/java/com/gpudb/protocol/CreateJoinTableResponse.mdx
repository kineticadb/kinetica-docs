...
<div className="inheritance">com.gpudb.protocol.CreateJoinTableResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/CreateJoinTableResponse.Info#QUALIFIED_JOIN_TABLE_NAME"><code>QUALIFIED\_JOIN\_TABLE\_NAME</code></a>: The fully qualified name of the join table (i.e. including the schema). </li>
</ul>

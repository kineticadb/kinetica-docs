...
<div className="inheritance">com.gpudb.protocol.InsertRecordsFromFilesRequest.CreateTableOptions</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/InsertRecordsFromFilesRequest" title="class in com.gpudb.protocol"><code>InsertRecordsFromFilesRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/InsertRecordsFromFilesRequest#getCreateTableOptions()"><code>createTableOptions</code></a>. 
<p> Options from <a href="/content/api/java/com/gpudb/GPUdb/createtable#createTable(com.gpudb.protocol.CreateTableRequest)"><code>GPUdb.createTable</code></a>, allowing the structure of the table to be defined independently of the data source, when creating the target table</p>
</div>
</div>

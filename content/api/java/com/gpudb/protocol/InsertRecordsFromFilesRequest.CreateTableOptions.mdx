...
<p> Options from <a href="/content/api/java/com/gpudb/GPUdb#createTable(com.gpudb.protocol.CreateTableRequest)"><code>GPUdb.createTable</code></a>, allowing the structure of the table to be defined independently of the data source, when creating the target table</p>
</div>
</div>

...
<div className="inheritance">com.gpudb.protocol.CreateCatalogRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/createcatalog#createCatalog(com.gpudb.protocol.CreateCatalogRequest)"><code>GPUdb.createCatalog</code></a>. 

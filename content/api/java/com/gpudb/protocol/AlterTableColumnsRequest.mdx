...
<div className="inheritance">com.gpudb.protocol.AlterTableColumnsRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/altertablecolumns#alterTableColumns(com.gpudb.protocol.AlterTableColumnsRequest)"><code>GPUdb.alterTableColumns</code></a>. 

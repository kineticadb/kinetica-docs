---
title: "ModifyGraphResponse"
description: "ModifyGraphResponse — Kinetica Java API"
---
...
<h1 title="Class ModifyGraphResponse" className="title">Class ModifyGraphResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.ModifyGraphResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">ModifyGraphResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">ModifyGraphResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a ModifyGraphResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getEdgesIds()" className="member-name-link">getEdgesIds</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Edges given as pairs of node indices.</div>
</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getNumEdges()" className="member-name-link">getNumEdges</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getNumNodes()" className="member-name-link">getNumNodes</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates a successful modification on all servers.</div>
</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setEdgesIds(java.util.List)" className="member-name-link">setEdgesIds</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html" title="class or interface in java.lang" className="external-link">Long</a>&gt;&nbsp;edgesIds)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Edges given as pairs of node indices.</div>
</div>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/ModifyGraphResponse" title="class in com.gpudb.protocol">ModifyGraphResponse</a></code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setNumEdges(long)" className="member-name-link">setNumEdges</a><wbr />(long&nbsp;numEdges)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total number of edges in the graph.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/ModifyGraphResponse" title="class in com.gpudb.protocol">ModifyGraphResponse</a></code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setNumNodes(long)" className="member-name-link">setNumNodes</a><wbr />(long&nbsp;numNodes)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total number of nodes in the graph.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/ModifyGraphResponse" title="class in com.gpudb.protocol">ModifyGraphResponse</a></code></div>
...
<h3>ModifyGraphResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">ModifyGraphResponse</span>()</div>
<div className="block">Constructs a ModifyGraphResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setResult</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ModifyGraphResponse" title="class in com.gpudb.protocol">ModifyGraphResponse</a></span>&nbsp;<span className="element-name">setResult</span><wbr /><span className="parameters">(boolean&nbsp;result)</span></div>
<div className="block">Indicates a successful modification on all servers.</div>
<div className="dl notes">
...
<h3>getNumNodes</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">long</span>&nbsp;<span className="element-name">getNumNodes</span>()</div>
<div className="block">Total number of nodes in the graph.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<li>
<div className="section detail" id="setNumNodes(long)">
<h3>setNumNodes</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ModifyGraphResponse" title="class in com.gpudb.protocol">ModifyGraphResponse</a></span>&nbsp;<span className="element-name">setNumNodes</span><wbr /><span className="parameters">(long&nbsp;numNodes)</span></div>
<div className="block">Total number of nodes in the graph.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>getNumEdges</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">long</span>&nbsp;<span className="element-name">getNumEdges</span>()</div>
<div className="block">Total number of edges in the graph.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<li>
<div className="section detail" id="setNumEdges(long)">
<h3>setNumEdges</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ModifyGraphResponse" title="class in com.gpudb.protocol">ModifyGraphResponse</a></span>&nbsp;<span className="element-name">setNumEdges</span><wbr /><span className="parameters">(long&nbsp;numEdges)</span></div>
<div className="block">Total number of edges in the graph.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<li>
<div className="section detail" id="getEdgesIds()">
<h3>getEdgesIds</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html" title="class or interface in java.lang" className="external-link">Long</a>&gt;</span>&nbsp;<span className="element-name">getEdgesIds</span>()</div>
<div className="block">Edges given as pairs of node indices. Only populated if <a href="/content/api/java/com/gpudb/protocol/ModifyGraphRequest.Options#EXPORT_CREATE_RESULTS"><code>EXPORT\_CREATE\_RESULTS</code></a> is set to <a href="/content/api/java/com/gpudb/protocol/ModifyGraphRequest.Options#TRUE"><code>TRUE</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>edgesIds</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setEdgesIds(java.util.List)">
<h3>setEdgesIds</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ModifyGraphResponse" title="class in com.gpudb.protocol">ModifyGraphResponse</a></span>&nbsp;<span className="element-name">setEdgesIds</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html" title="class or interface in java.lang" className="external-link">Long</a>&gt;&nbsp;edgesIds)</span></div>
<div className="block">Edges given as pairs of node indices. Only populated if <a href="/content/api/java/com/gpudb/protocol/ModifyGraphRequest.Options#EXPORT_CREATE_RESULTS"><code>EXPORT\_CREATE\_RESULTS</code></a> is set to <a href="/content/api/java/com/gpudb/protocol/ModifyGraphRequest.Options#TRUE"><code>TRUE</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>edgesIds</code> - The new value for <code>edgesIds</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ModifyGraphResponse" title="class in com.gpudb.protocol">ModifyGraphResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

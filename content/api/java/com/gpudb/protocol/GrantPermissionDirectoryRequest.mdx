...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#grantPermissionDirectory(com.gpudb.protocol.GrantPermissionDirectoryRequest)"><code>GPUdb.grantPermissionDirectory</code></a>. 
<p> \[DEPRECATED--please use <a href="/content/api/java/com/gpudb/GPUdb#grantPermission(com.gpudb.protocol.GrantPermissionRequest)"><code>GPUdb.grantPermission</code></a> instead\] Grants a <a href="/content/tools/kifs/" target="_top">KiFS</a> directory-level permission to a user or role.</p>
</div>
</div>

...
<div className="inheritance">com.gpudb.protocol.GrantPermissionDirectoryRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/grantpermissiondirectory#grantPermissionDirectory(com.gpudb.protocol.GrantPermissionDirectoryRequest)"><code>GPUdb.grantPermissionDirectory</code></a>. 
<p> \[DEPRECATED--please use <a href="/content/api/java/com/gpudb/GPUdb/grantpermission#grantPermission(com.gpudb.protocol.GrantPermissionRequest)"><code>GPUdb.grantPermission</code></a> instead\] Grants a <a href="/content/tools/kifs/" target="_top">KiFS</a> directory-level permission to a user or role.</p>
</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/GrantPermissionDirectoryRequest.Permission#DIRECTORY_READ"><code>DIRECTORY\_READ</code></a>: For files in the directory, access to list files, download files, or use files in server side functions. </li>
<li><a href="/content/api/java/com/gpudb/protocol/GrantPermissionDirectoryRequest.Permission#DIRECTORY_WRITE"><code>DIRECTORY\_WRITE</code></a>: Access to upload files to, or delete files from, the directory. A user or role with write access automatically has read access. </li>
</ul>
</div>

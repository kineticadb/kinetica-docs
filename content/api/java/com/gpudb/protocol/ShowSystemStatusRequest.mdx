...
<div className="inheritance">com.gpudb.protocol.ShowSystemStatusRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showsystemstatus#showSystemStatus(com.gpudb.protocol.ShowSystemStatusRequest)"><code>GPUdb.showSystemStatus</code></a>. 

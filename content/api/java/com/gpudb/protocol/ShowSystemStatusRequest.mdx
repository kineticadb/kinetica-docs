...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#showSystemStatus(com.gpudb.protocol.ShowSystemStatusRequest)"><code>GPUdb.showSystemStatus</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.HasRoleResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse" title="class in com.gpudb.protocol"><code>HasRoleResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse#getInfo()"><code>info</code></a>. 
...
<div className="block">
<a href="#TRUE"><code>TRUE</code></a> when principal is directly a member of the role. Supported values: 
<ul>

...
<div className="inheritance">com.gpudb.protocol.ShowSystemPropertiesRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesRequest" title="class in com.gpudb.protocol"><code>ShowSystemPropertiesRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ShowSystemPropertiesRequest#getOptions()"><code>options</code></a>. 

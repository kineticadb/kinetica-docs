...
<div className="inheritance">com.gpudb.protocol.DropCatalogRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/dropcatalog#dropCatalog(com.gpudb.protocol.DropCatalogRequest)"><code>GPUdb.dropCatalog</code></a>. 

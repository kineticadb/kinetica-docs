...
<div className="inheritance">com.gpudb.protocol.HasPermissionResponse.HasPermission</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse" title="class in com.gpudb.protocol"><code>HasPermissionResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse#getHasPermission()"><code>hasPermission</code></a>. 

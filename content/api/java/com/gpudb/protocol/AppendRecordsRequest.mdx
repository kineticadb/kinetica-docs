...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/appendrecords#appendRecords(com.gpudb.protocol.AppendRecordsRequest)"><code>GPUdb.appendRecords</code></a>. 

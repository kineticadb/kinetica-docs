---
title: "AdminShowClusterOperationsResponse.AddRanks"
description: "AdminShowClusterOperationsResponse.AddRanks — Kinetica Java API"
---
...
<h1 title="Class AdminShowClusterOperationsResponse.AddRanks" className="title">Class AdminShowClusterOperationsResponse.AddRanks</h1>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminShowClusterOperationsResponse.AddRanks.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminShowClusterOperationsResponse.AddRanks.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

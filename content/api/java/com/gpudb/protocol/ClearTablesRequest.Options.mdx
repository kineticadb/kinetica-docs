...
<div className="inheritance">com.gpudb.protocol.ClearTablesRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ClearTablesRequest" title="class in com.gpudb.protocol"><code>ClearTablesRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ClearTablesRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a> and if a table specified in <a href="/content/api/java/com/gpudb/protocol/ClearTablesRequest#getTableNames()"><code>tableNames</code></a> does not exist no error is returned. If <a href="#FALSE"><code>FALSE</code></a> and if a table specified in <a href="/content/api/java/com/gpudb/protocol/ClearTablesRequest#getTableNames()"><code>tableNames</code></a> does not exist then an error is returned. Supported values: 
<ul>

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#showResourceGroups(com.gpudb.protocol.ShowResourceGroupsRequest)"><code>GPUdb.showResourceGroups</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.ShowResourceGroupsRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showresourcegroups#showResourceGroups(com.gpudb.protocol.ShowResourceGroupsRequest)"><code>GPUdb.showResourceGroups</code></a>. 

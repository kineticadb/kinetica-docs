...
<div className="inheritance">com.gpudb.protocol.AdminAddRanksRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminAddRanksRequest" title="class in com.gpudb.protocol"><code>AdminAddRanksRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AdminAddRanksRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a>, only validation checks will be performed. No ranks are added. Supported values: 
<ul>

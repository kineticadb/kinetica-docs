...
<div className="inheritance">com.gpudb.protocol.HasSchemaRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/hasschema#hasSchema(com.gpudb.protocol.HasSchemaRequest)"><code>GPUdb.hasSchema</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.AggregateMinMaxResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse.Info#MIN_STRING"><code>MIN\_STRING</code></a>: The minimum value of <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>, stored as a byte vector. </li>
<li><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse.Info#MAX_STRING"><code>MAX\_STRING</code></a>: The maximum value of <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>, stored as a byte vector. </li>
</ul>

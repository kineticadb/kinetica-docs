---
title: "AggregateMinMaxResponse"
description: "AggregateMinMaxResponse — Kinetica Java API"
---
...
<h1 title="Class AggregateMinMaxResponse" className="title">Class AggregateMinMaxResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AggregateMinMaxResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AggregateMinMaxResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse.Info" className="type-name-link" title="class in com.gpudb.protocol">AggregateMinMaxResponse.Info</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse" title="class in com.gpudb.protocol"><code>AggregateMinMaxResponse</code></a> parameter <a href="#getInfo()"><code>info</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AggregateMinMaxResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AggregateMinMaxResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="block">Maximum value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>.</div>
</div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Minimum value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setMax(double)" className="member-name-link">setMax</a><wbr />(double&nbsp;max)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Maximum value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse" title="class in com.gpudb.protocol">AggregateMinMaxResponse</a></code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setMin(double)" className="member-name-link">setMin</a><wbr />(double&nbsp;min)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Minimum value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>.</div>
</div>
...
<h3>AggregateMinMaxResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AggregateMinMaxResponse</span>()</div>
<div className="block">Constructs an AggregateMinMaxResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setMin</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse" title="class in com.gpudb.protocol">AggregateMinMaxResponse</a></span>&nbsp;<span className="element-name">setMin</span><wbr /><span className="parameters">(double&nbsp;min)</span></div>
<div className="block">Minimum value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>.</div>
<div className="dl notes">
...
<h3>setMax</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse" title="class in com.gpudb.protocol">AggregateMinMaxResponse</a></span>&nbsp;<span className="element-name">setMax</span><wbr /><span className="parameters">(double&nbsp;max)</span></div>
<div className="block">Maximum value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<div className="block">Additional information. <ul> <li><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse.Info#MIN_STRING"><code>MIN\_STRING</code></a>: The minimum value of <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>, stored as a byte vector. </li><li><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse.Info#MAX_STRING"><code>MAX\_STRING</code></a>: The maximum value of <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>, stored as a byte vector. </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse" title="class in com.gpudb.protocol">AggregateMinMaxResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information. <ul> <li><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse.Info#MIN_STRING"><code>MIN\_STRING</code></a>: The minimum value of <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>, stored as a byte vector. </li><li><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxResponse.Info#MAX_STRING"><code>MAX\_STRING</code></a>: The maximum value of <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxRequest#getColumnName()"><code>columnName</code></a>, stored as a byte vector. </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

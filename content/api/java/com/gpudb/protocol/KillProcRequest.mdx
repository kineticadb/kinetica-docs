---
title: "KillProcRequest"
description: "KillProcRequest — Kinetica Java API"
---
...
<h1 title="Class KillProcRequest" className="title">Class KillProcRequest</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.KillProcRequest</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">KillProcRequest</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
<div className="block">A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#killProc(com.gpudb.protocol.KillProcRequest)"><code>GPUdb.killProc</code></a>. <p> Kills a running proc instance.</p></div>
</div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options" className="type-name-link" title="class in com.gpudb.protocol">KillProcRequest.Options</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/KillProcRequest" title="class in com.gpudb.protocol"><code>KillProcRequest</code></a> parameter <a href="#getOptions()"><code>options</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">KillProcRequest</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a KillProcRequest object with default parameters.</div>
</div>
<div className="col-constructor-name odd-row-color"><code><a href="#%3Cinit%3E(java.lang.String,java.util.Map)" className="member-name-link">KillProcRequest</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;runId, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</code></div>
<div className="col-last odd-row-color">
<div className="block">Constructs a KillProcRequest object with the specified parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="block">The run ID of a running proc instance.</div>
</div>
...
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/KillProcRequest" title="class in com.gpudb.protocol">KillProcRequest</a></code></div>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/KillProcRequest" title="class in com.gpudb.protocol">KillProcRequest</a></code></div>
...
<h3>KillProcRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">KillProcRequest</span>()</div>
<div className="block">Constructs a KillProcRequest object with default parameters.</div>
</div>
</li>
<li>
...
<h3>KillProcRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">KillProcRequest</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;runId, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</span></div>
<div className="block">Constructs a KillProcRequest object with the specified parameters.</div>
<div className="dl notes">
...
<div className="dd"><code>options</code> - Optional parameters. <ul> <li><a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#RUN_TAG"><code>RUN\_TAG</code></a>: If <code> runId</code> is specified, kill the proc instance that has a matching run ID and a matching run tag that was provided to <a href="/content/api/java/com/gpudb/GPUdb#executeProc(com.gpudb.protocol.ExecuteProcRequest)"><code>GPUdb.executeProc</code></a>. If <code>runId</code> is not specified, kill the proc instance(s) where a matching run tag was provided to <a href="/content/api/java/com/gpudb/GPUdb#executeProc(com.gpudb.protocol.ExecuteProcRequest)"><code>GPUdb.executeProc</code></a>. The default value is ''. </li><li><a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#CLEAR_EXECUTE_AT_STARTUP"><code>CLEAR\_EXECUTE\_AT\_STARTUP</code></a>: If <a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#TRUE"><code>TRUE</code></a>, kill and remove the instance of the proc matching the auto-start run ID that was created to run when the database is started. The auto-start run ID was returned from <a href="/content/api/java/com/gpudb/GPUdb#executeProc(com.gpudb.protocol.ExecuteProcRequest)"><code>GPUdb.executeProc</code></a> and can be retrieved using <a href="/content/api/java/com/gpudb/GPUdb#showProc(com.gpudb.protocol.ShowProcRequest)"><code>GPUdb.showProc</code></a>. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#FALSE"><code>FALSE</code></a>. </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
</div>
</div>
</li>
</ul>
...
<div className="block">The run ID of a running proc instance. If a proc with a matching run ID is not found or the proc instance has already completed, no procs will be killed. If not specified, all running proc instances will be killed. The default value is ''.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<h3>setRunId</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/KillProcRequest" title="class in com.gpudb.protocol">KillProcRequest</a></span>&nbsp;<span className="element-name">setRunId</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;runId)</span></div>
<div className="block">The run ID of a running proc instance. If a proc with a matching run ID is not found or the proc instance has already completed, no procs will be killed. If not specified, all running proc instances will be killed. The default value is ''.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setOptions</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/KillProcRequest" title="class in com.gpudb.protocol">KillProcRequest</a></span>&nbsp;<span className="element-name">setOptions</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</span></div>
<div className="block">Optional parameters. <ul> <li><a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#RUN_TAG"><code>RUN\_TAG</code></a>: If <a href="#getRunId()"><code>runId</code></a> is specified, kill the proc instance that has a matching run ID and a matching run tag that was provided to <a href="/content/api/java/com/gpudb/GPUdb#executeProc(com.gpudb.protocol.ExecuteProcRequest)"><code>GPUdb.executeProc</code></a>. If <a href="#getRunId()"><code>runId</code></a> is not specified, kill the proc instance(s) where a matching run tag was provided to <a href="/content/api/java/com/gpudb/GPUdb#executeProc(com.gpudb.protocol.ExecuteProcRequest)"><code>GPUdb.executeProc</code></a>. The default value is ''. </li><li><a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#CLEAR_EXECUTE_AT_STARTUP"><code>CLEAR\_EXECUTE\_AT\_STARTUP</code></a>: If <a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#TRUE"><code>TRUE</code></a>, kill and remove the instance of the proc matching the auto-start run ID that was created to run when the database is started. The auto-start run ID was returned from <a href="/content/api/java/com/gpudb/GPUdb#executeProc(com.gpudb.protocol.ExecuteProcRequest)"><code>GPUdb.executeProc</code></a> and can be retrieved using <a href="/content/api/java/com/gpudb/GPUdb#showProc(com.gpudb.protocol.ShowProcRequest)"><code>GPUdb.showProc</code></a>. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#FALSE"><code>FALSE</code></a>. </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

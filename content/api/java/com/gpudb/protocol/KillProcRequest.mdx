...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#killProc(com.gpudb.protocol.KillProcRequest)"><code>GPUdb.killProc</code></a>. 
...
<li>
<a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#CLEAR_EXECUTE_AT_STARTUP"><code>CLEAR\_EXECUTE\_AT\_STARTUP</code></a>: If <a href="/content/api/java/com/gpudb/protocol/KillProcRequest.Options#TRUE"><code>TRUE</code></a>, kill and remove the instance of the proc matching the auto-start run ID that was created to run when the database is started. The auto-start run ID was returned from <a href="/content/api/java/com/gpudb/GPUdb#executeProc(com.gpudb.protocol.ExecuteProcRequest)"><code>GPUdb.executeProc</code></a> and can be retrieved using <a href="/content/api/java/com/gpudb/GPUdb#showProc(com.gpudb.protocol.ShowProcRequest)"><code>GPUdb.showProc</code></a>. Supported values: 
<ul>

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#filterByGeometry(com.gpudb.protocol.FilterByGeometryRequest)"><code>GPUdb.filterByGeometry</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#aggregateHistogram(com.gpudb.protocol.AggregateHistogramRequest)"><code>GPUdb.aggregateHistogram</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.AggregateConvexHullRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/aggregateconvexhull#aggregateConvexHull(com.gpudb.protocol.AggregateConvexHullRequest)"><code>GPUdb.aggregateConvexHull</code></a>. 
<p> Calculates and returns the convex hull for the values in a table specified by <a href="#getTableName()"><code>tableName</code></a>.</p>
</div>
</div>

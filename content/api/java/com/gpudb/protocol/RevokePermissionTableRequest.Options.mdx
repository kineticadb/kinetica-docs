...
<div className="inheritance">com.gpudb.protocol.RevokePermissionTableRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RevokePermissionTableRequest" title="class in com.gpudb.protocol"><code>RevokePermissionTableRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RevokePermissionTableRequest#getOptions()"><code>options</code></a>. 

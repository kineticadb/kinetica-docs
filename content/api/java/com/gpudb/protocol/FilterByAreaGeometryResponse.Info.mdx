...
<div className="inheritance">com.gpudb.protocol.FilterByAreaGeometryResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByAreaGeometryResponse" title="class in com.gpudb.protocol"><code>FilterByAreaGeometryResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByAreaGeometryResponse#getInfo()"><code>info</code></a>. 

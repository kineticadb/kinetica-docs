...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/createvideo#createVideo(com.gpudb.protocol.CreateVideoRequest)"><code>GPUdb.createVideo</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.ClearTablesRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/cleartables#clearTables(com.gpudb.protocol.ClearTablesRequest)"><code>GPUdb.clearTables</code></a>. 
...
<div className="dd"><code>tableNames</code> - Names of the tables to be cleared, in \[schema\_name.\]table\_name format, using standard <a href="/content/concepts/tables/#table-name-resolution" target="_top">name resolution rules</a>. Must be existing tables. Empty list clears all available tables, though this behavior is prevented by default via system configuration parameter <a href="/content/config/#config-main-general" target="_top">disable\_clear\_all</a>. The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link"><code>List</code></a>.</div>
<div className="dd">

...
<div className="inheritance">com.gpudb.protocol.DropDatasourceRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/dropdatasource#dropDatasource(com.gpudb.protocol.DropDatasourceRequest)"><code>GPUdb.dropDatasource</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#dropDatasource(com.gpudb.protocol.DropDatasourceRequest)"><code>GPUdb.dropDatasource</code></a>. 

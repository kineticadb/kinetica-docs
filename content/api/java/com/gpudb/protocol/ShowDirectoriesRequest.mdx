...
<div className="inheritance">com.gpudb.protocol.ShowDirectoriesRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showdirectories#showDirectories(com.gpudb.protocol.ShowDirectoriesRequest)"><code>GPUdb.showDirectories</code></a>. 

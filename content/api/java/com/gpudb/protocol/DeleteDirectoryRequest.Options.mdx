...
<div className="inheritance">com.gpudb.protocol.DeleteDirectoryRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/DeleteDirectoryRequest" title="class in com.gpudb.protocol"><code>DeleteDirectoryRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/DeleteDirectoryRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a>, will delete directory and all files residing in it. If false, directory must be empty for deletion. Supported values: 
<ul>
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a>, no error is returned if specified directory does not exist. Supported values: 
<ul>
<li><a href="#TRUE"><code>TRUE</code></a> </li>
<li><a href="#FALSE"><code>FALSE</code></a> </li>
</ul>

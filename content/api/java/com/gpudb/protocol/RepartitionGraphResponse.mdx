---
title: "RepartitionGraphResponse"
description: "RepartitionGraphResponse — Kinetica Java API"
---
...
<h1 title="Class RepartitionGraphResponse" className="title">Class RepartitionGraphResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.RepartitionGraphResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">RepartitionGraphResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">RepartitionGraphResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a RepartitionGraphResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="block">Indicates a successful rebalancing on all servers.</div>
</div>
...
<h3>RepartitionGraphResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">RepartitionGraphResponse</span>()</div>
<div className="block">Constructs a RepartitionGraphResponse object with default parameters.</div>
</div>
</li>
</ul>

...
<div className="block">A source record that cannot be appended (e.g.&nbsp;a primary-key collision) raises an error.</div>
</div>
...
<div className="col-last even-row-color">
<div className="block">Specifies how record errors are handled while appending source table records into the target table.</div>
</div>
<div className="col-first odd-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
...
<div className="col-last odd-row-color">
<div className="block">Source records that cannot be appended (e.g.&nbsp;a primary-key collision) are skipped and reported; the rest of the batch is appended.</div>
</div>
<div className="col-first even-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
...
<div className="col-last even-row-color">
<div className="block">Source records that cannot be appended are skipped and reported; the rest of the batch is appended.</div>
</div>
<div className="col-first odd-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
...
<div className="block">
Specifies how record errors are handled while appending source table records into the target table. Currently this governs primary-key collision behavior: <a href="#SKIP"><code>SKIP</code></a> and <a href="#PERMISSIVE"><code>PERMISSIVE</code></a> drop the colliding source records and continue, while <a href="#ABORT"><code>ABORT</code></a> rejects the batch. Explicit <a href="#UPDATE_ON_EXISTING_PK"><code>UPDATE\_ON\_EXISTING\_PK</code></a> or <a href="#IGNORE_EXISTING_PK"><code>IGNORE\_EXISTING\_PK</code></a> take precedence over this option. Supported values: 
<ul>
<li><a href="#PERMISSIVE"><code>PERMISSIVE</code></a>: Source records that cannot be appended (e.g. a primary-key collision) are skipped and reported; the rest of the batch is appended. </li>
<li><a href="#SKIP"><code>SKIP</code></a>: Source records that cannot be appended are skipped and reported; the rest of the batch is appended. </li>
<li><a href="#ABORT"><code>ABORT</code></a>: A source record that cannot be appended (e.g. a primary-key collision) raises an error. This is the default. </li>
</ul>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AppendRecordsRequest.Options.ERROR_HANDLING">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AppendRecordsRequest.Options.PERMISSIVE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AppendRecordsRequest.Options.SKIP">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="block">A source record that cannot be appended (e.g.&nbsp;a primary-key collision) raises an error. This is the default.</div>
<div className="dl notes">
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AppendRecordsRequest.Options.ABORT">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

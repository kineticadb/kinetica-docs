---
title: "SolveGraphResponse"
description: "SolveGraphResponse — Kinetica Java API"
---
...
<h1 title="Class SolveGraphResponse" className="title">Class SolveGraphResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.SolveGraphResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">SolveGraphResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">SolveGraphResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a SolveGraphResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="block">Indicates a successful solution on all servers.</div>
</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getResultPerDestinationNode()" className="member-name-link">getResultPerDestinationNode</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Cost or page rank (based on solver type) for each destination node requested.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setResult(boolean)" className="member-name-link">setResult</a><wbr />(boolean&nbsp;result)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates a successful solution on all servers.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/SolveGraphResponse" title="class in com.gpudb.protocol">SolveGraphResponse</a></code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setResultPerDestinationNode(java.util.List)" className="member-name-link">setResultPerDestinationNode</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Float.html" title="class or interface in java.lang" className="external-link">Float</a>&gt;&nbsp;resultPerDestinationNode)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Cost or page rank (based on solver type) for each destination node requested.</div>
</div>
...
<h3>SolveGraphResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">SolveGraphResponse</span>()</div>
<div className="block">Constructs a SolveGraphResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<li>
<div className="section detail" id="getResultPerDestinationNode()">
<h3>getResultPerDestinationNode</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Float.html" title="class or interface in java.lang" className="external-link">Float</a>&gt;</span>&nbsp;<span className="element-name">getResultPerDestinationNode</span>()</div>
<div className="block">Cost or page rank (based on solver type) for each destination node requested. Only populated if 'export\_solve\_results' option is set to true.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>resultPerDestinationNode</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setResultPerDestinationNode(java.util.List)">
<h3>setResultPerDestinationNode</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/SolveGraphResponse" title="class in com.gpudb.protocol">SolveGraphResponse</a></span>&nbsp;<span className="element-name">setResultPerDestinationNode</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Float.html" title="class or interface in java.lang" className="external-link">Float</a>&gt;&nbsp;resultPerDestinationNode)</span></div>
<div className="block">Cost or page rank (based on solver type) for each destination node requested. Only populated if 'export\_solve\_results' option is set to true.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>resultPerDestinationNode</code> - The new value for <code> resultPerDestinationNode</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>

---
title: "AlterBackupResponse"
description: "AlterBackupResponse — Kinetica Java API"
---
...
<h1 title="Class AlterBackupResponse" className="title">Class AlterBackupResponse</h1>
</div>
...
<div className="inheritance">com.gpudb.protocol.AlterBackupResponse</div>
</div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AlterBackupResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AlterBackupResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AlterBackupResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="block">ID of the snapshot affected by the alter operation, if any.</div>
</div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/AlterBackupRequest#getBackupName()"><code>backupName</code></a>.</div>
</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getTotalBytes()" className="member-name-link">getTotalBytes</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total size of files affected by the alter operation.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>long</code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getTotalFiles()" className="member-name-link">getTotalFiles</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total number of files affected by the alter operation.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>long</code></div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total number of records affected by the alter operation.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setBackupId(long)" className="member-name-link">setBackupId</a><wbr />(long&nbsp;backupId)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">ID of the snapshot affected by the alter operation, if any.</div>
</div>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AlterBackupResponse" title="class in com.gpudb.protocol">AlterBackupResponse</a></code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setTotalBytes(long)" className="member-name-link">setTotalBytes</a><wbr />(long&nbsp;totalBytes)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total size of files affected by the alter operation.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AlterBackupResponse" title="class in com.gpudb.protocol">AlterBackupResponse</a></code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setTotalFiles(long)" className="member-name-link">setTotalFiles</a><wbr />(long&nbsp;totalFiles)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total number of files affected by the alter operation.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AlterBackupResponse" title="class in com.gpudb.protocol">AlterBackupResponse</a></code></div>
...
<h3>AlterBackupResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AlterBackupResponse</span>()</div>
<div className="block">Constructs an AlterBackupResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setBackupName</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterBackupResponse" title="class in com.gpudb.protocol">AlterBackupResponse</a></span>&nbsp;<span className="element-name">setBackupName</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;backupName)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/AlterBackupRequest#getBackupName()"><code>backupName</code></a>.</div>
<div className="dl notes">
...
<h3>setBackupId</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterBackupResponse" title="class in com.gpudb.protocol">AlterBackupResponse</a></span>&nbsp;<span className="element-name">setBackupId</span><wbr /><span className="parameters">(long&nbsp;backupId)</span></div>
<div className="block">ID of the snapshot affected by the alter operation, if any.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<li>
<div className="section detail" id="getTotalBytes()">
<h3>getTotalBytes</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">long</span>&nbsp;<span className="element-name">getTotalBytes</span>()</div>
<div className="block">Total size of files affected by the alter operation.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>totalBytes</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setTotalBytes(long)">
<h3>setTotalBytes</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterBackupResponse" title="class in com.gpudb.protocol">AlterBackupResponse</a></span>&nbsp;<span className="element-name">setTotalBytes</span><wbr /><span className="parameters">(long&nbsp;totalBytes)</span></div>
<div className="block">Total size of files affected by the alter operation.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>totalBytes</code> - The new value for <code>totalBytes</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<li>
<div className="section detail" id="getTotalFiles()">
<h3>getTotalFiles</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">long</span>&nbsp;<span className="element-name">getTotalFiles</span>()</div>
<div className="block">Total number of files affected by the alter operation.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>totalFiles</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setTotalFiles(long)">
<h3>setTotalFiles</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterBackupResponse" title="class in com.gpudb.protocol">AlterBackupResponse</a></span>&nbsp;<span className="element-name">setTotalFiles</span><wbr /><span className="parameters">(long&nbsp;totalFiles)</span></div>
<div className="block">Total number of files affected by the alter operation.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>totalFiles</code> - The new value for <code>totalFiles</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterBackupResponse" title="class in com.gpudb.protocol">AlterBackupResponse</a></span>&nbsp;<span className="element-name">setTotalNumberOfRecords</span><wbr /><span className="parameters">(long&nbsp;totalNumberOfRecords)</span></div>
<div className="block">Total number of records affected by the alter operation.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterBackupResponse" title="class in com.gpudb.protocol">AlterBackupResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

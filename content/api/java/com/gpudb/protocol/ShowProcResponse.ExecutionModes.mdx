...
<div className="inheritance">com.gpudb.protocol.ShowProcResponse.ExecutionModes</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowProcResponse" title="class in com.gpudb.protocol"><code>ShowProcResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ShowProcResponse#getExecutionModes()"><code>executionModes</code></a>. 
<p> The execution modes of the procs named in <a href="/content/api/java/com/gpudb/protocol/ShowProcResponse#getProcNames()"><code>procNames</code></a>.</p>
</div>
</div>

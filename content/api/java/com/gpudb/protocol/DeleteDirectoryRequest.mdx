...
<div className="inheritance">com.gpudb.protocol.DeleteDirectoryRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/deletedirectory#deleteDirectory(com.gpudb.protocol.DeleteDirectoryRequest)"><code>GPUdb.deleteDirectory</code></a>. 

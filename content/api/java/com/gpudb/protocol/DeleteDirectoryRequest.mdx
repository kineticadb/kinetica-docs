...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#deleteDirectory(com.gpudb.protocol.DeleteDirectoryRequest)"><code>GPUdb.deleteDirectory</code></a>. 

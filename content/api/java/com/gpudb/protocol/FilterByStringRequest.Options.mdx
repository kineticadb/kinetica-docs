...
<div className="inheritance">com.gpudb.protocol.FilterByStringRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByStringRequest" title="class in com.gpudb.protocol"><code>FilterByStringRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByStringRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#FALSE"><code>FALSE</code></a> then string filtering will ignore case. Does not apply to <a href="/content/api/java/com/gpudb/protocol/FilterByStringRequest.Mode#SEARCH"><code>SEARCH</code></a> mode. Supported values: 
<ul>
<li><a href="#TRUE"><code>TRUE</code></a> </li>
<li><a href="#FALSE"><code>FALSE</code></a> </li>
</ul>

...
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.RawGetRecordsFromCollectionResponse</div> </div>
...
<div className="block">Additional information. <ul> <li><a href="/content/api/java/com/gpudb/protocol/RawGetRecordsFromCollectionResponse.Info#TOTAL_NUMBER_OF_RECORDS"><code>TOTAL\_NUMBER\_OF\_RECORDS</code></a>: Total number of records. </li><li><a href="/content/api/java/com/gpudb/protocol/RawGetRecordsFromCollectionResponse.Info#HAS_MORE_RECORDS"><code>HAS\_MORE\_RECORDS</code></a>: Too many records. Returned a partial set. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/RawGetRecordsFromCollectionResponse.Info#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/RawGetRecordsFromCollectionResponse.Info#FALSE"><code>FALSE</code></a> </li></ul> </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>

---
title: "AdminAddRanksResponse"
description: "AdminAddRanksResponse — Kinetica Java API"
---
...
<h1 title="Class AdminAddRanksResponse" className="title">Class AdminAddRanksResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AdminAddRanksResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AdminAddRanksResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AdminAddRanksResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AdminAddRanksResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getAddedRanks()" className="member-name-link">getAddedRanks</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">The number assigned to each added rank, formatted as 'rankN', in the same order as the ranks in <a href="/content/api/java/com/gpudb/protocol/AdminAddRanksRequest#getHosts()"><code>hosts</code></a> and <a href="/content/api/java/com/gpudb/protocol/AdminAddRanksRequest#getConfigParams()"><code>configParams</code></a>.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setAddedRanks(java.util.List)" className="member-name-link">setAddedRanks</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;addedRanks)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">The number assigned to each added rank, formatted as 'rankN', in the same order as the ranks in <a href="/content/api/java/com/gpudb/protocol/AdminAddRanksRequest#getHosts()"><code>hosts</code></a> and <a href="/content/api/java/com/gpudb/protocol/AdminAddRanksRequest#getConfigParams()"><code>configParams</code></a>.</div>
</div>
...
<h3>AdminAddRanksResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AdminAddRanksResponse</span>()</div>
<div className="block">Constructs an AdminAddRanksResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<li>
<div className="section detail" id="getAddedRanks()">
<h3>getAddedRanks</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;</span>&nbsp;<span className="element-name">getAddedRanks</span>()</div>
<div className="block">The number assigned to each added rank, formatted as 'rankN', in the same order as the ranks in <a href="/content/api/java/com/gpudb/protocol/AdminAddRanksRequest#getHosts()"><code>hosts</code></a> and <a href="/content/api/java/com/gpudb/protocol/AdminAddRanksRequest#getConfigParams()"><code>configParams</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>addedRanks</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setAddedRanks(java.util.List)">
<h3>setAddedRanks</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminAddRanksResponse" title="class in com.gpudb.protocol">AdminAddRanksResponse</a></span>&nbsp;<span className="element-name">setAddedRanks</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;addedRanks)</span></div>
<div className="block">The number assigned to each added rank, formatted as 'rankN', in the same order as the ranks in <a href="/content/api/java/com/gpudb/protocol/AdminAddRanksRequest#getHosts()"><code>hosts</code></a> and <a href="/content/api/java/com/gpudb/protocol/AdminAddRanksRequest#getConfigParams()"><code>configParams</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>addedRanks</code> - The new value for <code>addedRanks</code>.</div>
<div className="dt">Returns:</div>

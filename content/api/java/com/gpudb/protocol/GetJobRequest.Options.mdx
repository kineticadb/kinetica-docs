...
<div className="inheritance">com.gpudb.protocol.GetJobRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GetJobRequest" title="class in com.gpudb.protocol"><code>GetJobRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GetJobRequest#getOptions()"><code>options</code></a>. 

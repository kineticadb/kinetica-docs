...
<div className="inheritance">com.gpudb.protocol.GrantPermissionProcRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/grantpermissionproc#grantPermissionProc(com.gpudb.protocol.GrantPermissionProcRequest)"><code>GPUdb.grantPermissionProc</code></a>. 
<p> \[DEPRECATED--please use <a href="/content/api/java/com/gpudb/GPUdb/grantpermission#grantPermission(com.gpudb.protocol.GrantPermissionRequest)"><code>GPUdb.grantPermission</code></a> instead\] Grants a proc-level permission to a user or role.</p>
</div>
</div>

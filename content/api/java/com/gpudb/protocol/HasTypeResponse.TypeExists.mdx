...
<div className="inheritance">com.gpudb.protocol.HasTypeResponse.TypeExists</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasTypeResponse" title="class in com.gpudb.protocol"><code>HasTypeResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/HasTypeResponse#getTypeExists()"><code>typeExists</code></a>. 

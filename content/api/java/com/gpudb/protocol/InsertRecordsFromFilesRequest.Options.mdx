...
<div className="inheritance">com.gpudb.protocol.InsertRecordsFromFilesRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/InsertRecordsFromFilesRequest" title="class in com.gpudb.protocol"><code>InsertRecordsFromFilesRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/InsertRecordsFromFilesRequest#getOptions()"><code>options</code></a>. 
...
<div className="col-first even-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
<div className="col-second even-row-color"><code><a href="#SKIP" className="member-name-link">SKIP</a></code></div>
<div className="col-last even-row-color">
...
<div className="col-first odd-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
<div className="col-second odd-row-color"><code><a href="#START_OFFSETS" className="member-name-link">START\_OFFSETS</a></code></div>
<div className="col-last odd-row-color">
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.InsertRecordsFromFilesRequest.Options.AVRO_SCHEMA">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.InsertRecordsFromFilesRequest.Options.AVRO_SCHEMA_NO_INFERENCE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.InsertRecordsFromFilesRequest.Options.SKIP">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="block">Number of tasks for reading file per rank. Default will be system configuration parameter, <a href="/content/config/#config-main-external-files" target="_top">external\_file\_reader\_num\_tasks</a>.</div>
<div className="dl notes">
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.InsertRecordsFromFilesRequest.Options.PK_CONFLICT_PREDICATE_HIGHER">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.InsertRecordsFromFilesRequest.Options.PK_CONFLICT_PREDICATE_LOWER">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="block">
If set to <a href="#TRUE"><code>TRUE</code></a>, truncates the table specified by <a href="/content/api/java/com/gpudb/protocol/InsertRecordsFromFilesRequest#getTableName()"><code>tableName</code></a> prior to loading the file(s). Supported values: 
<ul>
<li><a href="#TRUE"><code>TRUE</code></a> </li>
<li><a href="#FALSE"><code>FALSE</code></a> </li>
</ul>

...
<div className="inheritance">com.gpudb.protocol.RevokePermissionCredentialRequest.Permission</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RevokePermissionCredentialRequest" title="class in com.gpudb.protocol"><code>RevokePermissionCredentialRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RevokePermissionCredentialRequest#getPermission()"><code>permission</code></a>. 

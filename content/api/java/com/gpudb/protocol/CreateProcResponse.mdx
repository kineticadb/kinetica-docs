---
title: "CreateProcResponse"
description: "CreateProcResponse — Kinetica Java API"
---
...
<h1 title="Class CreateProcResponse" className="title">Class CreateProcResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.CreateProcResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">CreateProcResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">CreateProcResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a CreateProcResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/CreateProcRequest#getProcName()"><code>procName</code></a>.</div>
</div>
...
<h3>CreateProcResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">CreateProcResponse</span>()</div>
<div className="block">Constructs a CreateProcResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setProcName</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/CreateProcResponse" title="class in com.gpudb.protocol">CreateProcResponse</a></span>&nbsp;<span className="element-name">setProcName</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;procName)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/CreateProcRequest#getProcName()"><code>procName</code></a>.</div>
<div className="dl notes">
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/CreateProcResponse" title="class in com.gpudb.protocol">CreateProcResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

...
<div className="inheritance">com.gpudb.protocol.AlterRoleRequest.Action</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AlterRoleRequest" title="class in com.gpudb.protocol"><code>AlterRoleRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AlterRoleRequest#getAction()"><code>action</code></a>. 

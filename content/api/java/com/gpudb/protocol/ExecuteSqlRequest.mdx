...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/executesql#executeSql(com.gpudb.protocol.ExecuteSqlRequest)"><code>GPUdb.executeSql</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.CreateJobResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateJobResponse" title="class in com.gpudb.protocol"><code>CreateJobResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateJobResponse#getInfo()"><code>info</code></a>. 

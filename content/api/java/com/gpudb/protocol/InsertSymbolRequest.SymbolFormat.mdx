...
<div className="inheritance">com.gpudb.protocol.InsertSymbolRequest.SymbolFormat</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/InsertSymbolRequest" title="class in com.gpudb.protocol"><code>InsertSymbolRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/InsertSymbolRequest#getSymbolFormat()"><code>symbolFormat</code></a>. 

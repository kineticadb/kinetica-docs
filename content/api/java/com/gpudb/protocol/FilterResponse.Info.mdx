...
<div className="inheritance">com.gpudb.protocol.FilterResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterResponse" title="class in com.gpudb.protocol"><code>FilterResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterResponse#getInfo()"><code>info</code></a>. 

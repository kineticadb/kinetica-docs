...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#getRecordsBySeries(com.gpudb.protocol.GetRecordsBySeriesRequest)"><code>GPUdb.getRecordsBySeries</code></a>. 

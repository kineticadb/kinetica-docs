...
<div className="inheritance">com.gpudb.protocol.FilterBySeriesResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/FilterBySeriesResponse.Info#QUALIFIED_VIEW_NAME"><code>QUALIFIED\_VIEW\_NAME</code></a>: The fully qualified name of the view (i.e. including the schema). </li>
</ul>

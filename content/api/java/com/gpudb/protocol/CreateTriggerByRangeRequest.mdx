...
<div className="inheritance">com.gpudb.protocol.CreateTriggerByRangeRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/createtriggerbyrange#createTriggerByRange(com.gpudb.protocol.CreateTriggerByRangeRequest)"><code>GPUdb.createTriggerByRange</code></a>. 

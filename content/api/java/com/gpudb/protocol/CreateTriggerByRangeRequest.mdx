...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#createTriggerByRange(com.gpudb.protocol.CreateTriggerByRangeRequest)"><code>GPUdb.createTriggerByRange</code></a>. 

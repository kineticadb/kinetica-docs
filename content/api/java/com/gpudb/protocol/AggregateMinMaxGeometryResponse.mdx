---
title: "AggregateMinMaxGeometryResponse"
description: "AggregateMinMaxGeometryResponse — Kinetica Java API"
---
...
<h1 title="Class AggregateMinMaxGeometryResponse" className="title">Class AggregateMinMaxGeometryResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AggregateMinMaxGeometryResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AggregateMinMaxGeometryResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AggregateMinMaxGeometryResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AggregateMinMaxGeometryResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="block">Maximum x-coordinate value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryRequest#getColumnName()"><code>columnName</code></a>.</div>
</div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Maximum y-coordinate value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryRequest#getColumnName()"><code>columnName</code></a>.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>double</code></div>
...
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Minimum x-coordinate value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryRequest#getColumnName()"><code>columnName</code></a>.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>double</code></div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Minimum y-coordinate value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryRequest#getColumnName()"><code>columnName</code></a>.</div>
</div>
...
<h3>AggregateMinMaxGeometryResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AggregateMinMaxGeometryResponse</span>()</div>
<div className="block">Constructs an AggregateMinMaxGeometryResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setMinX</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryResponse" title="class in com.gpudb.protocol">AggregateMinMaxGeometryResponse</a></span>&nbsp;<span className="element-name">setMinX</span><wbr /><span className="parameters">(double&nbsp;minX)</span></div>
<div className="block">Minimum x-coordinate value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryRequest#getColumnName()"><code>columnName</code></a>.</div>
<div className="dl notes">
...
<h3>setMaxX</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryResponse" title="class in com.gpudb.protocol">AggregateMinMaxGeometryResponse</a></span>&nbsp;<span className="element-name">setMaxX</span><wbr /><span className="parameters">(double&nbsp;maxX)</span></div>
<div className="block">Maximum x-coordinate value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryRequest#getColumnName()"><code>columnName</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setMinY</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryResponse" title="class in com.gpudb.protocol">AggregateMinMaxGeometryResponse</a></span>&nbsp;<span className="element-name">setMinY</span><wbr /><span className="parameters">(double&nbsp;minY)</span></div>
<div className="block">Minimum y-coordinate value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryRequest#getColumnName()"><code>columnName</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setMaxY</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryResponse" title="class in com.gpudb.protocol">AggregateMinMaxGeometryResponse</a></span>&nbsp;<span className="element-name">setMaxY</span><wbr /><span className="parameters">(double&nbsp;maxY)</span></div>
<div className="block">Maximum y-coordinate value of the <a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryRequest#getColumnName()"><code>columnName</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateMinMaxGeometryResponse" title="class in com.gpudb.protocol">AggregateMinMaxGeometryResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

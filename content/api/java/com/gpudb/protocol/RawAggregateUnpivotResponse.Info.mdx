...
<div className="inheritance">com.gpudb.protocol.RawAggregateUnpivotResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RawAggregateUnpivotResponse" title="class in com.gpudb.protocol"><code>RawAggregateUnpivotResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RawAggregateUnpivotResponse#getInfo()"><code>info</code></a>. 

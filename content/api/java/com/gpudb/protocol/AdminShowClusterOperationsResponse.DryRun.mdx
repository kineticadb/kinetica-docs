---
title: "AdminShowClusterOperationsResponse.DryRun"
description: "AdminShowClusterOperationsResponse.DryRun — Kinetica Java API"
---
...
<h1 title="Class AdminShowClusterOperationsResponse.DryRun" className="title">Class AdminShowClusterOperationsResponse.DryRun</h1>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminShowClusterOperationsResponse.DryRun.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminShowClusterOperationsResponse.DryRun.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

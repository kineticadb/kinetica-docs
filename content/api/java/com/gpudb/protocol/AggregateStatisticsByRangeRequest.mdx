...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#aggregateStatisticsByRange(com.gpudb.protocol.AggregateStatisticsByRangeRequest)"><code>GPUdb.aggregateStatisticsByRange</code></a>. 

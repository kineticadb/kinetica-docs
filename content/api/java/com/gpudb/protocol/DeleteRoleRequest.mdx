...
<div className="inheritance">com.gpudb.protocol.DeleteRoleRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/deleterole#deleteRole(com.gpudb.protocol.DeleteRoleRequest)"><code>GPUdb.deleteRole</code></a>. 

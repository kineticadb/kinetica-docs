...
<li><a href="/content/api/java/com/gpudb/protocol/RawInsertRecordsRequest.Options#ABORT"><code>ABORT</code></a>: Stops the insertion and rejects the entire batch when any record is incorrect. </li>
</ul>

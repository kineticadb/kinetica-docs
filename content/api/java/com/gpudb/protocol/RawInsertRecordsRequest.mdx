...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#insertRecordsRaw(com.gpudb.protocol.RawInsertRecordsRequest)"><code>GPUdb.insertRecordsRaw</code></a>. 

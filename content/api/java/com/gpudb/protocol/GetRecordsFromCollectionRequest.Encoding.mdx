...
<div className="inheritance">com.gpudb.protocol.GetRecordsFromCollectionRequest.Encoding</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GetRecordsFromCollectionRequest" title="class in com.gpudb.protocol"><code>GetRecordsFromCollectionRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GetRecordsFromCollectionRequest#getEncoding()"><code>encoding</code></a>. 
<p> Specifies the encoding for returned records; either <a href="#BINARY"><code>BINARY</code></a> or <a href="#JSON"><code>JSON</code></a>.</p>
</div>
</div>

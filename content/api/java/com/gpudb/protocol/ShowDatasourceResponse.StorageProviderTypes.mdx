...
<div className="inheritance">com.gpudb.protocol.ShowDatasourceResponse.StorageProviderTypes</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowDatasourceResponse" title="class in com.gpudb.protocol"><code>ShowDatasourceResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ShowDatasourceResponse#getStorageProviderTypes()"><code>storageProviderTypes</code></a>. 
<p> The storage provider type of the data sources named in <a href="/content/api/java/com/gpudb/protocol/ShowDatasourceResponse#getDatasourceNames()"><code>datasourceNames</code></a>.</p>
</div>
</div>

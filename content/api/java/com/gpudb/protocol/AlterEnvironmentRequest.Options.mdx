---
title: "AlterEnvironmentRequest.Options"
description: "AlterEnvironmentRequest.Options — Kinetica Java API"
---
...
<h1 title="Class AlterEnvironmentRequest.Options" className="title">Class AlterEnvironmentRequest.Options</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AlterEnvironmentRequest.Options</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">AlterEnvironmentRequest.Options</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
...
<div className="block">Name of an existing external data source from which packages specified in <a href="/content/api/java/com/gpudb/protocol/AlterEnvironmentRequest#getValue()"><code>value</code></a> can be loaded.</div>
</div>
</div>
</div>
</li>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AlterEnvironmentRequest.Options.DATASOURCE_NAME">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

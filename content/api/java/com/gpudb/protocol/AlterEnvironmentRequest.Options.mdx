...
<div className="inheritance">com.gpudb.protocol.AlterEnvironmentRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AlterEnvironmentRequest" title="class in com.gpudb.protocol"><code>AlterEnvironmentRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AlterEnvironmentRequest#getOptions()"><code>options</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.CreateTypeRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateTypeRequest" title="class in com.gpudb.protocol"><code>CreateTypeRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateTypeRequest#getOptions()"><code>options</code></a>. 

---
title: "AdminShowClusterOperationsResponse.RemoveRanks"
description: "AdminShowClusterOperationsResponse.RemoveRanks — Kinetica Java API"
---
...
<h1 title="Class AdminShowClusterOperationsResponse.RemoveRanks" className="title">Class AdminShowClusterOperationsResponse.RemoveRanks</h1>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminShowClusterOperationsResponse.RemoveRanks.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminShowClusterOperationsResponse.RemoveRanks.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

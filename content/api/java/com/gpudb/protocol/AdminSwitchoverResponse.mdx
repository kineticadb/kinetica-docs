---
title: "AdminSwitchoverResponse"
description: "AdminSwitchoverResponse — Kinetica Java API"
---
...
<h1 title="Class AdminSwitchoverResponse" className="title">Class AdminSwitchoverResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AdminSwitchoverResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AdminSwitchoverResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AdminSwitchoverResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AdminSwitchoverResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<h3>AdminSwitchoverResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AdminSwitchoverResponse</span>()</div>
<div className="block">Constructs an AdminSwitchoverResponse object with default parameters.</div>
</div>
</li>
</ul>

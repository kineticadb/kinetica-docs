...
<div className="inheritance">com.gpudb.protocol.HasTypeRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/hastype#hasType(com.gpudb.protocol.HasTypeRequest)"><code>GPUdb.hasType</code></a>. 
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Id of the type returned in response to <a href="/content/api/java/com/gpudb/GPUdb/createtype#createType(com.gpudb.protocol.CreateTypeRequest)"><code>GPUdb.createType</code></a> request.</div>
</div>
...
<div className="dd"><code>typeId</code> - Id of the type returned in response to <a href="/content/api/java/com/gpudb/GPUdb/createtype#createType(com.gpudb.protocol.CreateTypeRequest)"><code>GPUdb.createType</code></a> request.</div>

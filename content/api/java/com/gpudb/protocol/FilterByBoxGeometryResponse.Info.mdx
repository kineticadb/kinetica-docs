...
<div className="inheritance">com.gpudb.protocol.FilterByBoxGeometryResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByBoxGeometryResponse" title="class in com.gpudb.protocol"><code>FilterByBoxGeometryResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByBoxGeometryResponse#getInfo()"><code>info</code></a>. 

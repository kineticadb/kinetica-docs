---
title: "HasTableResponse"
description: "HasTableResponse — Kinetica Java API"
---
...
<h1 title="Class HasTableResponse" className="title">Class HasTableResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.HasTableResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">HasTableResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/HasTableResponse.TableExists" className="type-name-link" title="class in com.gpudb.protocol">HasTableResponse.TableExists</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasTableResponse" title="class in com.gpudb.protocol"><code>HasTableResponse</code></a> parameter <a href="#getTableExists()"><code>tableExists</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">HasTableResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a HasTableResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getTableExists()" className="member-name-link">getTableExists</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates whether the table exists or not.</div>
</div>
...
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/HasTableRequest#getTableName()"><code>tableName</code></a>.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setTableExists(boolean)" className="member-name-link">setTableExists</a><wbr />(boolean&nbsp;tableExists)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates whether the table exists or not.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/HasTableResponse" title="class in com.gpudb.protocol">HasTableResponse</a></code></div>
...
<h3>HasTableResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">HasTableResponse</span>()</div>
<div className="block">Constructs a HasTableResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setTableName</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasTableResponse" title="class in com.gpudb.protocol">HasTableResponse</a></span>&nbsp;<span className="element-name">setTableName</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;tableName)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/HasTableRequest#getTableName()"><code>tableName</code></a>.</div>
<div className="dl notes">
...
<li>
<div className="section detail" id="getTableExists()">
<h3>getTableExists</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">boolean</span>&nbsp;<span className="element-name">getTableExists</span>()</div>
<div className="block">Indicates whether the table exists or not. Supported values: <ul> <li><code>true</code> </li><li><code>false</code> </li></ul></div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>tableExists</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setTableExists(boolean)">
<h3>setTableExists</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasTableResponse" title="class in com.gpudb.protocol">HasTableResponse</a></span>&nbsp;<span className="element-name">setTableExists</span><wbr /><span className="parameters">(boolean&nbsp;tableExists)</span></div>
<div className="block">Indicates whether the table exists or not. Supported values: <ul> <li><code>true</code> </li><li><code>false</code> </li></ul></div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>tableExists</code> - The new value for <code>tableExists</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasTableResponse" title="class in com.gpudb.protocol">HasTableResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

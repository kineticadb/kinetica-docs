...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#createEnvironment(com.gpudb.protocol.CreateEnvironmentRequest)"><code>GPUdb.createEnvironment</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.CreateEnvironmentRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/createenvironment#createEnvironment(com.gpudb.protocol.CreateEnvironmentRequest)"><code>GPUdb.createEnvironment</code></a>. 

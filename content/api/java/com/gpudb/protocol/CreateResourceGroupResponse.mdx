---
title: "CreateResourceGroupResponse"
description: "CreateResourceGroupResponse — Kinetica Java API"
---
...
<h1 title="Class CreateResourceGroupResponse" className="title">Class CreateResourceGroupResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.CreateResourceGroupResponse</div> </div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">CreateResourceGroupResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a CreateResourceGroupResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/CreateResourceGroupRequest#getName()"><code>name</code></a>.</div>
</div>
...
<h3>CreateResourceGroupResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">CreateResourceGroupResponse</span>()</div>
<div className="block">Constructs a CreateResourceGroupResponse object with default parameters.</div>
</div>
</li>
</ul>

...
<div className="inheritance">com.gpudb.protocol.RawGetRecordsFromCollectionResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RawGetRecordsFromCollectionResponse" title="class in com.gpudb.protocol"><code>RawGetRecordsFromCollectionResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RawGetRecordsFromCollectionResponse#getInfo()"><code>info</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.FilterByBoxRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByBoxRequest" title="class in com.gpudb.protocol"><code>FilterByBoxRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByBoxRequest#getOptions()"><code>options</code></a>. 

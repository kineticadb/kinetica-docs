...
<div className="inheritance">com.gpudb.protocol.ShowTablesByTypeRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showtablesbytype#showTablesByType(com.gpudb.protocol.ShowTablesByTypeRequest)"><code>GPUdb.showTablesByType</code></a>. 
...
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Type id returned by a call to <a href="/content/api/java/com/gpudb/GPUdb/createtype#createType(com.gpudb.protocol.CreateTypeRequest)"><code>GPUdb.createType</code></a>.</div>
</div>
...
<div className="dd"><code>typeId</code> - Type id returned by a call to <a href="/content/api/java/com/gpudb/GPUdb/createtype#createType(com.gpudb.protocol.CreateTypeRequest)"><code>GPUdb.createType</code></a>.</div>

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#showTablesByType(com.gpudb.protocol.ShowTablesByTypeRequest)"><code>GPUdb.showTablesByType</code></a>. 

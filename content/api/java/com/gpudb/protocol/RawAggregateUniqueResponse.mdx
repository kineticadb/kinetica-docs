...
<div className="inheritance">com.gpudb.protocol.RawAggregateUniqueResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/RawAggregateUniqueResponse.Info#QUALIFIED_RESULT_TABLE_NAME"><code>QUALIFIED\_RESULT\_TABLE\_NAME</code></a>: The fully qualified name of the table (i.e. including the schema) used to store the results. </li>
</ul>

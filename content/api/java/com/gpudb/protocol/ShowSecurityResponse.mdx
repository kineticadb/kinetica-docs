...
<div className="inheritance">com.gpudb.protocol.ShowSecurityResponse</div>
</div>
...
<div className="block">
Map of user/role name to the type of that user/role. Valid values are: 
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ShowSecurityResponse.Types#INTERNAL_USER"><code>INTERNAL\_USER</code></a>: A user whose credentials are managed by the database system. </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowSecurityResponse.Types#EXTERNAL_USER"><code>EXTERNAL\_USER</code></a>: A user whose credentials are managed by an external LDAP. </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowSecurityResponse.Types#ROLE"><code>ROLE</code></a>: A role. </li>
</ul>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>

...
<div className="inheritance">com.gpudb.protocol.AdminHaRefreshRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminharefresh#adminHaRefresh(com.gpudb.protocol.AdminHaRefreshRequest)"><code>GPUdb.adminHaRefresh</code></a>. 

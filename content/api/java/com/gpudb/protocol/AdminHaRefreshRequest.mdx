...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminHaRefresh(com.gpudb.protocol.AdminHaRefreshRequest)"><code>GPUdb.adminHaRefresh</code></a>. 

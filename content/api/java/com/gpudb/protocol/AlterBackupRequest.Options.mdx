---
title: "AlterBackupRequest.Options"
description: "AlterBackupRequest.Options — Kinetica Java API"
---
...
<h1 title="Class AlterBackupRequest.Options" className="title">Class AlterBackupRequest.Options</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AlterBackupRequest.Options</div> </div>
...
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AlterBackupRequest" title="class in com.gpudb.protocol"><code>AlterBackupRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AlterBackupRequest#getOptions()"><code>options</code></a>. <p> Optional parameters.</p></div>
</div>
...
<div className="block">Comments to store with the backup.</div>
</div>
...
<div className="block">Whether or not to perform a dry run of a backup alteration.</div>
</div>
<div className="col-first even-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AlterBackupRequest.Options.COMMENT">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="block">Whether or not to perform a dry run of a backup alteration. Supported values: <ul> <li><a href="#TRUE"><code>TRUE</code></a> </li><li><a href="#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="#FALSE"><code>FALSE</code></a>.</div>
<div className="dl notes">
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AlterBackupRequest.Options.DRY_RUN">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AlterBackupRequest.Options.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AlterBackupRequest.Options.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

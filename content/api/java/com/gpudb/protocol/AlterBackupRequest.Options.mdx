...
<div className="inheritance">com.gpudb.protocol.AlterBackupRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AlterBackupRequest" title="class in com.gpudb.protocol"><code>AlterBackupRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AlterBackupRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
Whether or not to perform a dry run of a backup alteration. Supported values: 
<ul>

...
<div className="inheritance">com.gpudb.protocol.ShowFilesResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowFilesResponse" title="class in com.gpudb.protocol"><code>ShowFilesResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ShowFilesResponse#getInfo()"><code>info</code></a>. 

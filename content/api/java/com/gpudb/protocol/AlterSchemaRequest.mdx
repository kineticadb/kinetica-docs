...
<div className="inheritance">com.gpudb.protocol.AlterSchemaRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/alterschema#alterSchema(com.gpudb.protocol.AlterSchemaRequest)"><code>GPUdb.alterSchema</code></a>. 
<p> Used to change the name of a SQL-style <a href="/content/concepts/schemas/" target="_top">schema</a>, specified in <a href="#getSchemaName()"><code>schemaName</code></a>.</p>
</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/AlterSchemaRequest.Action#ADD_COMMENT"><code>ADD\_COMMENT</code></a>: Adds a comment describing the schema. </li>
<li><a href="/content/api/java/com/gpudb/protocol/AlterSchemaRequest.Action#RENAME_SCHEMA"><code>RENAME\_SCHEMA</code></a>: Renames a schema to <a href="#getValue()"><code>value</code></a>. Has the same naming restrictions as <a href="/content/concepts/tables/" target="_top">tables</a>. </li>
</ul>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>

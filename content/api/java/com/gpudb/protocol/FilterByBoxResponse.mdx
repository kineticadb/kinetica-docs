...
<div className="inheritance">com.gpudb.protocol.FilterByBoxResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/FilterByBoxResponse.Info#QUALIFIED_VIEW_NAME"><code>QUALIFIED\_VIEW\_NAME</code></a>: The fully qualified name of the view (i.e. including the schema). </li>
</ul>

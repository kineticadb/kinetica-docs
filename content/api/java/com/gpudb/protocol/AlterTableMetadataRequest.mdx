...
<div className="inheritance">com.gpudb.protocol.AlterTableMetadataRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/altertablemetadata#alterTableMetadata(com.gpudb.protocol.AlterTableMetadataRequest)"><code>GPUdb.alterTableMetadata</code></a>. 

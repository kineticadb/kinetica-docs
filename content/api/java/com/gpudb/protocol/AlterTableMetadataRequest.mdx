...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#alterTableMetadata(com.gpudb.protocol.AlterTableMetadataRequest)"><code>GPUdb.alterTableMetadata</code></a>. 

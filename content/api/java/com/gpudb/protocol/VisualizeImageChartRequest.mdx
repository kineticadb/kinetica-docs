...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/visualizeimagechart#visualizeImageChart(com.gpudb.protocol.VisualizeImageChartRequest)"><code>GPUdb.visualizeImageChart</code></a>. 

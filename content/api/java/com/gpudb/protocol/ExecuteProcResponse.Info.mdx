...
<div className="inheritance">com.gpudb.protocol.ExecuteProcResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ExecuteProcResponse" title="class in com.gpudb.protocol"><code>ExecuteProcResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ExecuteProcResponse#getInfo()"><code>info</code></a>. 

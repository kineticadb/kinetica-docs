...
<div className="inheritance">com.gpudb.protocol.AlterTierRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/altertier#alterTier(com.gpudb.protocol.AlterTierRequest)"><code>GPUdb.alterTier</code></a>. 

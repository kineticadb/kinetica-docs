...
<div className="inheritance">com.gpudb.protocol.ShowTypesRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowTypesRequest" title="class in com.gpudb.protocol"><code>ShowTypesRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ShowTypesRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
When set to 'true', no join types will be included. Supported values: 
<ul>

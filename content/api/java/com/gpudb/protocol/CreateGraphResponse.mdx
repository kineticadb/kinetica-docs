...
description: "CreateGraphResponse — Kinetica Java API"
---
...
<h1 title="Class CreateGraphResponse" className="title">Class CreateGraphResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.CreateGraphResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">CreateGraphResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">CreateGraphResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a CreateGraphResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">\[Deprecated\] Edges given as pairs of node indices.</div>
</div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total number of edges created.</div>
</div>
...
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total number of nodes created.</div>
</div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates a successful creation on all servers.</div>
</div>
...
<h3>CreateGraphResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">CreateGraphResponse</span>()</div>
<div className="block">Constructs a CreateGraphResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setResult</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/CreateGraphResponse" title="class in com.gpudb.protocol">CreateGraphResponse</a></span>&nbsp;<span className="element-name">setResult</span><wbr /><span className="parameters">(boolean&nbsp;result)</span></div>
<div className="block">Indicates a successful creation on all servers.</div>
<div className="dl notes">
...
<h3>setNumNodes</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/CreateGraphResponse" title="class in com.gpudb.protocol">CreateGraphResponse</a></span>&nbsp;<span className="element-name">setNumNodes</span><wbr /><span className="parameters">(long&nbsp;numNodes)</span></div>
<div className="block">Total number of nodes created.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setNumEdges</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/CreateGraphResponse" title="class in com.gpudb.protocol">CreateGraphResponse</a></span>&nbsp;<span className="element-name">setNumEdges</span><wbr /><span className="parameters">(long&nbsp;numEdges)</span></div>
<div className="block">Total number of edges created.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<div className="block">\[Deprecated\] Edges given as pairs of node indices. Only populated if export\_create\_results internal option is set to true.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<h3>setEdgesIds</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/CreateGraphResponse" title="class in com.gpudb.protocol">CreateGraphResponse</a></span>&nbsp;<span className="element-name">setEdgesIds</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html" title="class or interface in java.lang" className="external-link">Long</a>&gt;&nbsp;edgesIds)</span></div>
<div className="block">\[Deprecated\] Edges given as pairs of node indices. Only populated if export\_create\_results internal option is set to true.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/CreateGraphResponse" title="class in com.gpudb.protocol">CreateGraphResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

...
<div className="inheritance">com.gpudb.protocol.ShowGraphRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowGraphRequest" title="class in com.gpudb.protocol"><code>ShowGraphRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ShowGraphRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If set to <a href="#TRUE"><code>TRUE</code></a>, the request that was originally used to create the graph is also returned as JSON. Supported values: 
<ul>
...
<div className="block">
If true, generates the graph ontology (schema) as a DOT format string in the response info field under the key 'dot'. Supported values: 
<ul>
<li><a href="#TRUE"><code>TRUE</code></a> </li>
<li><a href="#FALSE"><code>FALSE</code></a> </li>
</ul>

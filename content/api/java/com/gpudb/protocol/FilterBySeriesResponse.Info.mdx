...
<div className="inheritance">com.gpudb.protocol.FilterBySeriesResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterBySeriesResponse" title="class in com.gpudb.protocol"><code>FilterBySeriesResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterBySeriesResponse#getInfo()"><code>info</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.RevokePermissionProcRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/revokepermissionproc#revokePermissionProc(com.gpudb.protocol.RevokePermissionProcRequest)"><code>GPUdb.revokePermissionProc</code></a>. 
<p> \[DEPRECATED--please use <a href="/content/api/java/com/gpudb/GPUdb/revokepermission#revokePermission(com.gpudb.protocol.RevokePermissionRequest)"><code>GPUdb.revokePermission</code></a> instead\] Revokes a proc-level permission from a user or role.</p>
</div>
</div>

...
<div className="inheritance">com.gpudb.protocol.CreateDirectoryRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateDirectoryRequest" title="class in com.gpudb.protocol"><code>CreateDirectoryRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateDirectoryRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a>, does not return an error if the directory already exists. Supported values: 
<ul>

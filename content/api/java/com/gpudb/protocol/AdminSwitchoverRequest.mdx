...
<div className="inheritance">com.gpudb.protocol.AdminSwitchoverRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminswitchover#adminSwitchover(com.gpudb.protocol.AdminSwitchoverRequest)"><code>GPUdb.adminSwitchover</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.CreateBackupRequest.BackupType</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateBackupRequest" title="class in com.gpudb.protocol"><code>CreateBackupRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateBackupRequest#getBackupType()"><code>backupType</code></a>. 

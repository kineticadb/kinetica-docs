---
title: "AdminShutdownResponse"
description: "AdminShutdownResponse — Kinetica Java API"
---
...
<h1 title="Class AdminShutdownResponse" className="title">Class AdminShutdownResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AdminShutdownResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AdminShutdownResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AdminShutdownResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AdminShutdownResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getExitStatus()" className="member-name-link">getExitStatus</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">'OK' upon (right before) successful exit.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setExitStatus(java.lang.String)" className="member-name-link">setExitStatus</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;exitStatus)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">'OK' upon (right before) successful exit.</div>
</div>
...
<h3>AdminShutdownResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AdminShutdownResponse</span>()</div>
<div className="block">Constructs an AdminShutdownResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<li>
<div className="section detail" id="getExitStatus()">
<h3>getExitStatus</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></span>&nbsp;<span className="element-name">getExitStatus</span>()</div>
<div className="block">'OK' upon (right before) successful exit.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>exitStatus</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setExitStatus(java.lang.String)">
<h3>setExitStatus</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminShutdownResponse" title="class in com.gpudb.protocol">AdminShutdownResponse</a></span>&nbsp;<span className="element-name">setExitStatus</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;exitStatus)</span></div>
<div className="block">'OK' upon (right before) successful exit.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>exitStatus</code> - The new value for <code>exitStatus</code>.</div>
<div className="dt">Returns:</div>

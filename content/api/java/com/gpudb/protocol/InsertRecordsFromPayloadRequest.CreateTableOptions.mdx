...
<p> Options used when creating the target table. Includes type to use. The other options match those in <a href="/content/api/java/com/gpudb/GPUdb#createTable(com.gpudb.protocol.CreateTableRequest)"><code>GPUdb.createTable</code></a>.</p>
</div>
</div>

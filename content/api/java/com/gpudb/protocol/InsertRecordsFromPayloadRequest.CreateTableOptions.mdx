...
<div className="inheritance">com.gpudb.protocol.InsertRecordsFromPayloadRequest.CreateTableOptions</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/InsertRecordsFromPayloadRequest" title="class in com.gpudb.protocol"><code>InsertRecordsFromPayloadRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/InsertRecordsFromPayloadRequest#getCreateTableOptions()"><code>createTableOptions</code></a>. 
<p> Options used when creating the target table. Includes type to use. The other options match those in <a href="/content/api/java/com/gpudb/GPUdb/createtable#createTable(com.gpudb.protocol.CreateTableRequest)"><code>GPUdb.createTable</code></a>.</p>
</div>
</div>

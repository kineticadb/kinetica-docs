---
title: "CreateContainerRegistryResponse.Info"
description: "CreateContainerRegistryResponse.Info — Kinetica Java API"
---
...
<h1 title="Class CreateContainerRegistryResponse.Info" className="title">Class CreateContainerRegistryResponse.Info</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.CreateContainerRegistryResponse.Info</div> </div>
<div className="section class-description" id="class-description">
<div className="dl notes">
<div className="dt">Enclosing class:</div>
<div className="dd"><code><a href="/content/api/java/com/gpudb/protocol/CreateContainerRegistryResponse" title="class in com.gpudb.protocol">CreateContainerRegistryResponse</a></code></div>
</div>
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">CreateContainerRegistryResponse.Info</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
</div>
...
<div className="col-second even-row-color"><code><a href="#KML_RESPONSE" className="member-name-link">KML\_RESPONSE</a></code></div>
...
<li>
<div className="section detail" id="KML_RESPONSE">
<h3>KML\_RESPONSE</h3>
<div className="member-signature"><span className="modifiers">public static final</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></span>&nbsp;<span className="element-name">KML\_RESPONSE</span></div>
<div className="dl notes">
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.CreateContainerRegistryResponse.Info.KML_RESPONSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

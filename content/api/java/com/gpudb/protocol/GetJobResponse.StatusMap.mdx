...
<div className="inheritance">com.gpudb.protocol.GetJobResponse.StatusMap</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GetJobResponse" title="class in com.gpudb.protocol"><code>GetJobResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GetJobResponse#getStatusMap()"><code>statusMap</code></a>. 

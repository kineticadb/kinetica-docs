...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#filterByBoxGeometry(com.gpudb.protocol.FilterByBoxGeometryRequest)"><code>GPUdb.filterByBoxGeometry</code></a>. 

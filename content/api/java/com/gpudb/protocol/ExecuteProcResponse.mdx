...
<div className="inheritance">com.gpudb.protocol.ExecuteProcResponse</div>
</div>
...
<div className="block">The run ID of the running proc instance. This may be passed to <a href="/content/api/java/com/gpudb/GPUdb/showprocstatus#showProcStatus(com.gpudb.protocol.ShowProcStatusRequest)"><code>GPUdb.showProcStatus</code></a> to obtain status information, or <a href="/content/api/java/com/gpudb/GPUdb/killproc#killProc(com.gpudb.protocol.KillProcRequest)"><code>GPUdb.killProc</code></a> to kill the proc instance.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ExecuteProcResponse.Info#DEFERRED_TABLES"><code>DEFERRED\_TABLES</code></a>: &lt;DEVELOPER&gt; </li>
</ul>

...
<div className="inheritance">com.gpudb.protocol.AdminVerifyDbRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminverifydb#adminVerifyDb(com.gpudb.protocol.AdminVerifyDbRequest)"><code>GPUdb.adminVerifyDb</code></a>. 

---
title: "AggregateUniqueResponse"
description: "AggregateUniqueResponse — Kinetica Java API"
---
...
<h1 title="Class AggregateUniqueResponse" className="title">Class AggregateUniqueResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AggregateUniqueResponse</div> </div>
<div className="section class-description" id="class-description">
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AggregateUniqueResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/AggregateUniqueResponse.Info" className="type-name-link" title="class in com.gpudb.protocol">AggregateUniqueResponse.Info</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateUniqueResponse" title="class in com.gpudb.protocol"><code>AggregateUniqueResponse</code></a> parameter <a href="#getInfo()"><code>info</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AggregateUniqueResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AggregateUniqueResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<h3>AggregateUniqueResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AggregateUniqueResponse</span>()</div>
<div className="block">Constructs an AggregateUniqueResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setTableName</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateUniqueResponse" title="class in com.gpudb.protocol">AggregateUniqueResponse</a></span>&nbsp;<span className="element-name">setTableName</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;tableName)</span></div>
<div className="block">The same table name as was passed in the parameter list.</div>
<div className="dl notes">
...
<h3>setData</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateUniqueResponse" title="class in com.gpudb.protocol">AggregateUniqueResponse</a></span>&nbsp;<span className="element-name">setData</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="/content/api/java/com/gpudb/Record" title="interface in com.gpudb">Record</a>&gt;&nbsp;data)</span></div>
<div className="block">Avro binary encoded response.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateUniqueResponse" title="class in com.gpudb.protocol">AggregateUniqueResponse</a></span>&nbsp;<span className="element-name">setHasMoreRecords</span><wbr /><span className="parameters">(boolean&nbsp;hasMoreRecords)</span></div>
<div className="block">Too many records. Returned a partial set.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateUniqueResponse" title="class in com.gpudb.protocol">AggregateUniqueResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information. <ul> <li><a href="/content/api/java/com/gpudb/protocol/AggregateUniqueResponse.Info#QUALIFIED_RESULT_TABLE_NAME"><code>QUALIFIED\_RESULT\_TABLE\_NAME</code></a>: The fully qualified name of the table (i.e. including the schema) used to store the results. </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setDataType</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateUniqueResponse" title="class in com.gpudb.protocol">AggregateUniqueResponse</a></span>&nbsp;<span className="element-name">setDataType</span><wbr /><span className="parameters">(<a href="/content/api/java/com/gpudb/Type" title="class in com.gpudb">Type</a>&nbsp;dataType)</span></div>
<div className="block">The <a href="/content/api/java/com/gpudb/Type" title="class in com.gpudb"><code>Type</code></a> object containing the type of the dynamically generated data.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

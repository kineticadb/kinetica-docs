...
<div className="inheritance">com.gpudb.protocol.FilterByValueResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByValueResponse" title="class in com.gpudb.protocol"><code>FilterByValueResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByValueResponse#getInfo()"><code>info</code></a>. 

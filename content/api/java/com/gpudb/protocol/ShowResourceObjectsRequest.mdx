...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#showResourceObjects(com.gpudb.protocol.ShowResourceObjectsRequest)"><code>GPUdb.showResourceObjects</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.ShowResourceObjectsRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showresourceobjects#showResourceObjects(com.gpudb.protocol.ShowResourceObjectsRequest)"><code>GPUdb.showResourceObjects</code></a>. 

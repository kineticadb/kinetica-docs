...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/aggregateunpivot#aggregateUnpivot(com.gpudb.protocol.AggregateUnpivotRequest)"><code>GPUdb.aggregateUnpivot</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showstatistics#showStatistics(com.gpudb.protocol.ShowStatisticsRequest)"><code>GPUdb.showStatistics</code></a>. 

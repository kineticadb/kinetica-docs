...
<div className="inheritance">com.gpudb.protocol.ShowStatisticsRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#showStatistics(com.gpudb.protocol.ShowStatisticsRequest)"><code>GPUdb.showStatistics</code></a>. 
...
<ul>
<li>
<a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#NO_ERROR_IF_NOT_EXISTS"><code>NO\_ERROR\_IF\_NOT\_EXISTS</code></a>: If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a> and if the table names specified in <a href="#getTableNames()"><code>tableNames</code></a> does not exist, no error is returned. If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a> and if the table names specified in <a href="#getTableNames()"><code>tableNames</code></a> does not exist, then an error is returned. Supported values: 
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a> </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a> </li>
</ul>
...
<li>
<a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#COLLECT_NOW"><code>COLLECT\_NOW</code></a>: If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a>, the columns named by @{"{"}input.key options.column\_names{"}"} are collected synchronously during this request and reflected in the response. Supported values: 
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a> </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a> </li>
</ul>

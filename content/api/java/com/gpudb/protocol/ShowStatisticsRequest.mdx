---
title: "ShowStatisticsRequest"
description: "ShowStatisticsRequest — Kinetica Java API"
---
...
<h1 title="Class ShowStatisticsRequest" className="title">Class ShowStatisticsRequest</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.ShowStatisticsRequest</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">ShowStatisticsRequest</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
<div className="block">A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#showStatistics(com.gpudb.protocol.ShowStatisticsRequest)"><code>GPUdb.showStatistics</code></a>. <p> Retrieves the collected column statistics for the specified table(s).</p></div>
</div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options" className="type-name-link" title="class in com.gpudb.protocol">ShowStatisticsRequest.Options</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest" title="class in com.gpudb.protocol"><code>ShowStatisticsRequest</code></a> parameter <a href="#getOptions()"><code>options</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">ShowStatisticsRequest</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a ShowStatisticsRequest object with default parameters.</div>
</div>
<div className="col-constructor-name odd-row-color"><code><a href="#%3Cinit%3E(java.util.List,java.util.Map)" className="member-name-link">ShowStatisticsRequest</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;tableNames, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</code></div>
<div className="col-last odd-row-color">
<div className="block">Constructs a ShowStatisticsRequest object with the specified parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Names of tables whose metadata will be fetched, each in \[schema\_name.\]table\_name format, using standard <a href="/content/concepts/tables/#table-name-resolution" target="_top">name resolution rules</a>.</div>
</div>
...
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest" title="class in com.gpudb.protocol">ShowStatisticsRequest</a></code></div>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest" title="class in com.gpudb.protocol">ShowStatisticsRequest</a></code></div>
...
<h3>ShowStatisticsRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">ShowStatisticsRequest</span>()</div>
<div className="block">Constructs a ShowStatisticsRequest object with default parameters.</div>
</div>
</li>
<li>
<div className="section detail" id="&lt;init&gt;(java.util.List,java.util.Map)">
<h3>ShowStatisticsRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">ShowStatisticsRequest</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;tableNames, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</span></div>
<div className="block">Constructs a ShowStatisticsRequest object with the specified parameters.</div>
<div className="dl notes">
...
<div className="dd"><code>options</code> - Optional parameters. <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#NO_ERROR_IF_NOT_EXISTS"><code>NO\_ERROR\_IF\_NOT\_EXISTS</code></a>: If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a> and if the table names specified in <code> tableNames</code> does not exist, no error is returned. If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a> and if the table names specified in <code>tableNames</code> does not exist, then an error is returned. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a>. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#COLUMN_NAMES"><code>COLUMN\_NAMES</code></a>: Columns, per table in <code>tableNames</code>, to collect statistics for when @{"{"}input.key options.collect\_now{"}"} is <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a>; ignored otherwise. Encoded as a ';'-separated parallel array aligned with <code> tableNames</code> (e.g. 'x,y;z' requests columns x,y for the first table and z for the second). A value of '\*' expands to every collectable column on each table (geometry, vector, JSON, and array columns are skipped). An explicit list may not be combined with a '\*' table\_names wildcard. The default value is ''. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#COLLECT_NOW"><code>COLLECT\_NOW</code></a>: If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a>, the columns named by</li></ul></div>
</div>
</div>
</li>
</ul>
...
<div className="block">Names of tables whose metadata will be fetched, each in \[schema\_name.\]table\_name format, using standard <a href="/content/concepts/tables/#table-name-resolution" target="_top">name resolution rules</a>. All provided tables must exist, or an error is returned. A single entry of '\*' expands to every user table the caller may read (excluding system schemas, views, and temporary tables); when used it must be the only entry.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<h3>setTableNames</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest" title="class in com.gpudb.protocol">ShowStatisticsRequest</a></span>&nbsp;<span className="element-name">setTableNames</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;tableNames)</span></div>
<div className="block">Names of tables whose metadata will be fetched, each in \[schema\_name.\]table\_name format, using standard <a href="/content/concepts/tables/#table-name-resolution" target="_top">name resolution rules</a>. All provided tables must exist, or an error is returned. A single entry of '\*' expands to every user table the caller may read (excluding system schemas, views, and temporary tables); when used it must be the only entry.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<div className="block">Optional parameters. <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#NO_ERROR_IF_NOT_EXISTS"><code>NO\_ERROR\_IF\_NOT\_EXISTS</code></a>: If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a> and if the table names specified in <a href="#getTableNames()"><code>tableNames</code></a> does not exist, no error is returned. If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a> and if the table names specified in <a href="#getTableNames()"><code>tableNames</code></a> does not exist, then an error is returned. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a>. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#COLUMN_NAMES"><code>COLUMN\_NAMES</code></a>: Columns, per table in <a href="#getTableNames()"><code>tableNames</code></a>, to collect statistics for when @{"{"}input.key options.collect\_now{"}"} is <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a>; ignored otherwise. Encoded as a ';'-separated parallel array aligned with <a href="#getTableNames()"><code>tableNames</code></a> (e.g. 'x,y;z' requests columns x,y for the first table and z for the second). A value of '\*' expands to every collectable column on each table (geometry, vector, JSON, and array columns are skipped). An explicit list may not be combined with a '\*' table\_names wildcard. The default value is ''. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#COLLECT_NOW"><code>COLLECT\_NOW</code></a>: If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a>, the columns named by @{"{"}input.key options.column\_names{"}"} are collected synchronously during this request and reflected in the response. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a>. </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<h3>setOptions</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest" title="class in com.gpudb.protocol">ShowStatisticsRequest</a></span>&nbsp;<span className="element-name">setOptions</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</span></div>
<div className="block">Optional parameters. <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#NO_ERROR_IF_NOT_EXISTS"><code>NO\_ERROR\_IF\_NOT\_EXISTS</code></a>: If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a> and if the table names specified in <a href="#getTableNames()"><code>tableNames</code></a> does not exist, no error is returned. If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a> and if the table names specified in <a href="#getTableNames()"><code>tableNames</code></a> does not exist, then an error is returned. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a>. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#COLUMN_NAMES"><code>COLUMN\_NAMES</code></a>: Columns, per table in <a href="#getTableNames()"><code>tableNames</code></a>, to collect statistics for when @{"{"}input.key options.collect\_now{"}"} is <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a>; ignored otherwise. Encoded as a ';'-separated parallel array aligned with <a href="#getTableNames()"><code>tableNames</code></a> (e.g. 'x,y;z' requests columns x,y for the first table and z for the second). A value of '\*' expands to every collectable column on each table (geometry, vector, JSON, and array columns are skipped). An explicit list may not be combined with a '\*' table\_names wildcard. The default value is ''. </li><li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#COLLECT_NOW"><code>COLLECT\_NOW</code></a>: If <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a>, the columns named by @{"{"}input.key options.column\_names{"}"} are collected synchronously during this request and reflected in the response. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/ShowStatisticsRequest.Options#FALSE"><code>FALSE</code></a>. </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

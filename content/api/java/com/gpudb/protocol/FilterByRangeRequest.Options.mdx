...
<div className="inheritance">com.gpudb.protocol.FilterByRangeRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByRangeRequest" title="class in com.gpudb.protocol"><code>FilterByRangeRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByRangeRequest#getOptions()"><code>options</code></a>. 

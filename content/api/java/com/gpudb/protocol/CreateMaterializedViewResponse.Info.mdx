...
<div className="inheritance">com.gpudb.protocol.CreateMaterializedViewResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateMaterializedViewResponse" title="class in com.gpudb.protocol"><code>CreateMaterializedViewResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateMaterializedViewResponse#getInfo()"><code>info</code></a>. 

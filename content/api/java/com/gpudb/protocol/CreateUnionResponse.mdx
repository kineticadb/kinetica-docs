...
<div className="inheritance">com.gpudb.protocol.CreateUnionResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/CreateUnionResponse.Info#COUNT"><code>COUNT</code></a>: Number of records in the final table. </li>
<li><a href="/content/api/java/com/gpudb/protocol/CreateUnionResponse.Info#QUALIFIED_TABLE_NAME"><code>QUALIFIED\_TABLE\_NAME</code></a>: The fully qualified name of the result table (i.e. including the schema). </li>
</ul>

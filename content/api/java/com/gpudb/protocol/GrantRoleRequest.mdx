...
<div className="inheritance">com.gpudb.protocol.GrantRoleRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/grantrole#grantRole(com.gpudb.protocol.GrantRoleRequest)"><code>GPUdb.grantRole</code></a>. 

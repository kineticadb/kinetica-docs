...
<div className="inheritance">com.gpudb.protocol.AdminShowShardsRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminshowshards#adminShowShards(com.gpudb.protocol.AdminShowShardsRequest)"><code>GPUdb.adminShowShards</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminShowShards(com.gpudb.protocol.AdminShowShardsRequest)"><code>GPUdb.adminShowShards</code></a>. 

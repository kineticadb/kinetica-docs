...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#alterEnvironment(com.gpudb.protocol.AlterEnvironmentRequest)"><code>GPUdb.alterEnvironment</code></a>. 

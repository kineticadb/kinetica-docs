...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/aggregatestatistics#aggregateStatistics(com.gpudb.protocol.AggregateStatisticsRequest)"><code>GPUdb.aggregateStatistics</code></a>. 

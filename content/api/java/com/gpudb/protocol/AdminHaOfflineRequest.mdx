...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminHaOffline(com.gpudb.protocol.AdminHaOfflineRequest)"><code>GPUdb.adminHaOffline</code></a>. 

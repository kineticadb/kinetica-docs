...
<div className="inheritance">com.gpudb.protocol.AdminHaOfflineRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminhaoffline#adminHaOffline(com.gpudb.protocol.AdminHaOfflineRequest)"><code>GPUdb.adminHaOffline</code></a>. 

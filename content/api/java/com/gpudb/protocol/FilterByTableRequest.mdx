...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/filterbytable#filterByTable(com.gpudb.protocol.FilterByTableRequest)"><code>GPUdb.filterByTable</code></a>. 

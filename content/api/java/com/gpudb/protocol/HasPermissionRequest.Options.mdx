...
<div className="inheritance">com.gpudb.protocol.HasPermissionRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasPermissionRequest" title="class in com.gpudb.protocol"><code>HasPermissionRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/HasPermissionRequest#getOptions()"><code>options</code></a>. 

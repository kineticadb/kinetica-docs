...
<div className="inheritance">com.gpudb.protocol.AdminAlterJobsRequest.Action</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminAlterJobsRequest" title="class in com.gpudb.protocol"><code>AdminAlterJobsRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AdminAlterJobsRequest#getAction()"><code>action</code></a>. 

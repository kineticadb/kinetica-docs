...
<div className="inheritance">com.gpudb.protocol.ShowSecurityRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowSecurityRequest" title="class in com.gpudb.protocol"><code>ShowSecurityRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ShowSecurityRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a>, returns only security information for the current user. Supported values: 
<ul>

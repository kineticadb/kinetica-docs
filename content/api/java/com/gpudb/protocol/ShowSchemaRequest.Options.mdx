...
<div className="inheritance">com.gpudb.protocol.ShowSchemaRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowSchemaRequest" title="class in com.gpudb.protocol"><code>ShowSchemaRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ShowSchemaRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#FALSE"><code>FALSE</code></a> will return an error if the provided <a href="/content/api/java/com/gpudb/protocol/ShowSchemaRequest#getSchemaName()"><code>schemaName</code></a> does not exist. If <a href="#TRUE"><code>TRUE</code></a> then it will return an empty result if the provided <a href="/content/api/java/com/gpudb/protocol/ShowSchemaRequest#getSchemaName()"><code>schemaName</code></a> does not exist. Supported values: 
<ul>

...
<div className="inheritance">com.gpudb.protocol.FilterByRangeResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByRangeResponse" title="class in com.gpudb.protocol"><code>FilterByRangeResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByRangeResponse#getInfo()"><code>info</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.RawAggregateGroupByResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RawAggregateGroupByResponse" title="class in com.gpudb.protocol"><code>RawAggregateGroupByResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RawAggregateGroupByResponse#getInfo()"><code>info</code></a>. 

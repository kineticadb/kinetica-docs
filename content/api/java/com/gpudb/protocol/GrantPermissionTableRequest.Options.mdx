...
<div className="inheritance">com.gpudb.protocol.GrantPermissionTableRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GrantPermissionTableRequest" title="class in com.gpudb.protocol"><code>GrantPermissionTableRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GrantPermissionTableRequest#getOptions()"><code>options</code></a>. 

---
title: "AdminOfflineResponse"
description: "AdminOfflineResponse — Kinetica Java API"
---
...
<h1 title="Class AdminOfflineResponse" className="title">Class AdminOfflineResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AdminOfflineResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AdminOfflineResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AdminOfflineResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AdminOfflineResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getIsOffline()" className="member-name-link">getIsOffline</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Returns true if the system is offline, or false otherwise.</div>
</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setIsOffline(boolean)" className="member-name-link">setIsOffline</a><wbr />(boolean&nbsp;isOffline)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Returns true if the system is offline, or false otherwise.</div>
</div>
...
<h3>AdminOfflineResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AdminOfflineResponse</span>()</div>
<div className="block">Constructs an AdminOfflineResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<li>
<div className="section detail" id="getIsOffline()">
<h3>getIsOffline</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">boolean</span>&nbsp;<span className="element-name">getIsOffline</span>()</div>
<div className="block">Returns true if the system is offline, or false otherwise.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>isOffline</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setIsOffline(boolean)">
<h3>setIsOffline</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminOfflineResponse" title="class in com.gpudb.protocol">AdminOfflineResponse</a></span>&nbsp;<span className="element-name">setIsOffline</span><wbr /><span className="parameters">(boolean&nbsp;isOffline)</span></div>
<div className="block">Returns true if the system is offline, or false otherwise.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>isOffline</code> - The new value for <code>isOffline</code>.</div>
<div className="dt">Returns:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminOfflineResponse" title="class in com.gpudb.protocol">AdminOfflineResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

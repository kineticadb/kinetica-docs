...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#filterByString(com.gpudb.protocol.FilterByStringRequest)"><code>GPUdb.filterByString</code></a>. 

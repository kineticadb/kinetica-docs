---
title: "ShowContainerRegistryResponse.Info"
description: "ShowContainerRegistryResponse.Info — Kinetica Java API"
---
...
<h1 title="Class ShowContainerRegistryResponse.Info" className="title">Class ShowContainerRegistryResponse.Info</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.ShowContainerRegistryResponse.Info</div> </div>
<div className="section class-description" id="class-description">
<div className="dl notes">
<div className="dt">Enclosing class:</div>
<div className="dd"><code><a href="/content/api/java/com/gpudb/protocol/ShowContainerRegistryResponse" title="class in com.gpudb.protocol">ShowContainerRegistryResponse</a></code></div>
</div>
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">ShowContainerRegistryResponse.Info</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.ShowContainerRegistryResponse.Info.KML_RESPONSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

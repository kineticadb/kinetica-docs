---
title: "FilterByGeometryResponse"
description: "FilterByGeometryResponse — Kinetica Java API"
---
...
<h1 title="Class FilterByGeometryResponse" className="title">Class FilterByGeometryResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.FilterByGeometryResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">FilterByGeometryResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/FilterByGeometryResponse.Info" className="type-name-link" title="class in com.gpudb.protocol">FilterByGeometryResponse.Info</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByGeometryResponse" title="class in com.gpudb.protocol"><code>FilterByGeometryResponse</code></a> parameter <a href="#getInfo()"><code>info</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">FilterByGeometryResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a FilterByGeometryResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">The number of records passing the geometry filter.</div>
</div>
...
<h3>FilterByGeometryResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">FilterByGeometryResponse</span>()</div>
<div className="block">Constructs a FilterByGeometryResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setCount</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/FilterByGeometryResponse" title="class in com.gpudb.protocol">FilterByGeometryResponse</a></span>&nbsp;<span className="element-name">setCount</span><wbr /><span className="parameters">(long&nbsp;count)</span></div>
<div className="block">The number of records passing the geometry filter.</div>
<div className="dl notes">
...
<div className="block">Additional information. <ul> <li><a href="/content/api/java/com/gpudb/protocol/FilterByGeometryResponse.Info#QUALIFIED_VIEW_NAME"><code>QUALIFIED\_VIEW\_NAME</code></a>: The fully qualified name of the view (i.e. including the schema). </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/FilterByGeometryResponse" title="class in com.gpudb.protocol">FilterByGeometryResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information. <ul> <li><a href="/content/api/java/com/gpudb/protocol/FilterByGeometryResponse.Info#QUALIFIED_VIEW_NAME"><code>QUALIFIED\_VIEW\_NAME</code></a>: The fully qualified name of the view (i.e. including the schema). </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

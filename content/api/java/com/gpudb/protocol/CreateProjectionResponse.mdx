...
<div className="inheritance">com.gpudb.protocol.CreateProjectionResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/CreateProjectionResponse.Info#COUNT"><code>COUNT</code></a>: Number of records in the final table. </li>
<li><a href="/content/api/java/com/gpudb/protocol/CreateProjectionResponse.Info#QUALIFIED_PROJECTION_NAME"><code>QUALIFIED\_PROJECTION\_NAME</code></a>: The fully qualified name of the projection (i.e. including the schema). </li>
</ul>

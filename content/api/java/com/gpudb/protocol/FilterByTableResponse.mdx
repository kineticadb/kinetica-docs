---
title: "FilterByTableResponse"
description: "FilterByTableResponse — Kinetica Java API"
---
...
<h1 title="Class FilterByTableResponse" className="title">Class FilterByTableResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.FilterByTableResponse</div> </div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/FilterByTableResponse.Info" className="type-name-link" title="class in com.gpudb.protocol">FilterByTableResponse.Info</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByTableResponse" title="class in com.gpudb.protocol"><code>FilterByTableResponse</code></a> parameter <a href="#getInfo()"><code>info</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">FilterByTableResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a FilterByTableResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">The number of records in <a href="/content/api/java/com/gpudb/protocol/FilterByTableRequest#getTableName()"><code>tableName</code></a> that have <a href="/content/api/java/com/gpudb/protocol/FilterByTableRequest#getColumnName()"><code>columnName</code></a> values matching <a href="/content/api/java/com/gpudb/protocol/FilterByTableRequest#getSourceTableColumnName()"><code>sourceTableColumnName</code></a> values in <a href="/content/api/java/com/gpudb/protocol/FilterByTableRequest#getSourceTableName()"><code>sourceTableName</code></a>.</div>
</div>
...
<h3>FilterByTableResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">FilterByTableResponse</span>()</div>
<div className="block">Constructs a FilterByTableResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<div className="block">Additional information. <ul> <li><a href="/content/api/java/com/gpudb/protocol/FilterByTableResponse.Info#QUALIFIED_VIEW_NAME"><code>QUALIFIED\_VIEW\_NAME</code></a>: The fully qualified name of the view (i.e. including the schema). </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>

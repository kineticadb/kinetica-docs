---
title: "GrantPermissionTableResponse"
description: "GrantPermissionTableResponse — Kinetica Java API"
---
...
<h1 title="Class GrantPermissionTableResponse" className="title">Class GrantPermissionTableResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.GrantPermissionTableResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">GrantPermissionTableResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">GrantPermissionTableResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a GrantPermissionTableResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/GrantPermissionTableRequest#getFilterExpression()"><code>filterExpression</code></a>.</div>
</div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/GrantPermissionTableRequest#getName()"><code>name</code></a>.</div>
</div>
...
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/GrantPermissionTableRequest#getPermission()"><code>permission</code></a>.</div>
</div>
...
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/GrantPermissionTableRequest#getTableName()"><code>tableName</code></a>.</div>
</div>
...
<h3>GrantPermissionTableResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">GrantPermissionTableResponse</span>()</div>
<div className="block">Constructs a GrantPermissionTableResponse object with default parameters.</div>
</div>
</li>
</ul>

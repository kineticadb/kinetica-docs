---
title: "ExportRecordsToTableResponse"
description: "ExportRecordsToTableResponse — Kinetica Java API"
---
...
<h1 title="Class ExportRecordsToTableResponse" className="title">Class ExportRecordsToTableResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.ExportRecordsToTableResponse</div> </div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">ExportRecordsToTableResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an ExportRecordsToTableResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="block">Number of records skipped.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>long</code></div>
...
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/ExportRecordsToTableRequest#getTableName()"><code>tableName</code></a>.</div>
</div>
...
<h3>ExportRecordsToTableResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">ExportRecordsToTableResponse</span>()</div>
<div className="block">Constructs an ExportRecordsToTableResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setTableName</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ExportRecordsToTableResponse" title="class in com.gpudb.protocol">ExportRecordsToTableResponse</a></span>&nbsp;<span className="element-name">setTableName</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;tableName)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/ExportRecordsToTableRequest#getTableName()"><code>tableName</code></a>.</div>
<div className="dl notes">
...
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ExportRecordsToTableResponse" title="class in com.gpudb.protocol">ExportRecordsToTableResponse</a></span>&nbsp;<span className="element-name">setCountInserted</span><wbr /><span className="parameters">(long&nbsp;countInserted)</span></div>
<div className="block">Number of records inserted into the target table.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ExportRecordsToTableResponse" title="class in com.gpudb.protocol">ExportRecordsToTableResponse</a></span>&nbsp;<span className="element-name">setCountSkipped</span><wbr /><span className="parameters">(long&nbsp;countSkipped)</span></div>
<div className="block">Number of records skipped.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ExportRecordsToTableResponse" title="class in com.gpudb.protocol">ExportRecordsToTableResponse</a></span>&nbsp;<span className="element-name">setCountUpdated</span><wbr /><span className="parameters">(long&nbsp;countUpdated)</span></div>
<div className="block">\[Not yet implemented\] Number of records updated within the target table.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ExportRecordsToTableResponse" title="class in com.gpudb.protocol">ExportRecordsToTableResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

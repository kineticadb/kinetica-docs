...
<div className="inheritance">com.gpudb.protocol.GetRecordsFromCollectionResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GetRecordsFromCollectionResponse" title="class in com.gpudb.protocol"><code>GetRecordsFromCollectionResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GetRecordsFromCollectionResponse#getInfo()"><code>info</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.AlterUserRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/alteruser#alterUser(com.gpudb.protocol.AlterUserRequest)"><code>GPUdb.alterUser</code></a>. 
<p> Alters a user.</p>
</div>
</div>

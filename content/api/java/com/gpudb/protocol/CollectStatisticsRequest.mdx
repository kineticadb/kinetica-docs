...
<div className="inheritance">com.gpudb.protocol.CollectStatisticsRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/collectstatistics#collectStatistics(com.gpudb.protocol.CollectStatisticsRequest)"><code>GPUdb.collectStatistics</code></a>. 

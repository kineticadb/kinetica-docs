...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#collectStatistics(com.gpudb.protocol.CollectStatisticsRequest)"><code>GPUdb.collectStatistics</code></a>. 

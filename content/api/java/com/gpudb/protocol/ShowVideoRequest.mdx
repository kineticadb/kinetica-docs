...
<div className="inheritance">com.gpudb.protocol.ShowVideoRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showvideo#showVideo(com.gpudb.protocol.ShowVideoRequest)"><code>GPUdb.showVideo</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.ShowTableMonitorsRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showtablemonitors#showTableMonitors(com.gpudb.protocol.ShowTableMonitorsRequest)"><code>GPUdb.showTableMonitors</code></a>. 
<p> Show table monitors and their properties. Table monitors are created using <a href="/content/api/java/com/gpudb/GPUdb/createtablemonitor#createTableMonitor(com.gpudb.protocol.CreateTableMonitorRequest)"><code>GPUdb.createTableMonitor</code></a>. Returns detailed information about existing table monitors.</p>
</div>
</div>

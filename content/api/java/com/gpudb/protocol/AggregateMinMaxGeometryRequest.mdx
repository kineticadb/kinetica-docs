...
<div className="inheritance">com.gpudb.protocol.AggregateMinMaxGeometryRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/aggregateminmaxgeometry#aggregateMinMaxGeometry(com.gpudb.protocol.AggregateMinMaxGeometryRequest)"><code>GPUdb.aggregateMinMaxGeometry</code></a>. 

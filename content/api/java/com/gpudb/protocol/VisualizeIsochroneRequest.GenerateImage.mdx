---
title: "VisualizeIsochroneRequest.GenerateImage"
description: "VisualizeIsochroneRequest.GenerateImage — Kinetica Java API"
---
...
<h1 title="Class VisualizeIsochroneRequest.GenerateImage" className="title">Class VisualizeIsochroneRequest.GenerateImage</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.VisualizeIsochroneRequest.GenerateImage</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">VisualizeIsochroneRequest.GenerateImage</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/VisualizeIsochroneRequest" title="class in com.gpudb.protocol"><code>VisualizeIsochroneRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/VisualizeIsochroneRequest#getGenerateImage()"><code>generateImage</code></a>. <p> If set to <a href="#TRUE"><code>TRUE</code></a>, generates a PNG image of the isochrones in the response.</p></div>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.VisualizeIsochroneRequest.GenerateImage.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.VisualizeIsochroneRequest.GenerateImage.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

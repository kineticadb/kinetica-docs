...
<div className="inheritance">com.gpudb.protocol.VisualizeIsochroneRequest.GenerateImage</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/VisualizeIsochroneRequest" title="class in com.gpudb.protocol"><code>VisualizeIsochroneRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/VisualizeIsochroneRequest#getGenerateImage()"><code>generateImage</code></a>. 
<p> If set to <a href="#TRUE"><code>TRUE</code></a>, generates a PNG image of the isochrones in the response.</p>
</div>
</div>

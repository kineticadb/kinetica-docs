...
<div className="inheritance">com.gpudb.protocol.DeleteGraphRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/deletegraph#deleteGraph(com.gpudb.protocol.DeleteGraphRequest)"><code>GPUdb.deleteGraph</code></a>. 

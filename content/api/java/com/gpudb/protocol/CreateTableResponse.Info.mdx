...
<div className="inheritance">com.gpudb.protocol.CreateTableResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateTableResponse" title="class in com.gpudb.protocol"><code>CreateTableResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateTableResponse#getInfo()"><code>info</code></a>. 

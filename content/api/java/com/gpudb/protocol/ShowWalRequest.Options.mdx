...
<div className="inheritance">com.gpudb.protocol.ShowWalRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowWalRequest" title="class in com.gpudb.protocol"><code>ShowWalRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ShowWalRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a> include a map of the WAL settings for the requested tables. Supported values: 
<ul>

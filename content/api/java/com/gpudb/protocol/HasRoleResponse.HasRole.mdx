---
title: "HasRoleResponse.HasRole"
description: "HasRoleResponse.HasRole — Kinetica Java API"
---
...
<h1 title="Class HasRoleResponse.HasRole" className="title">Class HasRoleResponse.HasRole</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.HasRoleResponse.HasRole</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">HasRoleResponse.HasRole</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse" title="class in com.gpudb.protocol"><code>HasRoleResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse#getHasRole()"><code>hasRole</code></a>. <p> Indicates whether the specified user has membership in the specified target <a href="/content/api/java/com/gpudb/protocol/HasRoleRequest#getRole()"><code>role</code></a>.</p></div>
</div>
...
<div className="block">User does not have membership in the role.</div>
</div>
...
<div className="block">User has membership in the role.</div>
</div>
</div>
</div>
</li>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.HasRoleResponse.HasRole.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.HasRoleResponse.HasRole.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

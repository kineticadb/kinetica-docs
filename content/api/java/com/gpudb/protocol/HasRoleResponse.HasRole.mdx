...
<div className="inheritance">com.gpudb.protocol.HasRoleResponse.HasRole</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse" title="class in com.gpudb.protocol"><code>HasRoleResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/HasRoleResponse#getHasRole()"><code>hasRole</code></a>. 
<p> Indicates whether the specified user has membership in the specified target <a href="/content/api/java/com/gpudb/protocol/HasRoleRequest#getRole()"><code>role</code></a>.</p>
</div>
</div>

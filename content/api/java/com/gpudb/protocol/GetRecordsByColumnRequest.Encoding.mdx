...
<div className="inheritance">com.gpudb.protocol.GetRecordsByColumnRequest.Encoding</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GetRecordsByColumnRequest" title="class in com.gpudb.protocol"><code>GetRecordsByColumnRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GetRecordsByColumnRequest#getEncoding()"><code>encoding</code></a>. 

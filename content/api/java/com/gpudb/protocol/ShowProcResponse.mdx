...
<div className="inheritance">com.gpudb.protocol.ShowProcResponse</div>
</div>
...
<div className="block">
The execution modes of the procs named in <a href="#getProcNames()"><code>procNames</code></a>. Supported values: 
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ShowProcResponse.ExecutionModes#DISTRIBUTED"><code>DISTRIBUTED</code></a>: Distributed </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowProcResponse.ExecutionModes#NONDISTRIBUTED"><code>NONDISTRIBUTED</code></a>: Nondistributed </li>
</ul>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>

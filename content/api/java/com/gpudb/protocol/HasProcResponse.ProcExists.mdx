...
<div className="inheritance">com.gpudb.protocol.HasProcResponse.ProcExists</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasProcResponse" title="class in com.gpudb.protocol"><code>HasProcResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/HasProcResponse#getProcExists()"><code>procExists</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.CreateJobRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateJobRequest" title="class in com.gpudb.protocol"><code>CreateJobRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateJobRequest#getOptions()"><code>options</code></a>. 

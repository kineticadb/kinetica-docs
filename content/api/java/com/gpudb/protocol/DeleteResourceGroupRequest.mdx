...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#deleteResourceGroup(com.gpudb.protocol.DeleteResourceGroupRequest)"><code>GPUdb.deleteResourceGroup</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.DeleteResourceGroupRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/deleteresourcegroup#deleteResourceGroup(com.gpudb.protocol.DeleteResourceGroupRequest)"><code>GPUdb.deleteResourceGroup</code></a>. 

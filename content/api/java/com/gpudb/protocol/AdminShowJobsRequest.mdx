---
title: "AdminShowJobsRequest"
description: "AdminShowJobsRequest — Kinetica Java API"
---
...
<h1 title="Class AdminShowJobsRequest" className="title">Class AdminShowJobsRequest</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AdminShowJobsRequest</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AdminShowJobsRequest</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
<div className="block">A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminShowJobs(com.gpudb.protocol.AdminShowJobsRequest)"><code>GPUdb.adminShowJobs</code></a>. <p> Get a list of the current jobs in GPUdb.</p></div>
</div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options" className="type-name-link" title="class in com.gpudb.protocol">AdminShowJobsRequest.Options</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest" title="class in com.gpudb.protocol"><code>AdminShowJobsRequest</code></a> parameter <a href="#getOptions()"><code>options</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AdminShowJobsRequest</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AdminShowJobsRequest object with default parameters.</div>
</div>
<div className="col-constructor-name odd-row-color"><code><a href="#%3Cinit%3E(java.util.Map)" className="member-name-link">AdminShowJobsRequest</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</code></div>
<div className="col-last odd-row-color">
<div className="block">Constructs an AdminShowJobsRequest object with the specified parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest" title="class in com.gpudb.protocol">AdminShowJobsRequest</a></code></div>
...
<h3>AdminShowJobsRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AdminShowJobsRequest</span>()</div>
<div className="block">Constructs an AdminShowJobsRequest object with default parameters.</div>
</div>
</li>
<li>
...
<h3>AdminShowJobsRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AdminShowJobsRequest</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</span></div>
<div className="block">Constructs an AdminShowJobsRequest object with the specified parameters.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>options</code> - Optional parameters. <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#SHOW_ASYNC_JOBS"><code>SHOW\_ASYNC\_JOBS</code></a>: If <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a>, then the completed async jobs are also included in the response. By default, once the async jobs are completed they are no longer included in the jobs list. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#FALSE"><code>FALSE</code></a>. </li><li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#SHOW_WORKER_INFO"><code>SHOW\_WORKER\_INFO</code></a>: If <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a>, then information is also returned from worker ranks. By default only status from the head rank is returned. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
</div>
</div>
</li>
</ul>
...
<div className="block">Optional parameters. <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#SHOW_ASYNC_JOBS"><code>SHOW\_ASYNC\_JOBS</code></a>: If <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a>, then the completed async jobs are also included in the response. By default, once the async jobs are completed they are no longer included in the jobs list. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#FALSE"><code>FALSE</code></a>. </li><li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#SHOW_WORKER_INFO"><code>SHOW\_WORKER\_INFO</code></a>: If <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a>, then information is also returned from worker ranks. By default only status from the head rank is returned. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
...
<h3>setOptions</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest" title="class in com.gpudb.protocol">AdminShowJobsRequest</a></span>&nbsp;<span className="element-name">setOptions</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</span></div>
<div className="block">Optional parameters. <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#SHOW_ASYNC_JOBS"><code>SHOW\_ASYNC\_JOBS</code></a>: If <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a>, then the completed async jobs are also included in the response. By default, once the async jobs are completed they are no longer included in the jobs list. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> The default value is <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#FALSE"><code>FALSE</code></a>. </li><li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#SHOW_WORKER_INFO"><code>SHOW\_WORKER\_INFO</code></a>: If <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a>, then information is also returned from worker ranks. By default only status from the head rank is returned. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminShowJobsRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

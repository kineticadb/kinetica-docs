...
<div className="inheritance">com.gpudb.protocol.GrantPermissionProcRequest.Permission</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GrantPermissionProcRequest" title="class in com.gpudb.protocol"><code>GrantPermissionProcRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GrantPermissionProcRequest#getPermission()"><code>permission</code></a>. 

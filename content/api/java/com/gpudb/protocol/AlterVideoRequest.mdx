...
<div className="inheritance">com.gpudb.protocol.AlterVideoRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/altervideo#alterVideo(com.gpudb.protocol.AlterVideoRequest)"><code>GPUdb.alterVideo</code></a>. 
<p> Alters a video.</p>
</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/AlterVideoRequest.Options#TTL"><code>TTL</code></a>: Sets the <a href="/content/concepts/ttl/" target="_top">TTL</a> of the video. </li>
</ul>

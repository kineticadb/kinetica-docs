...
<div className="inheritance">com.gpudb.protocol.HasProcRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/hasproc#hasProc(com.gpudb.protocol.HasProcRequest)"><code>GPUdb.hasProc</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.CreateRoleRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateRoleRequest" title="class in com.gpudb.protocol"><code>CreateRoleRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateRoleRequest#getOptions()"><code>options</code></a>. 

---
title: "ImportModelResponse.Info"
description: "ImportModelResponse.Info — Kinetica Java API"
---
...
<h1 title="Class ImportModelResponse.Info" className="title">Class ImportModelResponse.Info</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.ImportModelResponse.Info</div> </div>
<div className="section class-description" id="class-description">
<div className="dl notes">
<div className="dt">Enclosing class:</div>
<div className="dd"><code><a href="/content/api/java/com/gpudb/protocol/ImportModelResponse" title="class in com.gpudb.protocol">ImportModelResponse</a></code></div>
</div>
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">ImportModelResponse.Info</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.ImportModelResponse.Info.KML_RESPONSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

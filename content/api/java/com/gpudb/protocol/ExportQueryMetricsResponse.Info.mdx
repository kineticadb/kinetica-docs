...
<div className="inheritance">com.gpudb.protocol.ExportQueryMetricsResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ExportQueryMetricsResponse" title="class in com.gpudb.protocol"><code>ExportQueryMetricsResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ExportQueryMetricsResponse#getInfo()"><code>info</code></a>. 

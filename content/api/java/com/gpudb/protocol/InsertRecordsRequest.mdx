...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/insertrecords#insertRecords(com.gpudb.protocol.InsertRecordsRequest)"><code>GPUdb.insertRecords</code></a>. 

---
title: "FilterByAreaGeometryResponse"
description: "FilterByAreaGeometryResponse — Kinetica Java API"
---
...
<h1 title="Class FilterByAreaGeometryResponse" className="title">Class FilterByAreaGeometryResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.FilterByAreaGeometryResponse</div> </div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/FilterByAreaGeometryResponse.Info" className="type-name-link" title="class in com.gpudb.protocol">FilterByAreaGeometryResponse.Info</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByAreaGeometryResponse" title="class in com.gpudb.protocol"><code>FilterByAreaGeometryResponse</code></a> parameter <a href="#getInfo()"><code>info</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">FilterByAreaGeometryResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a FilterByAreaGeometryResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<h3>FilterByAreaGeometryResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">FilterByAreaGeometryResponse</span>()</div>
<div className="block">Constructs a FilterByAreaGeometryResponse object with default parameters.</div>
</div>
</li>
</ul>

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#insertRecordsRandom(com.gpudb.protocol.InsertRecordsRandomRequest)"><code>GPUdb.insertRecordsRandom</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.InsertRecordsRandomRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/insertrecordsrandom#insertRecordsRandom(com.gpudb.protocol.InsertRecordsRandomRequest)"><code>GPUdb.insertRecordsRandom</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.DropDatasinkRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/DropDatasinkRequest" title="class in com.gpudb.protocol"><code>DropDatasinkRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/DropDatasinkRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a>, any <a href="/content/concepts/table_monitors/" target="_top">table monitors</a> that use this data sink will be cleared. Supported values: 
<ul>

...
<div className="inheritance">com.gpudb.protocol.CreateJoinTableResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateJoinTableResponse" title="class in com.gpudb.protocol"><code>CreateJoinTableResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateJoinTableResponse#getInfo()"><code>info</code></a>. 

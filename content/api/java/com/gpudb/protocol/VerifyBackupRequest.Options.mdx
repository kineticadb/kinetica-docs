...
<div className="inheritance">com.gpudb.protocol.VerifyBackupRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/VerifyBackupRequest" title="class in com.gpudb.protocol"><code>VerifyBackupRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/VerifyBackupRequest#getOptions()"><code>options</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.GrantPermissionTableRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/grantpermissiontable#grantPermissionTable(com.gpudb.protocol.GrantPermissionTableRequest)"><code>GPUdb.grantPermissionTable</code></a>. 
<p> \[DEPRECATED--please use <a href="/content/api/java/com/gpudb/GPUdb/grantpermission#grantPermission(com.gpudb.protocol.GrantPermissionRequest)"><code>GPUdb.grantPermission</code></a> instead\] Grants a table-level permission to a user or role.</p>
</div>
</div>

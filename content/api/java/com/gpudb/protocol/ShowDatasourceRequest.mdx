...
<div className="inheritance">com.gpudb.protocol.ShowDatasourceRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showdatasource#showDatasource(com.gpudb.protocol.ShowDatasourceRequest)"><code>GPUdb.showDatasource</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#showDatasource(com.gpudb.protocol.ShowDatasourceRequest)"><code>GPUdb.showDatasource</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/querygraph#queryGraph(com.gpudb.protocol.QueryGraphRequest)"><code>GPUdb.queryGraph</code></a>. 
<p> Employs a topological query on a graph generated a-priori by <a href="/content/api/java/com/gpudb/GPUdb/creategraph#createGraph(com.gpudb.protocol.CreateGraphRequest)"><code>GPUdb.createGraph</code></a> and returns a list of adjacent edge(s) or node(s), also known as an adjacency list, depending on what's been provided to the endpoint; providing edges will return nodes and providing nodes will return edges. </p>

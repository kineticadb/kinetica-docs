---
title: "AggregateHistogramResponse"
description: "AggregateHistogramResponse — Kinetica Java API"
---
...
<h1 title="Class AggregateHistogramResponse" className="title">Class AggregateHistogramResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AggregateHistogramResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AggregateHistogramResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AggregateHistogramResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AggregateHistogramResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getCounts()" className="member-name-link">getCounts</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">The array of calculated values that represents the histogram data points.</div>
</div>
...
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/AggregateHistogramRequest#getEnd()"><code>end</code></a>.</div>
</div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/AggregateHistogramRequest#getStart()"><code>start</code></a>.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setCounts(java.util.List)" className="member-name-link">setCounts</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Double.html" title="class or interface in java.lang" className="external-link">Double</a>&gt;&nbsp;counts)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">The array of calculated values that represents the histogram data points.</div>
</div>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AggregateHistogramResponse" title="class in com.gpudb.protocol">AggregateHistogramResponse</a></code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setStart(double)" className="member-name-link">setStart</a><wbr />(double&nbsp;start)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/AggregateHistogramRequest#getStart()"><code>start</code></a>.</div>
</div>
...
<h3>AggregateHistogramResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AggregateHistogramResponse</span>()</div>
<div className="block">Constructs an AggregateHistogramResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setCounts</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateHistogramResponse" title="class in com.gpudb.protocol">AggregateHistogramResponse</a></span>&nbsp;<span className="element-name">setCounts</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Double.html" title="class or interface in java.lang" className="external-link">Double</a>&gt;&nbsp;counts)</span></div>
<div className="block">The array of calculated values that represents the histogram data points.</div>
<div className="dl notes">
...
<h3>setStart</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateHistogramResponse" title="class in com.gpudb.protocol">AggregateHistogramResponse</a></span>&nbsp;<span className="element-name">setStart</span><wbr /><span className="parameters">(double&nbsp;start)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/AggregateHistogramRequest#getStart()"><code>start</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setEnd</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateHistogramResponse" title="class in com.gpudb.protocol">AggregateHistogramResponse</a></span>&nbsp;<span className="element-name">setEnd</span><wbr /><span className="parameters">(double&nbsp;end)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/AggregateHistogramRequest#getEnd()"><code>end</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AggregateHistogramResponse" title="class in com.gpudb.protocol">AggregateHistogramResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

...
<div className="inheritance">com.gpudb.protocol.ClearTableMonitorRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/cleartablemonitor#clearTableMonitor(com.gpudb.protocol.ClearTableMonitorRequest)"><code>GPUdb.clearTableMonitor</code></a>. 
<p> Deactivates a table monitor previously created with <a href="/content/api/java/com/gpudb/GPUdb/createtablemonitor#createTableMonitor(com.gpudb.protocol.CreateTableMonitorRequest)"><code>GPUdb.createTableMonitor</code></a>.</p>
</div>
</div>
...
<li>
<a href="/content/api/java/com/gpudb/protocol/ClearTableMonitorRequest.Options#CLEAR_ALL_REFERENCES"><code>CLEAR\_ALL\_REFERENCES</code></a>: If <a href="/content/api/java/com/gpudb/protocol/ClearTableMonitorRequest.Options#TRUE"><code>TRUE</code></a>, all references that share the same <a href="#getTopicId()"><code>topicId</code></a> will be cleared. Supported values: 
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ClearTableMonitorRequest.Options#TRUE"><code>TRUE</code></a> </li>
<li><a href="/content/api/java/com/gpudb/protocol/ClearTableMonitorRequest.Options#FALSE"><code>FALSE</code></a> </li>
</ul>

...
<div className="inheritance">com.gpudb.protocol.AlterRoleRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/alterrole#alterRole(com.gpudb.protocol.AlterRoleRequest)"><code>GPUdb.alterRole</code></a>. 
<p> Alters a Role.</p>
</div>
</div>

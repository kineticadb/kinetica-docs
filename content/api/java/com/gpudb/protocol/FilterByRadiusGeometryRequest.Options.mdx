...
<div className="inheritance">com.gpudb.protocol.FilterByRadiusGeometryRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByRadiusGeometryRequest" title="class in com.gpudb.protocol"><code>FilterByRadiusGeometryRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByRadiusGeometryRequest#getOptions()"><code>options</code></a>. 

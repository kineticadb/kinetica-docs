---
title: "AlterTableColumnsResponse"
description: "AlterTableColumnsResponse — Kinetica Java API"
---
...
<h1 title="Class AlterTableColumnsResponse" className="title">Class AlterTableColumnsResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AlterTableColumnsResponse</div> </div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AlterTableColumnsResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AlterTableColumnsResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<h3>AlterTableColumnsResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AlterTableColumnsResponse</span>()</div>
<div className="block">Constructs an AlterTableColumnsResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setTypeId</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterTableColumnsResponse" title="class in com.gpudb.protocol">AlterTableColumnsResponse</a></span>&nbsp;<span className="element-name">setTypeId</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;typeId)</span></div>
<div className="block">Return the type\_id (when changing a table, a new type may be created).</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterTableColumnsResponse" title="class in com.gpudb.protocol">AlterTableColumnsResponse</a></span>&nbsp;<span className="element-name">setTypeDefinition</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;typeDefinition)</span></div>
<div className="block">Return the type\_definition (when changing a table, a new type may be created).</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setProperties</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterTableColumnsResponse" title="class in com.gpudb.protocol">AlterTableColumnsResponse</a></span>&nbsp;<span className="element-name">setProperties</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&gt;&nbsp;properties)</span></div>
<div className="block">Return the type properties (when changing a table, a new type may be created).</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setLabel</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterTableColumnsResponse" title="class in com.gpudb.protocol">AlterTableColumnsResponse</a></span>&nbsp;<span className="element-name">setLabel</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;label)</span></div>
<div className="block">Return the type label (when changing a table, a new type may be created).</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AlterTableColumnsResponse" title="class in com.gpudb.protocol">AlterTableColumnsResponse</a></span>&nbsp;<span className="element-name">setColumnAlterations</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&gt;&nbsp;columnAlterations)</span></div>
<div className="block">List of alter table add/delete/change column requests - all for the same table. Each request is a map that includes 'column\_name', 'action' and the options specific for the action. Note that the same options as in alter table requests but in the same map as the column name and the action. For example: \[{"{"}'column\_name':'col\_1','action':'change\_column','rename\_column':'col\_2'{"}"},{"{"}'column\_name':'col\_1','action':'add\_column', 'type':'int','default\_value':'1'{"}"}\].</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

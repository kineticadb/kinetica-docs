...
<div className="inheritance">com.gpudb.protocol.ShowSystemPropertiesRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showsystemproperties#showSystemProperties(com.gpudb.protocol.ShowSystemPropertiesRequest)"><code>GPUdb.showSystemProperties</code></a>. 

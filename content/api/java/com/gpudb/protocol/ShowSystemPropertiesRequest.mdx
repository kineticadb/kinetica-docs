...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#showSystemProperties(com.gpudb.protocol.ShowSystemPropertiesRequest)"><code>GPUdb.showSystemProperties</code></a>. 

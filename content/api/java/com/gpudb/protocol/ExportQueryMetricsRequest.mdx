...
<div className="inheritance">com.gpudb.protocol.ExportQueryMetricsRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/exportquerymetrics#exportQueryMetrics(com.gpudb.protocol.ExportQueryMetricsRequest)"><code>GPUdb.exportQueryMetrics</code></a>. 

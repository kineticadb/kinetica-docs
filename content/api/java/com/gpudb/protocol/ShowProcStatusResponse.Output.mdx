...
<div className="inheritance">com.gpudb.protocol.ShowProcStatusResponse.Output</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowProcStatusResponse" title="class in com.gpudb.protocol"><code>ShowProcStatusResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ShowProcStatusResponse#getOutput()"><code>output</code></a>. 

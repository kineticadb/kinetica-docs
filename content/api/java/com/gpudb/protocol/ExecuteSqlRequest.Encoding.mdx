...
<div className="inheritance">com.gpudb.protocol.ExecuteSqlRequest.Encoding</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ExecuteSqlRequest" title="class in com.gpudb.protocol"><code>ExecuteSqlRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ExecuteSqlRequest#getEncoding()"><code>encoding</code></a>. 

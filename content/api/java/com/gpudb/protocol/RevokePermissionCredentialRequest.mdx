...
<div className="inheritance">com.gpudb.protocol.RevokePermissionCredentialRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/revokepermissioncredential#revokePermissionCredential(com.gpudb.protocol.RevokePermissionCredentialRequest)"><code>GPUdb.revokePermissionCredential</code></a>. 
<p> \[DEPRECATED--please use <a href="/content/api/java/com/gpudb/GPUdb/revokepermission#revokePermission(com.gpudb.protocol.RevokePermissionRequest)"><code>GPUdb.revokePermission</code></a> instead\] Revokes a <a href="/content/security/sec_concepts/#security-concepts-permissions-credential" target="_top">credential-level permission</a> from a user or role.</p>
</div>
</div>

...
<div className="inheritance">com.gpudb.protocol.ShowSchemaRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showschema#showSchema(com.gpudb.protocol.ShowSchemaRequest)"><code>GPUdb.showSchema</code></a>. 
<p> Retrieves information about a <a href="/content/concepts/schemas/" target="_top">schema</a> (or all schemas), as specified in <a href="#getSchemaName()"><code>schemaName</code></a>.</p>
</div>
</div>
...
<ul>
<li>
<a href="/content/api/java/com/gpudb/protocol/ShowSchemaRequest.Options#NO_ERROR_IF_NOT_EXISTS"><code>NO\_ERROR\_IF\_NOT\_EXISTS</code></a>: If <a href="/content/api/java/com/gpudb/protocol/ShowSchemaRequest.Options#FALSE"><code>FALSE</code></a> will return an error if the provided <a href="#getSchemaName()"><code>schemaName</code></a> does not exist. If <a href="/content/api/java/com/gpudb/protocol/ShowSchemaRequest.Options#TRUE"><code>TRUE</code></a> then it will return an empty result if the provided <a href="#getSchemaName()"><code>schemaName</code></a> does not exist. Supported values: 
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ShowSchemaRequest.Options#TRUE"><code>TRUE</code></a> </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowSchemaRequest.Options#FALSE"><code>FALSE</code></a> </li>
</ul>

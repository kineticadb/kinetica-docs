...
<div className="inheritance">com.gpudb.protocol.AggregateUnpivotRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateUnpivotRequest" title="class in com.gpudb.protocol"><code>AggregateUnpivotRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AggregateUnpivotRequest#getOptions()"><code>options</code></a>. 
...
<div className="col-last odd-row-color">
<div className="block">\[DEPRECATED--please specify the containing schema as part of <a href="#RESULT_TABLE"><code>RESULT\_TABLE</code></a> and use <a href="/content/api/java/com/gpudb/GPUdb/createschema#createSchema(com.gpudb.protocol.CreateSchemaRequest)"><code>GPUdb.createSchema</code></a> to create the schema if non-existent\] Name of a schema which is to contain the table specified in <a href="#RESULT_TABLE"><code>RESULT\_TABLE</code></a>.</div>
</div>
<div className="col-first even-row-color"><code>static final <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>

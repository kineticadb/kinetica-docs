---
title: "AdminShowClusterOperationsResponse.RebalanceShardedData"
description: "AdminShowClusterOperationsResponse.RebalanceShardedData — Kinetica Java API"
---
...
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">AdminShowClusterOperationsResponse.RebalanceShardedData</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminShowClusterOperationsResponse" title="class in com.gpudb.protocol"><code>AdminShowClusterOperationsResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AdminShowClusterOperationsResponse#getRebalanceShardedData()"><code>rebalanceShardedData</code></a>. <p> Whether rebalancing of sharded data is (or was) part of this operation.</p></div>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminShowClusterOperationsResponse.RebalanceShardedData.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminShowClusterOperationsResponse.RebalanceShardedData.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

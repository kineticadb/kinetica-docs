...
<div className="inheritance">com.gpudb.protocol.DeleteFilesRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/DeleteFilesRequest" title="class in com.gpudb.protocol"><code>DeleteFilesRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/DeleteFilesRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a>, no error is returned if a specified file does not exist. Supported values: 
<ul>

---
title: "HasProcResponse"
description: "HasProcResponse — Kinetica Java API"
---
...
<h1 title="Class HasProcResponse" className="title">Class HasProcResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.HasProcResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">HasProcResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/HasProcResponse.ProcExists" className="type-name-link" title="class in com.gpudb.protocol">HasProcResponse.ProcExists</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasProcResponse" title="class in com.gpudb.protocol"><code>HasProcResponse</code></a> parameter <a href="#getProcExists()"><code>procExists</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">HasProcResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a HasProcResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getProcExists()" className="member-name-link">getProcExists</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates whether the proc exists or not.</div>
</div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/HasProcRequest#getProcName()"><code>procName</code></a>.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setProcExists(boolean)" className="member-name-link">setProcExists</a><wbr />(boolean&nbsp;procExists)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates whether the proc exists or not.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/HasProcResponse" title="class in com.gpudb.protocol">HasProcResponse</a></code></div>
...
<h3>HasProcResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">HasProcResponse</span>()</div>
<div className="block">Constructs a HasProcResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setProcName</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasProcResponse" title="class in com.gpudb.protocol">HasProcResponse</a></span>&nbsp;<span className="element-name">setProcName</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;procName)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/HasProcRequest#getProcName()"><code>procName</code></a>.</div>
<div className="dl notes">
...
<li>
<div className="section detail" id="getProcExists()">
<h3>getProcExists</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">boolean</span>&nbsp;<span className="element-name">getProcExists</span>()</div>
<div className="block">Indicates whether the proc exists or not. Supported values: <ul> <li><code>true</code> </li><li><code>false</code> </li></ul></div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>procExists</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setProcExists(boolean)">
<h3>setProcExists</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasProcResponse" title="class in com.gpudb.protocol">HasProcResponse</a></span>&nbsp;<span className="element-name">setProcExists</span><wbr /><span className="parameters">(boolean&nbsp;procExists)</span></div>
<div className="block">Indicates whether the proc exists or not. Supported values: <ul> <li><code>true</code> </li><li><code>false</code> </li></ul></div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>procExists</code> - The new value for <code>procExists</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasProcResponse" title="class in com.gpudb.protocol">HasProcResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

...
<div className="inheritance">com.gpudb.protocol.DropSchemaRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/dropschema#dropSchema(com.gpudb.protocol.DropSchemaRequest)"><code>GPUdb.dropSchema</code></a>. 
<p> Drops an existing SQL-style <a href="/content/concepts/schemas/" target="_top">schema</a>, specified in <a href="#getSchemaName()"><code>schemaName</code></a>.</p>
</div>
</div>

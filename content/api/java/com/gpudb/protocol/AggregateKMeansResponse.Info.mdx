...
<div className="inheritance">com.gpudb.protocol.AggregateKMeansResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateKMeansResponse" title="class in com.gpudb.protocol"><code>AggregateKMeansResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AggregateKMeansResponse#getInfo()"><code>info</code></a>. 

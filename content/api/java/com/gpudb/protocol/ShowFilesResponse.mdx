...
<div className="inheritance">com.gpudb.protocol.ShowFilesResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ShowFilesResponse.Info#MULTIPART_UPLOADS"><code>MULTIPART\_UPLOADS</code></a>: JSON-encoded information about multipart uploads in progress. </li>
</ul>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>

...
<div className="inheritance">com.gpudb.protocol.ShowResourceStatisticsRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showresourcestatistics#showResourceStatistics(com.gpudb.protocol.ShowResourceStatisticsRequest)"><code>GPUdb.showResourceStatistics</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#showResourceStatistics(com.gpudb.protocol.ShowResourceStatisticsRequest)"><code>GPUdb.showResourceStatistics</code></a>. 

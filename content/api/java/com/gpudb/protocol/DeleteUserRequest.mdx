...
<div className="inheritance">com.gpudb.protocol.DeleteUserRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/deleteuser#deleteUser(com.gpudb.protocol.DeleteUserRequest)"><code>GPUdb.deleteUser</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.GrantPermissionDatasourceRequest.Permission</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/GrantPermissionDatasourceRequest" title="class in com.gpudb.protocol"><code>GrantPermissionDatasourceRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/GrantPermissionDatasourceRequest#getPermission()"><code>permission</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.AdminSwitchoverRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminSwitchoverRequest" title="class in com.gpudb.protocol"><code>AdminSwitchoverRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AdminSwitchoverRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If set to <a href="#TRUE"><code>TRUE</code></a>, only validation checks will be performed. Nothing is switched over. Supported values: 
<ul>

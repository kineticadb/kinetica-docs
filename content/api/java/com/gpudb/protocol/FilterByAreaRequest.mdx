...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/filterbyarea#filterByArea(com.gpudb.protocol.FilterByAreaRequest)"><code>GPUdb.filterByArea</code></a>. 

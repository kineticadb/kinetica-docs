...
<div className="inheritance">com.gpudb.protocol.FilterByAreaGeometryRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByAreaGeometryRequest" title="class in com.gpudb.protocol"><code>FilterByAreaGeometryRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByAreaGeometryRequest#getOptions()"><code>options</code></a>. 

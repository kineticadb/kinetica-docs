...
<div className="inheritance">com.gpudb.protocol.ShowTableMetadataRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showtablemetadata#showTableMetadata(com.gpudb.protocol.ShowTableMetadataRequest)"><code>GPUdb.showTableMetadata</code></a>. 

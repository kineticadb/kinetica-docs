...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#showTableMetadata(com.gpudb.protocol.ShowTableMetadataRequest)"><code>GPUdb.showTableMetadata</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.AggregateUniqueResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateUniqueResponse" title="class in com.gpudb.protocol"><code>AggregateUniqueResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AggregateUniqueResponse#getInfo()"><code>info</code></a>. 

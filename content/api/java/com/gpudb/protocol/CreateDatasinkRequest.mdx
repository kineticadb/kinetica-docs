...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#createDatasink(com.gpudb.protocol.CreateDatasinkRequest)"><code>GPUdb.createDatasink</code></a>. 

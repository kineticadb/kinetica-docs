...
<div className="inheritance">com.gpudb.protocol.AggregateGroupByRequest.Encoding</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateGroupByRequest" title="class in com.gpudb.protocol"><code>AggregateGroupByRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AggregateGroupByRequest#getEncoding()"><code>encoding</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.HasTableRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/hastable#hasTable(com.gpudb.protocol.HasTableRequest)"><code>GPUdb.hasTable</code></a>. 

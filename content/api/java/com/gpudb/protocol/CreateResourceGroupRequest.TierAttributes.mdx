...
<div className="inheritance">com.gpudb.protocol.CreateResourceGroupRequest.TierAttributes</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateResourceGroupRequest" title="class in com.gpudb.protocol"><code>CreateResourceGroupRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateResourceGroupRequest#getTierAttributes()"><code>tierAttributes</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/modifygraph#modifyGraph(com.gpudb.protocol.ModifyGraphRequest)"><code>GPUdb.modifyGraph</code></a>. 

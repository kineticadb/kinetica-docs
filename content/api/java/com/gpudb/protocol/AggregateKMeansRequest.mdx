...
<div className="inheritance">com.gpudb.protocol.AggregateKMeansRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/aggregatekmeans#aggregateKMeans(com.gpudb.protocol.AggregateKMeansRequest)"><code>GPUdb.aggregateKMeans</code></a>. 

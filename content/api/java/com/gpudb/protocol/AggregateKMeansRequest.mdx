...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#aggregateKMeans(com.gpudb.protocol.AggregateKMeansRequest)"><code>GPUdb.aggregateKMeans</code></a>. 

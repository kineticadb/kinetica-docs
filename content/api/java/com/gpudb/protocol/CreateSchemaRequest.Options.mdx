...
<div className="inheritance">com.gpudb.protocol.CreateSchemaRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateSchemaRequest" title="class in com.gpudb.protocol"><code>CreateSchemaRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateSchemaRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a>, prevents an error from occurring if the schema already exists. Supported values: 
<ul>

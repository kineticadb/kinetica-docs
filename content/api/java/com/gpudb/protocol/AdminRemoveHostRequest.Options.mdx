...
<div className="inheritance">com.gpudb.protocol.AdminRemoveHostRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminRemoveHostRequest" title="class in com.gpudb.protocol"><code>AdminRemoveHostRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AdminRemoveHostRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If set to <a href="#TRUE"><code>TRUE</code></a>, only validation checks will be performed. No host is removed. Supported values: 
<ul>

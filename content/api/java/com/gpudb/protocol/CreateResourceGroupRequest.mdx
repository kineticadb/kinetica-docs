...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/createresourcegroup#createResourceGroup(com.gpudb.protocol.CreateResourceGroupRequest)"><code>GPUdb.createResourceGroup</code></a>. 

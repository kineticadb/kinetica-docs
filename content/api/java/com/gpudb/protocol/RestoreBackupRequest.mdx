...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/restorebackup#restoreBackup(com.gpudb.protocol.RestoreBackupRequest)"><code>GPUdb.restoreBackup</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.RevokePermissionDatasourceRequest.Permission</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RevokePermissionDatasourceRequest" title="class in com.gpudb.protocol"><code>RevokePermissionDatasourceRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RevokePermissionDatasourceRequest#getPermission()"><code>permission</code></a>. 

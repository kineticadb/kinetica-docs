...
<div className="inheritance">com.gpudb.protocol.FilterByRadiusRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByRadiusRequest" title="class in com.gpudb.protocol"><code>FilterByRadiusRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByRadiusRequest#getOptions()"><code>options</code></a>. 

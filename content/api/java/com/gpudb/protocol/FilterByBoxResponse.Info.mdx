...
<div className="inheritance">com.gpudb.protocol.FilterByBoxResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByBoxResponse" title="class in com.gpudb.protocol"><code>FilterByBoxResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByBoxResponse#getInfo()"><code>info</code></a>. 

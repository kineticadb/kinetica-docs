...
<div className="inheritance">com.gpudb.protocol.ShowSqlProcResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ShowSqlProcResponse.AdditionalInfo#EXECUTE_AS"><code>EXECUTE\_AS</code></a>: The periodic execution impersonate user. The default value is ''. </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowSqlProcResponse.AdditionalInfo#EXECUTE_INTERVAL"><code>EXECUTE\_INTERVAL</code></a>: The periodic execution interval in seconds. The default value is ''. </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowSqlProcResponse.AdditionalInfo#EXECUTE_START_TIME"><code>EXECUTE\_START\_TIME</code></a>: The initial date/time that periodic execution began. The default value is ''. </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowSqlProcResponse.AdditionalInfo#EXECUTE_STOP_TIME"><code>EXECUTE\_STOP\_TIME</code></a>: Time at which the periodic execution stops. The default value is ''. </li>
</ul>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>

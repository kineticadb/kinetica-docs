...
<div className="inheritance">com.gpudb.protocol.ShowTriggersRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showtriggers#showTriggers(com.gpudb.protocol.ShowTriggersRequest)"><code>GPUdb.showTriggers</code></a>. 

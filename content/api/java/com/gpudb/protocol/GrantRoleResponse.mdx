---
title: "GrantRoleResponse"
description: "GrantRoleResponse — Kinetica Java API"
---
...
<h1 title="Class GrantRoleResponse" className="title">Class GrantRoleResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.GrantRoleResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">GrantRoleResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">GrantRoleResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a GrantRoleResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/GrantRoleRequest#getMember()"><code>member</code></a>.</div>
</div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/GrantRoleRequest#getRole()"><code>role</code></a>.</div>
</div>
...
<h3>GrantRoleResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">GrantRoleResponse</span>()</div>
<div className="block">Constructs a GrantRoleResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setRole</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/GrantRoleResponse" title="class in com.gpudb.protocol">GrantRoleResponse</a></span>&nbsp;<span className="element-name">setRole</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;role)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/GrantRoleRequest#getRole()"><code>role</code></a>.</div>
<div className="dl notes">
...
<h3>setMember</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/GrantRoleResponse" title="class in com.gpudb.protocol">GrantRoleResponse</a></span>&nbsp;<span className="element-name">setMember</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;member)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/GrantRoleRequest#getMember()"><code>member</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/GrantRoleResponse" title="class in com.gpudb.protocol">GrantRoleResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

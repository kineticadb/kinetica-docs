...
<div className="inheritance">com.gpudb.protocol.CreateJobResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/CreateJobResponse.Info#JOB_TAG"><code>JOB\_TAG</code></a>: The job tag specified by the user or if unspecified by user, a unique identifier generated internally. </li>
<li><a href="/content/api/java/com/gpudb/protocol/CreateJobResponse.Info#QUERY_ID"><code>QUERY\_ID</code></a>: A unique identifier for this job generated for use in tracing telemetry data. </li>
</ul>

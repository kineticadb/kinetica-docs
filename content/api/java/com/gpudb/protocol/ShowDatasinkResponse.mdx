...
<div className="inheritance">com.gpudb.protocol.ShowDatasinkResponse</div>
</div>
...
<div className="block">
Additional information about the respective data sinks in <a href="#getDatasinkNames()"><code>datasinkNames</code></a>. 
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ShowDatasinkResponse.AdditionalInfo#DESTINATION"><code>DESTINATION</code></a>: Destination for the output data in 'destination\_type://path\[:port\]' format. </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowDatasinkResponse.AdditionalInfo#KAFKA_TOPIC_NAME"><code>KAFKA\_TOPIC\_NAME</code></a>: Kafka topic if the data sink type is a Kafka broker. </li>
<li><a href="/content/api/java/com/gpudb/protocol/ShowDatasinkResponse.AdditionalInfo#USER_NAME"><code>USER\_NAME</code></a>: Name of the remote system user. </li>
</ul>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>

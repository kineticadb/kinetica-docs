...
<div className="inheritance">com.gpudb.protocol.FilterByTableResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByTableResponse" title="class in com.gpudb.protocol"><code>FilterByTableResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByTableResponse#getInfo()"><code>info</code></a>. 

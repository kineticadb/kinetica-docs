---
title: "AdminShowClusterOperationsResponse.Rebalance"
description: "AdminShowClusterOperationsResponse.Rebalance — Kinetica Java API"
---
...
<h1 title="Class AdminShowClusterOperationsResponse.Rebalance" className="title">Class AdminShowClusterOperationsResponse.Rebalance</h1>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminShowClusterOperationsResponse.Rebalance.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.AdminShowClusterOperationsResponse.Rebalance.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

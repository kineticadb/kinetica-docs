...
<div className="inheritance">com.gpudb.protocol.InsertRecordsResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/InsertRecordsResponse" title="class in com.gpudb.protocol"><code>InsertRecordsResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/InsertRecordsResponse#getInfo()"><code>info</code></a>. 

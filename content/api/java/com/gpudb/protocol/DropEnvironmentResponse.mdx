---
title: "DropEnvironmentResponse"
description: "DropEnvironmentResponse — Kinetica Java API"
---
...
<h1 title="Class DropEnvironmentResponse" className="title">Class DropEnvironmentResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.DropEnvironmentResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">DropEnvironmentResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">DropEnvironmentResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a DropEnvironmentResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/DropEnvironmentRequest#getEnvironmentName()"><code>environmentName</code></a>.</div>
</div>
...
<h3>DropEnvironmentResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">DropEnvironmentResponse</span>()</div>
<div className="block">Constructs a DropEnvironmentResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/DropEnvironmentResponse" title="class in com.gpudb.protocol">DropEnvironmentResponse</a></span>&nbsp;<span className="element-name">setEnvironmentName</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;environmentName)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/DropEnvironmentRequest#getEnvironmentName()"><code>environmentName</code></a>.</div>
<div className="dl notes">

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/aggregategroupby#aggregateGroupBy(com.gpudb.protocol.AggregateGroupByRequest)"><code>GPUdb.aggregateGroupBy</code></a>. 

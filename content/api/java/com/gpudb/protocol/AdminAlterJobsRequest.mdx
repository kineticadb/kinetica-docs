...
<div className="inheritance">com.gpudb.protocol.AdminAlterJobsRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminalterjobs#adminAlterJobs(com.gpudb.protocol.AdminAlterJobsRequest)"><code>GPUdb.adminAlterJobs</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminAlterJobs(com.gpudb.protocol.AdminAlterJobsRequest)"><code>GPUdb.adminAlterJobs</code></a>. 

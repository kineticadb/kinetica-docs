...
<div className="inheritance">com.gpudb.protocol.AdminAlterHostRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminAlterHostRequest" title="class in com.gpudb.protocol"><code>AdminAlterHostRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AdminAlterHostRequest#getOptions()"><code>options</code></a>. 

---
title: "HasPermissionResponse"
description: "HasPermissionResponse — Kinetica Java API"
---
...
<h1 title="Class HasPermissionResponse" className="title">Class HasPermissionResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.HasPermissionResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">HasPermissionResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse.HasPermission" className="type-name-link" title="class in com.gpudb.protocol">HasPermissionResponse.HasPermission</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse" title="class in com.gpudb.protocol"><code>HasPermissionResponse</code></a> parameter <a href="#getHasPermission()"><code>hasPermission</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">HasPermissionResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a HasPermissionResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getFilters()" className="member-name-link">getFilters</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Map of column/filters that have been granted.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getHasPermission()" className="member-name-link">getHasPermission</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates whether the specified user has the specified permission on the specified target.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a><wbr />&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;</code></div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getObject()" className="member-name-link">getObject</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Fully-qualified value of <a href="/content/api/java/com/gpudb/protocol/HasPermissionRequest#getObject()"><code>object</code></a>.</div>
</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getObjectType()" className="member-name-link">getObjectType</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/HasPermissionRequest#getObjectType()"><code>objectType</code></a>.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
...
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/HasPermissionRequest#getPermission()"><code>permission</code></a>.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></code></div>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/HasPermissionRequest#getPrincipal()"><code>principal</code></a>.</div>
</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setFilters(java.util.Map)" className="member-name-link">setFilters</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;filters)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Map of column/filters that have been granted.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setHasPermission(boolean)" className="member-name-link">setHasPermission</a><wbr />(boolean&nbsp;hasPermission)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Indicates whether the specified user has the specified permission on the specified target.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse" title="class in com.gpudb.protocol">HasPermissionResponse</a></code></div>
...
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse" title="class in com.gpudb.protocol">HasPermissionResponse</a></code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setObject(java.lang.String)" className="member-name-link">setObject</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;object)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Fully-qualified value of <a href="/content/api/java/com/gpudb/protocol/HasPermissionRequest#getObject()"><code>object</code></a>.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse" title="class in com.gpudb.protocol">HasPermissionResponse</a></code></div>
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setObjectType(java.lang.String)" className="member-name-link">setObjectType</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;objectType)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/HasPermissionRequest#getObjectType()"><code>objectType</code></a>.</div>
</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse" title="class in com.gpudb.protocol">HasPermissionResponse</a></code></div>
...
<h3>HasPermissionResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">HasPermissionResponse</span>()</div>
<div className="block">Constructs a HasPermissionResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setObject</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse" title="class in com.gpudb.protocol">HasPermissionResponse</a></span>&nbsp;<span className="element-name">setObject</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;object)</span></div>
<div className="block">Fully-qualified value of <a href="/content/api/java/com/gpudb/protocol/HasPermissionRequest#getObject()"><code>object</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<h3>setObjectType</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse" title="class in com.gpudb.protocol">HasPermissionResponse</a></span>&nbsp;<span className="element-name">setObjectType</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;objectType)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/HasPermissionRequest#getObjectType()"><code>objectType</code></a>.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
...
<li>
<div className="section detail" id="getHasPermission()">
<h3>getHasPermission</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">boolean</span>&nbsp;<span className="element-name">getHasPermission</span>()</div>
<div className="block">Indicates whether the specified user has the specified permission on the specified target. Supported values: <ul> <li><code>true</code>: User has the effective queried permission. </li><li><code>false</code>: User does not have the queried permission. </li></ul></div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>hasPermission</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setHasPermission(boolean)">
<h3>setHasPermission</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse" title="class in com.gpudb.protocol">HasPermissionResponse</a></span>&nbsp;<span className="element-name">setHasPermission</span><wbr /><span className="parameters">(boolean&nbsp;hasPermission)</span></div>
<div className="block">Indicates whether the specified user has the specified permission on the specified target. Supported values: <ul> <li><code>true</code>: User has the effective queried permission. </li><li><code>false</code>: User does not have the queried permission. </li></ul></div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>hasPermission</code> - The new value for <code>hasPermission</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<li>
<div className="section detail" id="getFilters()">
<h3>getFilters</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;</span>&nbsp;<span className="element-name">getFilters</span>()</div>
<div className="block">Map of column/filters that have been granted.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>filters</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setFilters(java.util.Map)">
<h3>setFilters</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/HasPermissionResponse" title="class in com.gpudb.protocol">HasPermissionResponse</a></span>&nbsp;<span className="element-name">setFilters</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;filters)</span></div>
<div className="block">Map of column/filters that have been granted.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>filters</code> - The new value for <code>filters</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>

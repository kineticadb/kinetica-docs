...
<div className="inheritance">com.gpudb.protocol.HasPermissionResponse</div>
</div>
...
<div className="block">
Indicates whether the specified user has the specified permission on the specified target. Supported values: 
<ul>
<li><code>true</code>: User has the effective queried permission. </li>
<li><code>false</code>: User does not have the queried permission. </li>
</ul>
</div>
<div className="dl notes">
<div className="dt">Returns:</div>

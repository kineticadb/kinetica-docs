...
<div className="inheritance">com.gpudb.protocol.RawAggregateUniqueResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RawAggregateUniqueResponse" title="class in com.gpudb.protocol"><code>RawAggregateUniqueResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RawAggregateUniqueResponse#getInfo()"><code>info</code></a>. 

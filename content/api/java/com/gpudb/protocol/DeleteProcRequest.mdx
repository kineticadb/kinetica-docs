...
<div className="inheritance">com.gpudb.protocol.DeleteProcRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/deleteproc#deleteProc(com.gpudb.protocol.DeleteProcRequest)"><code>GPUdb.deleteProc</code></a>. 

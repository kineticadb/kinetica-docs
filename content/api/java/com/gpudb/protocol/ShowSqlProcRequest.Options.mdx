...
<div className="inheritance">com.gpudb.protocol.ShowSqlProcRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ShowSqlProcRequest" title="class in com.gpudb.protocol"><code>ShowSqlProcRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ShowSqlProcRequest#getOptions()"><code>options</code></a>. 
...
<div className="block">
If <a href="#TRUE"><code>TRUE</code></a>, no error will be returned if the requested procedure does not exist. If <a href="#FALSE"><code>FALSE</code></a>, an error will be returned if the requested procedure does not exist. Supported values: 
<ul>

...
<div className="inheritance">com.gpudb.protocol.ShowDatasinkRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/showdatasink#showDatasink(com.gpudb.protocol.ShowDatasinkRequest)"><code>GPUdb.showDatasink</code></a>. 

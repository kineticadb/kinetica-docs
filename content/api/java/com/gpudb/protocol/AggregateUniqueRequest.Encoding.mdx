...
<div className="inheritance">com.gpudb.protocol.AggregateUniqueRequest.Encoding</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateUniqueRequest" title="class in com.gpudb.protocol"><code>AggregateUniqueRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AggregateUniqueRequest#getEncoding()"><code>encoding</code></a>. 

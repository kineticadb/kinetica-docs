...
<div className="inheritance">com.gpudb.protocol.AdminShowJobsResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsResponse" title="class in com.gpudb.protocol"><code>AdminShowJobsResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AdminShowJobsResponse#getInfo()"><code>info</code></a>. 

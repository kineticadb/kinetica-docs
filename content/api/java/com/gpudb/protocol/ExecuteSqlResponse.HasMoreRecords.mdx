...
<div className="inheritance">com.gpudb.protocol.ExecuteSqlResponse.HasMoreRecords</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/ExecuteSqlResponse" title="class in com.gpudb.protocol"><code>ExecuteSqlResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/ExecuteSqlResponse#getHasMoreRecords()"><code>hasMoreRecords</code></a>. 

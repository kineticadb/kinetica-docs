---
title: "AdminOfflineRequest"
description: "AdminOfflineRequest — Kinetica Java API"
---
...
<h1 title="Class AdminOfflineRequest" className="title">Class AdminOfflineRequest</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.AdminOfflineRequest</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">AdminOfflineRequest</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
<div className="block">A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminOffline(com.gpudb.protocol.AdminOfflineRequest)"><code>GPUdb.adminOffline</code></a>. <p> Take the system offline. When the system is offline, no user operations can be performed with the exception of a system shutdown.</p></div>
</div>
...
<div className="col-second even-row-color"><code><a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest.Offline" className="type-name-link" title="class in com.gpudb.protocol">AdminOfflineRequest.Offline</a></code></div>
<div className="col-last even-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest" title="class in com.gpudb.protocol"><code>AdminOfflineRequest</code></a> parameter <a href="#getOffline()"><code>offline</code></a>.</div>
</div>
<div className="col-first odd-row-color"><code>static final class&nbsp;</code></div>
<div className="col-second odd-row-color"><code><a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest.Options" className="type-name-link" title="class in com.gpudb.protocol">AdminOfflineRequest.Options</a></code></div>
<div className="col-last odd-row-color">
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest" title="class in com.gpudb.protocol"><code>AdminOfflineRequest</code></a> parameter <a href="#getOptions()"><code>options</code></a>.</div>
</div>
</div>
</div>
</li>
...
<div className="table-header col-last">Description</div>
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">AdminOfflineRequest</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs an AdminOfflineRequest object with default parameters.</div>
</div>
<div className="col-constructor-name odd-row-color"><code><a href="#%3Cinit%3E(boolean,java.util.Map)" className="member-name-link">AdminOfflineRequest</a><wbr />(boolean&nbsp;offline, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</code></div>
<div className="col-last odd-row-color">
<div className="block">Constructs an AdminOfflineRequest object with the specified parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getOffline()" className="member-name-link">getOffline</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Set to true if desired state is offline.</div>
</div>
...
<div className="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest" title="class in com.gpudb.protocol">AdminOfflineRequest</a></code></div>
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setOffline(boolean)" className="member-name-link">setOffline</a><wbr />(boolean&nbsp;offline)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Set to true if desired state is offline.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest" title="class in com.gpudb.protocol">AdminOfflineRequest</a></code></div>
...
<h3>AdminOfflineRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AdminOfflineRequest</span>()</div>
<div className="block">Constructs an AdminOfflineRequest object with default parameters.</div>
</div>
</li>
<li>
<div className="section detail" id="&lt;init&gt;(boolean,java.util.Map)">
<h3>AdminOfflineRequest</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">AdminOfflineRequest</span><wbr /><span className="parameters">(boolean&nbsp;offline, <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;options)</span></div>
<div className="block">Constructs an AdminOfflineRequest object with the specified parameters.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>offline</code> - Set to true if desired state is offline. Supported values: <ul> <li><code>true</code> </li><li><code>false</code> </li></ul></div>
<div className="dd"><code>options</code> - Optional parameters. <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest.Options#FLUSH_TO_DISK"><code>FLUSH\_TO\_DISK</code></a>: Flush to disk when going offline. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
</div>
</div>
</li>
</ul>
...
<li>
<div className="section detail" id="getOffline()">
<h3>getOffline</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">boolean</span>&nbsp;<span className="element-name">getOffline</span>()</div>
<div className="block">Set to true if desired state is offline. Supported values: <ul> <li><code>true</code> </li><li><code>false</code> </li></ul></div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>offline</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setOffline(boolean)">
<h3>setOffline</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest" title="class in com.gpudb.protocol">AdminOfflineRequest</a></span>&nbsp;<span className="element-name">setOffline</span><wbr /><span className="parameters">(boolean&nbsp;offline)</span></div>
<div className="block">Set to true if desired state is offline. Supported values: <ul> <li><code>true</code> </li><li><code>false</code> </li></ul></div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>offline</code> - The new value for <code>offline</code>.</div>
<div className="dt">Returns:</div>
...
<div className="block">Optional parameters. <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest.Options#FLUSH_TO_DISK"><code>FLUSH\_TO\_DISK</code></a>: Flush to disk when going offline. Supported values: <ul> <li><a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest.Options#TRUE"><code>TRUE</code></a> </li><li><a href="/content/api/java/com/gpudb/protocol/AdminOfflineRequest.Options#FALSE"><code>FALSE</code></a> </li></ul> </li></ul> The default value is an empty <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link"><code>Map</code></a>.</div>
<div className="dl notes">
<div className="dt">Returns:</div>

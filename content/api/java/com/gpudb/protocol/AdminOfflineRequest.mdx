...
<div className="inheritance">com.gpudb.protocol.AdminOfflineRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminoffline#adminOffline(com.gpudb.protocol.AdminOfflineRequest)"><code>GPUdb.adminOffline</code></a>. 

---
title: "RawExecuteSqlResponse.HasMoreRecords"
description: "RawExecuteSqlResponse.HasMoreRecords — Kinetica Java API"
---
...
<h1 title="Class RawExecuteSqlResponse.HasMoreRecords" className="title">Class RawExecuteSqlResponse.HasMoreRecords</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.RawExecuteSqlResponse.HasMoreRecords</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public static final class </span><span className="element-name type-name-label">RawExecuteSqlResponse.HasMoreRecords</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a></span></div>
<div className="block">A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RawExecuteSqlResponse" title="class in com.gpudb.protocol"><code>RawExecuteSqlResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RawExecuteSqlResponse#getHasMoreRecords()"><code>hasMoreRecords</code></a>. <p> Too many records. Returned a partial set.</p></div>
</div>
...
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.RawExecuteSqlResponse.HasMoreRecords.TRUE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.RawExecuteSqlResponse.HasMoreRecords.FALSE">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>

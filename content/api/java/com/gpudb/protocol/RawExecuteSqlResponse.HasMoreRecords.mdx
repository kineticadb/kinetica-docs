...
<div className="inheritance">com.gpudb.protocol.RawExecuteSqlResponse.HasMoreRecords</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/RawExecuteSqlResponse" title="class in com.gpudb.protocol"><code>RawExecuteSqlResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/RawExecuteSqlResponse#getHasMoreRecords()"><code>hasMoreRecords</code></a>. 

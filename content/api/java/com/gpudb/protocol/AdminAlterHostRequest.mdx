...
<div className="inheritance">com.gpudb.protocol.AdminAlterHostRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminalterhost#adminAlterHost(com.gpudb.protocol.AdminAlterHostRequest)"><code>GPUdb.adminAlterHost</code></a>. 

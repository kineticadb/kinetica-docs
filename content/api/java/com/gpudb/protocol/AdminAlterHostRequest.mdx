...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminAlterHost(com.gpudb.protocol.AdminAlterHostRequest)"><code>GPUdb.adminAlterHost</code></a>. 

---
title: "ClearTableMonitorResponse"
description: "ClearTableMonitorResponse — Kinetica Java API"
---
...
<h1 title="Class ClearTableMonitorResponse" className="title">Class ClearTableMonitorResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.ClearTableMonitorResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">ClearTableMonitorResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">ClearTableMonitorResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a ClearTableMonitorResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/ClearTableMonitorRequest#getTopicId()"><code>topicId</code></a>.</div>
</div>
...
<h3>ClearTableMonitorResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">ClearTableMonitorResponse</span>()</div>
<div className="block">Constructs a ClearTableMonitorResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<h3>setTopicId</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ClearTableMonitorResponse" title="class in com.gpudb.protocol">ClearTableMonitorResponse</a></span>&nbsp;<span className="element-name">setTopicId</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;topicId)</span></div>
<div className="block">Value of <a href="/content/api/java/com/gpudb/protocol/ClearTableMonitorRequest#getTopicId()"><code>topicId</code></a>.</div>
<div className="dl notes">
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ClearTableMonitorResponse" title="class in com.gpudb.protocol">ClearTableMonitorResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/getrecordsbycolumn#getRecordsByColumn(com.gpudb.protocol.GetRecordsByColumnRequest)"><code>GPUdb.getRecordsByColumn</code></a>. 

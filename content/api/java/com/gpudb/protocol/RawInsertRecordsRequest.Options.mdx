...
<div className="block">Stops the insertion and rejects the entire batch when any record is incorrect.</div>
</div>
...
<li><a href="#ABORT"><code>ABORT</code></a>: Stops the insertion and rejects the entire batch when any record is incorrect. </li>
</ul>

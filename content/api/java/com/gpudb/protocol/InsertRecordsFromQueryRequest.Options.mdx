...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.InsertRecordsFromQueryRequest.Options.SKIP">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.InsertRecordsFromQueryRequest.Options.PK_CONFLICT_PREDICATE_HIGHER">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="dd">
<ul className="tag-list">
<li><a href="/content/api/java/constant-values#com.gpudb.protocol.InsertRecordsFromQueryRequest.Options.PK_CONFLICT_PREDICATE_LOWER">Constant Field Values</a></li>
</ul>
</div>
</div>
</div>
...
<div className="block">Number of splits for reading data per rank. Default will be <a href="/content/config/#config-main-external-files" target="_top">external\_file\_reader\_num\_tasks</a>. The default value is ''.</div>
<div className="dl notes">
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">
...
<div className="block">Number of tasks for reading data per rank. Default will be <a href="/content/config/#config-main-external-files" target="_top">external\_file\_reader\_num\_tasks</a>.</div>
<div className="dl notes">
<div className="dt">See Also:</div>
<div className="dd">
<ul className="tag-list">

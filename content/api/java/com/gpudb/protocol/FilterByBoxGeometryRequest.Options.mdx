...
<div className="inheritance">com.gpudb.protocol.FilterByBoxGeometryRequest.Options</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByBoxGeometryRequest" title="class in com.gpudb.protocol"><code>FilterByBoxGeometryRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByBoxGeometryRequest#getOptions()"><code>options</code></a>. 

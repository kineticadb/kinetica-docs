...
<div className="inheritance">com.gpudb.protocol.DropDatasinkRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/dropdatasink#dropDatasink(com.gpudb.protocol.DropDatasinkRequest)"><code>GPUdb.dropDatasink</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.ExportQueryMetricsResponse</div>
</div>
...
<ul>
<li><a href="/content/api/java/com/gpudb/protocol/ExportQueryMetricsResponse.Info#EXPORTED_FILES"><code>EXPORTED\_FILES</code></a>: Comma separated list of filenames exported if applicable. </li>
<li><a href="/content/api/java/com/gpudb/protocol/ExportQueryMetricsResponse.Info#OUTPUT"><code>OUTPUT</code></a>: Exported metrics if no other destination specified. </li>
</ul>

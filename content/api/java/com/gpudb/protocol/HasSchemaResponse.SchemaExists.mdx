...
<div className="inheritance">com.gpudb.protocol.HasSchemaResponse.SchemaExists</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/HasSchemaResponse" title="class in com.gpudb.protocol"><code>HasSchemaResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/HasSchemaResponse#getSchemaExists()"><code>schemaExists</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#exportRecordsToTable(com.gpudb.protocol.ExportRecordsToTableRequest)"><code>GPUdb.exportRecordsToTable</code></a>. 

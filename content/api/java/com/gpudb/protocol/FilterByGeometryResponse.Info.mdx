...
<div className="inheritance">com.gpudb.protocol.FilterByGeometryResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/FilterByGeometryResponse" title="class in com.gpudb.protocol"><code>FilterByGeometryResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/FilterByGeometryResponse#getInfo()"><code>info</code></a>. 

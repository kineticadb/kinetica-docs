...
<div className="inheritance">com.gpudb.protocol.CreateProjectionResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/CreateProjectionResponse" title="class in com.gpudb.protocol"><code>CreateProjectionResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/CreateProjectionResponse#getInfo()"><code>info</code></a>. 

...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#createCredential(com.gpudb.protocol.CreateCredentialRequest)"><code>GPUdb.createCredential</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.CreateCredentialRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/createcredential#createCredential(com.gpudb.protocol.CreateCredentialRequest)"><code>GPUdb.createCredential</code></a>. 

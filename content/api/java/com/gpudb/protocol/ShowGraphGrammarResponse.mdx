---
title: "ShowGraphGrammarResponse"
description: "ShowGraphGrammarResponse — Kinetica Java API"
---
...
<h1 title="Class ShowGraphGrammarResponse" className="title">Class ShowGraphGrammarResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.ShowGraphGrammarResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">ShowGraphGrammarResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
</div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">ShowGraphGrammarResponse</a>()</code></div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getComponentsJson()" className="member-name-link">getComponentsJson</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">&nbsp;</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setComponentsJson(java.lang.String)" className="member-name-link">setComponentsJson</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;componentsJson)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">&nbsp;</div>
...
<h3>ShowGraphGrammarResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">ShowGraphGrammarResponse</span>()</div>
</div>
</li>
</ul>
</div>
...
<h3>setResult</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ShowGraphGrammarResponse" title="class in com.gpudb.protocol">ShowGraphGrammarResponse</a></span>&nbsp;<span className="element-name">setResult</span><wbr /><span className="parameters">(boolean&nbsp;result)</span></div>
</div>
</li>
<li>
<div className="section detail" id="getComponentsJson()">
<h3>getComponentsJson</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></span>&nbsp;<span className="element-name">getComponentsJson</span>()</div>
</div>
</li>
<li>
<div className="section detail" id="setComponentsJson(java.lang.String)">
<h3>setComponentsJson</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/ShowGraphGrammarResponse" title="class in com.gpudb.protocol">ShowGraphGrammarResponse</a></span>&nbsp;<span className="element-name">setComponentsJson</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;componentsJson)</span></div>
</div>
</li>
<li>

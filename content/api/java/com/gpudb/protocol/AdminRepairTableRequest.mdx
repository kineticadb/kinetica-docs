...
<div className="inheritance">com.gpudb.protocol.AdminRepairTableRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminrepairtable#adminRepairTable(com.gpudb.protocol.AdminRepairTableRequest)"><code>GPUdb.adminRepairTable</code></a>. 

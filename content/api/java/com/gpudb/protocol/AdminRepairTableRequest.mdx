...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminRepairTable(com.gpudb.protocol.AdminRepairTableRequest)"><code>GPUdb.adminRepairTable</code></a>. 

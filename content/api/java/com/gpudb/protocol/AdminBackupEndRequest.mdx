...
<div className="inheritance">com.gpudb.protocol.AdminBackupEndRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/adminbackupend#adminBackupEnd(com.gpudb.protocol.AdminBackupEndRequest)"><code>GPUdb.adminBackupEnd</code></a>. 

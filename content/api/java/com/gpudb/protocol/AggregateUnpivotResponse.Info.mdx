...
<div className="inheritance">com.gpudb.protocol.AggregateUnpivotResponse.Info</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AggregateUnpivotResponse" title="class in com.gpudb.protocol"><code>AggregateUnpivotResponse</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AggregateUnpivotResponse#getInfo()"><code>info</code></a>. 

...
<div className="inheritance">com.gpudb.protocol.DropBackupRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/dropbackup#dropBackup(com.gpudb.protocol.DropBackupRequest)"><code>GPUdb.dropBackup</code></a>. 
<p> Deletes one or more existing database <a href="/content/admin/backup_restore/#database-backup" target="_top">backups</a> and contained snapshots, accessible via the <a href="/content/concepts/data_sinks/" target="_top">data sink</a> specified by <a href="#getDatasinkName()"><code>datasinkName</code></a>.</p>
</div>
</div>

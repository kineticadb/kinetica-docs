...
<div className="inheritance">com.gpudb.protocol.AlterWalRequest</div>
</div>
...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb/alterwal#alterWal(com.gpudb.protocol.AlterWalRequest)"><code>GPUdb.alterWal</code></a>. 

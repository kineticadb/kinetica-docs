...
<div className="block">
A set of parameters for <a href="/content/api/java/com/gpudb/GPUdb#adminShowClusterOperations(com.gpudb.protocol.AdminShowClusterOperationsRequest)"><code>GPUdb.adminShowClusterOperations</code></a>. 

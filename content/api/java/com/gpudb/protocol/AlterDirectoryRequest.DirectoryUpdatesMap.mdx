...
<div className="inheritance">com.gpudb.protocol.AlterDirectoryRequest.DirectoryUpdatesMap</div>
</div>
...
<div className="block">
A set of string constants for the <a href="/content/api/java/com/gpudb/protocol/AlterDirectoryRequest" title="class in com.gpudb.protocol"><code>AlterDirectoryRequest</code></a> parameter <a href="/content/api/java/com/gpudb/protocol/AlterDirectoryRequest#getDirectoryUpdatesMap()"><code>directoryUpdatesMap</code></a>. 

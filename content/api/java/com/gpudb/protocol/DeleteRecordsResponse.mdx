---
title: "DeleteRecordsResponse"
description: "DeleteRecordsResponse — Kinetica Java API"
---
...
<h1 title="Class DeleteRecordsResponse" className="title">Class DeleteRecordsResponse</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.protocol.DeleteRecordsResponse</div> </div>
...
<hr />
<div className="type-signature"><span className="modifiers">public class </span><span className="element-name type-name-label">DeleteRecordsResponse</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">Object</a> implements org.apache.avro.generic.IndexedRecord</span></div>
...
<div className="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" className="member-name-link">DeleteRecordsResponse</a>()</code></div>
<div className="col-last even-row-color">
<div className="block">Constructs a DeleteRecordsResponse object with default parameters.</div>
</div>
</div>
</div>
</li>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getCountDeleted()" className="member-name-link">getCountDeleted</a>()</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total number of records deleted across all expressions.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getCountsDeleted()" className="member-name-link">getCountsDeleted</a>()</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total number of records deleted per expression.</div>
</div>
...
<div className="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setCountDeleted(long)" className="member-name-link">setCountDeleted</a><wbr />(long&nbsp;countDeleted)</code></div>
<div className="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total number of records deleted across all expressions.</div>
</div>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setCountsDeleted(java.util.List)" className="member-name-link">setCountsDeleted</a><wbr />(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html" title="class or interface in java.lang" className="external-link">Long</a>&gt;&nbsp;countsDeleted)</code></div>
<div className="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div className="block">Total number of records deleted per expression.</div>
</div>
<div className="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="/content/api/java/com/gpudb/protocol/DeleteRecordsResponse" title="class in com.gpudb.protocol">DeleteRecordsResponse</a></code></div>
...
<h3>DeleteRecordsResponse</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="element-name">DeleteRecordsResponse</span>()</div>
<div className="block">Constructs a DeleteRecordsResponse object with default parameters.</div>
</div>
</li>
</ul>
...
<li>
<div className="section detail" id="getCountDeleted()">
<h3>getCountDeleted</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type">long</span>&nbsp;<span className="element-name">getCountDeleted</span>()</div>
<div className="block">Total number of records deleted across all expressions.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>countDeleted</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setCountDeleted(long)">
<h3>setCountDeleted</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/DeleteRecordsResponse" title="class in com.gpudb.protocol">DeleteRecordsResponse</a></span>&nbsp;<span className="element-name">setCountDeleted</span><wbr /><span className="parameters">(long&nbsp;countDeleted)</span></div>
<div className="block">Total number of records deleted across all expressions.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>countDeleted</code> - The new value for <code>countDeleted</code>.</div>
<div className="dt">Returns:</div>
...
<li>
<div className="section detail" id="getCountsDeleted()">
<h3>getCountsDeleted</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html" title="class or interface in java.lang" className="external-link">Long</a>&gt;</span>&nbsp;<span className="element-name">getCountsDeleted</span>()</div>
<div className="block">Total number of records deleted per expression.</div>
<div className="dl notes">
<div className="dt">Returns:</div>
<div className="dd">The current value of <code>countsDeleted</code>.</div>
</div>
</div>
</li>
<li>
<div className="section detail" id="setCountsDeleted(java.util.List)">
<h3>setCountsDeleted</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/DeleteRecordsResponse" title="class in com.gpudb.protocol">DeleteRecordsResponse</a></span>&nbsp;<span className="element-name">setCountsDeleted</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/List.html" title="class or interface in java.util" className="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Long.html" title="class or interface in java.lang" className="external-link">Long</a>&gt;&nbsp;countsDeleted)</span></div>
<div className="block">Total number of records deleted per expression.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>
<div className="dd"><code>countsDeleted</code> - The new value for <code>countsDeleted</code>.</div>
<div className="dt">Returns:</div>
<div className="dd"><code>this</code> to mimic the builder pattern.</div>
</div>
</div>
...
<h3>setInfo</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/protocol/DeleteRecordsResponse" title="class in com.gpudb.protocol">DeleteRecordsResponse</a></span>&nbsp;<span className="element-name">setInfo</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" className="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>,<wbr /><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&gt;&nbsp;info)</span></div>
<div className="block">Additional information.</div>
<div className="dl notes">
<div className="dt">Parameters:</div>

...
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance">com.gpudb.RecordBase</div> </div>
...
<div className="inherited-list"> <h3 id="methods-inherited-from-class-com.gpudb.Record">Methods inherited from interface&nbsp;com.gpudb.<a href="/content/api/java/com/gpudb/Record" title="interface in com.gpudb">Record</a></h3> <code><a href="/content/api/java/com/gpudb/Record#get(int)">get</a>, <a href="/content/api/java/com/gpudb/Record#getType()">getType</a>, <a href="/content/api/java/com/gpudb/Record#put(int,java.lang.Object)">put</a></code></div>
</div>
</li>
</ul>
</div>

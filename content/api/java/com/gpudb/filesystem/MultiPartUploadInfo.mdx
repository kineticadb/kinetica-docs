...
<div className="block">
This class packages and mimics certain important attributes of a multi-part upload operation. The attributes of this class are in one-one correspondence to those specified in the <a href="/content/api/java/com/gpudb/GPUdb#uploadFiles(java.util.List,java.util.List,java.util.Map)"><code>GPUdb.uploadFiles(List, List, Map)</code></a> endpoint. 

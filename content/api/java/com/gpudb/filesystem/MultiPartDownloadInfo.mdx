...
<div className="inheritance">com.gpudb.filesystem.MultiPartDownloadInfo</div>
</div>
...
<div className="block">
This class packages and mimics certain important attributes of a multi-part download operation. The attributes of this class are in one-one correspondence to those specified in the <a href="/content/api/java/com/gpudb/GPUdb/downloadfiles#downloadFiles(java.util.List,java.util.List,java.util.List,java.util.Map)"><code>GPUdb.downloadFiles(List, List, List, Map)</code></a> endpoint. 

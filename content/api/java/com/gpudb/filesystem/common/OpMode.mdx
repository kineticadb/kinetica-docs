---
title: "OpMode"
description: "OpMode — Kinetica Java API"
---
...
<div className="col-first even-row-color"><code><a href="#DOWNLOAD" className="member-name-link">DOWNLOAD</a></code></div>
<div className="col-last even-row-color">&nbsp;</div>
<div className="col-first odd-row-color"><code><a href="#UPLOAD" className="member-name-link">UPLOAD</a></code></div>
...
<div className="table-header col-last">Description</div>
<div className="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="/content/api/java/com/gpudb/filesystem/common/OpMode" title="enum in com.gpudb.filesystem.common">OpMode</a></code></div>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="/content/api/java/com/gpudb/filesystem/common/OpMode" title="enum in com.gpudb.filesystem.common">OpMode</a>\[\]</code></div>
...
<li>
<div className="section detail" id="UPLOAD">
<h3>UPLOAD</h3>
<div className="member-signature"><span className="modifiers">public static final</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/filesystem/common/OpMode" title="enum in com.gpudb.filesystem.common">OpMode</a></span>&nbsp;<span className="element-name">UPLOAD</span></div>
</div>
</li>
<li>
<div className="section detail" id="DOWNLOAD">
<h3>DOWNLOAD</h3>
<div className="member-signature"><span className="modifiers">public static final</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/filesystem/common/OpMode" title="enum in com.gpudb.filesystem.common">OpMode</a></span>&nbsp;<span className="element-name">DOWNLOAD</span></div>
</div>
</li>
</ul>
</div>
...
<h3>values</h3>
<div className="member-signature"><span className="modifiers">public static</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/filesystem/common/OpMode" title="enum in com.gpudb.filesystem.common">OpMode</a>\[\]</span>&nbsp;<span className="element-name">values</span>()</div>
<div className="block">Returns an array containing the constants of this enum type, in the order they are declared.</div>
<div className="dl notes">
...
<h3>valueOf</h3>
<div className="member-signature"><span className="modifiers">public static</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/filesystem/common/OpMode" title="enum in com.gpudb.filesystem.common">OpMode</a></span>&nbsp;<span className="element-name">valueOf</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;name)</span></div>

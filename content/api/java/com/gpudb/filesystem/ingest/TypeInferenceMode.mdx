...
<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang" className="external-link">java.lang.Enum</a>&lt;<a href="/content/api/java/com/gpudb/filesystem/ingest/TypeInferenceMode" title="enum in com.gpudb.filesystem.ingest">TypeInferenceMode</a>&gt;
<div className="inheritance">com.gpudb.filesystem.ingest.TypeInferenceMode</div>
</div>
</div>

...
<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang" className="external-link">java.lang.Enum</a>&lt;<a href="/content/api/java/com/gpudb/filesystem/ingest/ErrorHandlingMode" title="enum in com.gpudb.filesystem.ingest">ErrorHandlingMode</a>&gt;
<div className="inheritance">com.gpudb.filesystem.ingest.ErrorHandlingMode</div>
</div>
</div>

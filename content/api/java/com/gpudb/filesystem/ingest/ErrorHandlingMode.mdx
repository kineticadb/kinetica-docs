---
title: "ErrorHandlingMode"
description: "ErrorHandlingMode — Kinetica Java API"
---
...
<h1 title="Enum ErrorHandlingMode" className="title">Enum ErrorHandlingMode</h1>
</div>
<div className="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" className="external-link">java.lang.Object</a> <div className="inheritance"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang" className="external-link">java.lang.Enum</a>&lt;<a href="/content/api/java/com/gpudb/filesystem/ingest/ErrorHandlingMode" title="enum in com.gpudb.filesystem.ingest">ErrorHandlingMode</a>&gt; <div className="inheritance">com.gpudb.filesystem.ingest.ErrorHandlingMode</div> </div> </div>
<div className="section class-description" id="class-description">
<div className="dl notes">
<div className="dt">All Implemented Interfaces:</div>
<div className="dd"><code><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io" className="external-link">Serializable</a></code>, <code><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang" className="external-link">Comparable</a>&lt;<a href="/content/api/java/com/gpudb/filesystem/ingest/ErrorHandlingMode" title="enum in com.gpudb.filesystem.ingest">ErrorHandlingMode</a>&gt;</code></div>
</div>
<hr />
<div className="type-signature"><span className="modifiers">public enum </span><span className="element-name type-name-label">ErrorHandlingMode</span> <span className="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang" className="external-link">Enum</a>&lt;<a href="/content/api/java/com/gpudb/filesystem/ingest/ErrorHandlingMode" title="enum in com.gpudb.filesystem.ingest">ErrorHandlingMode</a>&gt;</span></div>
</div>
...
<div className="col-first even-row-color"><code><a href="#ABORT" className="member-name-link">ABORT</a></code></div>
<div className="col-last even-row-color">&nbsp;</div>
<div className="col-first odd-row-color"><code><a href="#IGNORE_BAD_RECORDS" className="member-name-link">IGNORE\_BAD\_RECORDS</a></code></div>
<div className="col-last odd-row-color">&nbsp;</div>
<div className="col-first even-row-color"><code><a href="#PERMISSIVE" className="member-name-link">PERMISSIVE</a></code></div>
<div className="col-last even-row-color">&nbsp;</div>
</div>
</div>
</li>
...
<div className="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#defaultMode()" className="member-name-link">defaultMode</a>()</code></div>
...
<div className="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="/content/api/java/com/gpudb/filesystem/ingest/ErrorHandlingMode" title="enum in com.gpudb.filesystem.ingest">ErrorHandlingMode</a></code></div>
...
<div className="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="/content/api/java/com/gpudb/filesystem/ingest/ErrorHandlingMode" title="enum in com.gpudb.filesystem.ingest">ErrorHandlingMode</a>\[\]</code></div>
...
<h3>PERMISSIVE</h3>
<div className="member-signature"><span className="modifiers">public static final</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/filesystem/ingest/ErrorHandlingMode" title="enum in com.gpudb.filesystem.ingest">ErrorHandlingMode</a></span>&nbsp;<span className="element-name">PERMISSIVE</span></div>
</div>
</li>
<li>
<div className="section detail" id="IGNORE_BAD_RECORDS">
<h3>IGNORE\_BAD\_RECORDS</h3>
<div className="member-signature"><span className="modifiers">public static final</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/filesystem/ingest/ErrorHandlingMode" title="enum in com.gpudb.filesystem.ingest">ErrorHandlingMode</a></span>&nbsp;<span className="element-name">IGNORE\_BAD\_RECORDS</span></div>
</div>
</li>
<li>
<div className="section detail" id="ABORT">
<h3>ABORT</h3>
<div className="member-signature"><span className="modifiers">public static final</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/filesystem/ingest/ErrorHandlingMode" title="enum in com.gpudb.filesystem.ingest">ErrorHandlingMode</a></span>&nbsp;<span className="element-name">ABORT</span></div>
</div>
</li>
</ul>
</div>
...
<h3>values</h3>
<div className="member-signature"><span className="modifiers">public static</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/filesystem/ingest/ErrorHandlingMode" title="enum in com.gpudb.filesystem.ingest">ErrorHandlingMode</a>\[\]</span>&nbsp;<span className="element-name">values</span>()</div>
<div className="block">Returns an array containing the constants of this enum type, in the order they are declared.</div>
<div className="dl notes">
...
<h3>valueOf</h3>
<div className="member-signature"><span className="modifiers">public static</span>&nbsp;<span className="return-type"><a href="/content/api/java/com/gpudb/filesystem/ingest/ErrorHandlingMode" title="enum in com.gpudb.filesystem.ingest">ErrorHandlingMode</a></span>&nbsp;<span className="element-name">valueOf</span><wbr /><span className="parameters">(<a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a>&nbsp;name)</span></div>
...
<li>
<div className="section detail" id="defaultMode()">
<h3>defaultMode</h3>
<div className="member-signature"><span className="modifiers">public</span>&nbsp;<span className="return-type"><a href="https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" className="external-link">String</a></span>&nbsp;<span className="element-name">defaultMode</span>()</div>
</div>
</li>
</ul>
</div>

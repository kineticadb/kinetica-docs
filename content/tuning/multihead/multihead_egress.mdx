...
sidebarTitle: Distributed Key Lookup
---
...
* Specifying only the shard key columns/values of a sharded table with
  [attribute indexes](/content/sql/ddl/alter-table#sql-alter-table-column-index-add) on each of
...
has an [attribute index](/content/sql/ddl/alter-table#sql-alter-table-column-index-add).
